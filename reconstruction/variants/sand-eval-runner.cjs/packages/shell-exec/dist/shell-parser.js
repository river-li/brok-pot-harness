...
function isStubbedTreeSitterError(error3) {
  return typeof error3 === "object" && error3 !== null && error3.code === TREE_SITTER_STUBBED_ERROR_CODE;
}
var cachedParser;
function getParser() {
  ...
  try {
    ...
    if (!isStubbedTreeSitterError(error3)) {
      throw error3;
    }
    cachedParser = null;
