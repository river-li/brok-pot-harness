 ...
 * Source: ../packages/shell-exec/dist/dump_zsh_state.js
 * Bundle: sand-host/sand-eval-runner.cjs
 * See reconstruction-manifest.json for exact byte ranges. */
// @recovered-fragment 1/1
var ZSH_STATE_START_MARKER, ZSH_STATE_END_MARKER, zshScript, dump_zsh_state_default;
var init_dump_zsh_state = __esm({
  "../packages/shell-exec/dist/dump_zsh_state.js"() {
    "use strict";
    ZSH_STATE_START_MARKER = "__CURSOR_ZSH_STATE_START__";
    ZSH_STATE_END_MARKER = "__CURSOR_ZSH_STATE_END__";
    zshScript = `#!/usr/bin/env zsh
...
`;
    dump_zsh_state_default = zshScript;
  }
});
