...
var __await5 = function(v2) {
  return this instanceof __await5 ? (this.v = v2, this) : new __await5(v2);
};
var __asyncGenerator5 = function(thisArg, _arguments, generator) {
  if (!Symbol.asyncIterator) throw new TypeError("Symbol.asyncIterator is not defined.");
  ...
  function step(r) {
    r.value instanceof __await5 ? Promise.resolve(r.value.v).then(fulfill, reject2) : settle(q2[0][2], r);
  }
...
function stampImageDescriptionsOnMessage(message, entries) {
  ...
  if (message.role === "user") {
    ...
    for (const entry of entries) {
      ...
      updatedContent[entry.partIndex] = Object.assign(Object.assign({}, part), { providerOptions: Object.assign(Object.assign({}, part.providerOptions), { cursor: Object.assign(Object.assign({}, (_a20 = part.providerOptions) === null || _a20 === void 0 ? void 0 : _a20.cursor), { imageDescription: entry.description }) }) });
      updatedAny = true;
    }
...
var ProtoPromptExecutor = class extends BasePromptExecutor {
  ...
  applyImageDescriptions(requestMessages, info2) {
    ...
    for (const entry of info2.descriptions) {
      ...
      const entries = (_a20 = entriesByMessageIndex.get(entry.messageIndex)) !== null && _a20 !== void 0 ? _a20 : [];
      entries.push(entry);
  ...
  stream(ctx, invocationId, tools, options2) {
    ...
    const request3 = buildStreamRequest({
      ...
      compactionEpoch: (_a20 = ctx.get(compactionEpochKey)) === null || _a20 === void 0 ? void 0 : _a20(),
  ...
  createFullStream(streamPromise, resolvers, _ctx, requestMessages) {
    return __asyncGenerator5(this, arguments, function* createFullStream_1() {
      ...
      try {
        try {
          for (var _g = true, streamPromise_1 = __asyncValues4(streamPromise), streamPromise_1_1; streamPromise_1_1 = yield __await5(streamPromise_1.next()), _a20 = streamPromise_1_1.done, !_a20; _g = true) {
          ...
          try {
            if (!_g && !_a20 && (_b2 = streamPromise_1.return)) yield __await5(_b2.call(streamPromise_1));
          } finally {
            if (e_1) throw e_1.error;
          }
        }
      } catch (error3) {
        streamError = error3 instanceof Error ? error3 : new Error(String(error3));
      }
      if (!usageResolved) {
        if (streamError) {
    ...
    return info2.messages.map((msg) => {
      ...
      if (role === "assistant") {
        ...
        for (const rp of msg.reasoningParts) {
          if (rp.isRedacted) {
            content.push(Object.assign({ type: "redacted-reasoning", data: (_a20 = rp.redactedData) !== null && _a20 !== void 0 ? _a20 : "" }, providerOptionsFromModelName(rp.modelName)));
          } else {
        ...
        return {
          ...
          content: msg.toolResult ? msg.toolResult.parts.map((part) => {
            ...
            return {
              ...
              result: (_a21 = part.result) === null || _a21 === void 0 ? void 0 : _a21.toJson(),
