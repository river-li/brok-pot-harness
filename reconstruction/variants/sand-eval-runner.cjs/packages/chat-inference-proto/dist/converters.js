...
function toolCallArgsFromProto(tc) {
  var _a20;
  var _b2, _c2;
  return (_c2 = (_b2 = (_a20 = tc.args) === null || _a20 === void 0 ? void 0 : _a20.toJson()) !== null && _b2 !== void 0 ? _b2 : tc.rawToolCallArgs) !== null && _c2 !== void 0 ? _c2 : {};
}
...
function cursorToolCallIsErrorFromProviderOptions(msg) {
  var _a20, _b2, _c2;
  const isError = (_c2 = (_b2 = (_a20 = msg.providerOptions) === null || _a20 === void 0 ? void 0 : _a20.cursor) === null || _b2 === void 0 ? void 0 : _b2.highLevelToolCallResult) === null || _c2 === void 0 ? void 0 : _c2.isError;
    ...
    if (typeof msg.content === "string") {
      ...
      for (const part of msg.content) {
        if (part.type === "text") {
          ...
          const rawToolCallArgs = (_b2 = (_a20 = toolCallPart.providerOptions) === null || _a20 === void 0 ? void 0 : _a20.cursor) === null || _b2 === void 0 ? void 0 : _b2.rawToolCallArgs;
...
function getResponsesMetadataFromProviderOptions(msg) {
  var _a20;
  const cursorOptions = (_a20 = msg.providerOptions) === null || _a20 === void 0 ? void 0 : _a20.cursor;
...
function providerOptionsToProto(options2) {
  ...
  let hasOptions = false;
  if ((_a20 = opts.anthropic) === null || _a20 === void 0 ? void 0 : _a20.cacheControl) {
...
function userContentPartToProto(part) {
  ...
  if (part.type === "text") {
    ...
    const textPart = new InferenceTextPart();
    textPart.text = `[File: ${(_a20 = part.name) !== null && _a20 !== void 0 ? _a20 : "unnamed"}]`;
    protoPart.part = { case: "text", value: textPart };
  } else {
    const textPart = new InferenceTextPart();
    textPart.text = "";
...
function protoStreamErrorToError(protoError) {
  ...
  return (_a20 = classifyTokenLimitErrorFromMessage(protoError.message)) !== null && _a20 !== void 0 ? _a20 : new Error(protoError.message);
}
function buildStreamRequest(options2) {
  var _a20;
  const { messages, requestedModel, tools, providerDefinedTools, modelConfig, invocationId, conversationId, conversationGroupId, automationId, parentRequestId, rootParentRequestId, parentAgentToolCallId, subagentType, compactionEpoch, inferenceReason, acceptedUnadvertisedToolNames } = options2;
  ...
  request3.acceptedUnadvertisedToolNames = [...acceptedUnadvertisedToolNames !== null && acceptedUnadvertisedToolNames !== void 0 ? acceptedUnadvertisedToolNames : []];
  ...
  if (modelConfig) {
    ...
    config2.stopSequences = (_a20 = modelConfig.stopSequences) !== null && _a20 !== void 0 ? _a20 : [];
