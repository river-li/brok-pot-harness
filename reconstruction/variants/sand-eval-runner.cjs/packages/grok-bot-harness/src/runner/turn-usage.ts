...
function turnUsageFromTurnEnded(fields2) {
  ...
  return {
    inputTokens: toSafeTokenCount(fields2.inputTokens ?? BIGINT_ZERO3),
    outputTokens: toSafeTokenCount(fields2.outputTokens ?? BIGINT_ZERO3),
    cacheReadTokens: toSafeTokenCount(fields2.cacheReadTokens ?? BIGINT_ZERO3),
    cacheWriteTokens: toSafeTokenCount(fields2.cacheWriteTokens ?? BIGINT_ZERO3),
