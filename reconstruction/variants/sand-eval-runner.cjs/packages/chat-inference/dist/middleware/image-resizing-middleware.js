...
var __asyncDelegator = function(o) {
  ...
  function verb(n, f2) {
    i[n] = o[n] ? function(v2) {
      return (p2 = !p2) ? { value: __await3(o[n](v2)), done: false } : f2 ? f2(v2) : v2;
    } : f2;
  }
};
var __asyncGenerator3 = function(thisArg, _arguments, generator) {
  ...
  function step(r) {
    r.value instanceof __await3 ? Promise.resolve(r.value.v).then(fulfill, reject2) : settle(q2[0][2], r);
  }
...
function decodeImageDataUrl(value) {
  ...
  const separatorIndex = parsed.pathname.indexOf(",");
  if (separatorIndex === -1) {
    throw new Error("Image data URL is missing its data separator");
  }
  const metadata = parsed.pathname.slice(0, separatorIndex);
  ...
  const encodedData = parsed.pathname.slice(separatorIndex + 1);
...
function resizeImagesInMessage(_a20) {
  return __awaiter10(this, arguments, void 0, function* ({ ctx, message, resizeOptions, checkedImageParts }) {
    var _b2;
    var _c2, _d;
      ...
      for (const part of message.content) {
        if (part.type === "image") {
          ...
          try {
            ...
            hasUpdates = true;
            logger3.error(ctx, "Failed to resize image, dropping it", error3, {
              originalSize
            });
            updatedContent.push({
              type: "text",
          ...
          for (let expContentIndex = 0; expContentIndex < expContent.length; expContentIndex++) {
            ...
            if (expPart.type === "image") {
              ...
              try {
                ...
                expContentHasUpdates = true;
                messageHasUpdates = true;
                logger3.error(ctx, "Failed to resize image in tool result, dropping it", error3, {
                  partIndex,
                  expContentIndex,
                  originalSize: imageBuffer.length
                });
...
function resizeImagesInMessages(_a20) {
  return __awaiter10(this, arguments, void 0, function* ({ ctx, messages, resizeOptions, checkedImageParts }) {
    return asyncMapValues(messages, (message) => resizeImagesInMessage({ ctx, message, resizeOptions, checkedImageParts }), { max: IMAGE_RESIZE_CONCURRENCY });
  });
}
var ImageResizingPromptExecutor = class extends BaseMiddleware {
  ...
  stream(ctx, invocationId, tools, options2) {
    ...
    const processAndStream = () => __awaiter10(this, void 0, void 0, function* () {
    ...
    return {
      fullStream: (function() {
        return __asyncGenerator3(this, arguments, function* () {
          const result = yield __await3(processingPromise);
          yield __await3(yield* __asyncDelegator(__asyncValues2(result.fullStream)));
        });
      })(),
      response: (() => __awaiter10(this, void 0, void 0, function* () {
        const result = yield processingPromise;
        return yield result.response;
      }))(),
      usage: (() => __awaiter10(this, void 0, void 0, function* () {
        const result = yield processingPromise;
        return yield result.usage;
      }))(),
      providerMetadata: (() => __awaiter10(this, void 0, void 0, function* () {
        const result = yield processingPromise;
        return yield result.providerMetadata;
      }))(),
      extendedUsage: (() => __awaiter10(this, void 0, void 0, function* () {
        const result = yield processingPromise;
        return yield result.extendedUsage;
      }))(),
      invocationId: (() => __awaiter10(this, void 0, void 0, function* () {
        const result = yield processingPromise;
