...
init_esm13();
init_compact();
var __protoPackage104 = "agent.v1.";
var __protoMessage3103 = class extends CompactMessage {
  static get runtime() {
...
var PreCompactRequestQuery = class _PreCompactRequestQuery extends __protoMessage3103 {
  constructor(data) {
    super();
    this.trigger = "";
...
var PreCompactRequestResponse = class _PreCompactRequestResponse extends __protoMessage3103 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SubagentStartRequestQuery = class _SubagentStartRequestQuery extends __protoMessage3103 {
  constructor(data) {
    super();
    this.subagentId = "";
    this.subagentType = "";
...
var SubagentStartRequestResponse = class _SubagentStartRequestResponse extends __protoMessage3103 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SubagentStopRequestQuery = class _SubagentStopRequestQuery extends __protoMessage3103 {
  constructor(data) {
    super();
    this.subagentId = "";
    this.subagentType = "";
...
var SubagentStopRequestResponse = class _SubagentStopRequestResponse extends __protoMessage3103 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var BeforeSubmitPromptAttachment = class _BeforeSubmitPromptAttachment extends __protoMessage3103 {
  constructor(data) {
    super();
    this.type = "";
    this.filePath = "";
...
var BeforeSubmitPromptRequestQuery = class _BeforeSubmitPromptRequestQuery extends __protoMessage3103 {
  constructor(data) {
    super();
    this.prompt = "";
    this.attachments = [];
...
var BeforeSubmitPromptRequestResponse = class _BeforeSubmitPromptRequestResponse extends __protoMessage3103 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var AfterAgentResponseRequestQuery = class _AfterAgentResponseRequestQuery extends __protoMessage3103 {
  constructor(data) {
    super();
    this.text = "";
    this.modelParams = [];
...
var AfterAgentResponseRequestResponse = class _AfterAgentResponseRequestResponse extends __protoMessage3103 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var AfterAgentThoughtRequestQuery = class _AfterAgentThoughtRequestQuery extends __protoMessage3103 {
  constructor(data) {
    super();
    this.text = "";
    this.modelParams = [];
...
var AfterAgentThoughtRequestResponse = class _AfterAgentThoughtRequestResponse extends __protoMessage3103 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var StopRequestQuery = class _StopRequestQuery extends __protoMessage3103 {
  constructor(data) {
    super();
    this.status = "";
    this.loopCount = 0;
...
var StopRequestResponse = class _StopRequestResponse extends __protoMessage3103 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var PreToolUseRequestQuery = class _PreToolUseRequestQuery extends __protoMessage3103 {
  constructor(data) {
    super();
    this.toolName = "";
    this.toolUseId = "";
...
var PreToolUseRequestResponse = class _PreToolUseRequestResponse extends __protoMessage3103 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var PostToolUseRequestQuery = class _PostToolUseRequestQuery extends __protoMessage3103 {
  constructor(data) {
    super();
    this.toolName = "";
    this.toolOutput = "";
...
var PostToolUseRequestResponse = class _PostToolUseRequestResponse extends __protoMessage3103 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var PostToolUseFailureRequestQuery = class _PostToolUseFailureRequestQuery extends __protoMessage3103 {
  constructor(data) {
    super();
    this.toolName = "";
    this.errorMessage = "";
...
var PostToolUseFailureRequestResponse = class _PostToolUseFailureRequestResponse extends __protoMessage3103 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
