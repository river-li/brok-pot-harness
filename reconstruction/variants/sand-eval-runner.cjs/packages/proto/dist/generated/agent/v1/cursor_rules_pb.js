...
var CursorRuleSource = /* @__PURE__ */ enumType2(proto3, __protoPackage14, "CursorRuleSource", [[0, "UNSPECIFIED"], [1, "TEAM"], [2, "USER"]], 1);
var CursorRuleTypeGlobal = class _CursorRuleTypeGlobal extends __protoMessage314 {
  constructor(data) {
    super();
...
var CursorRuleTypeFileGlobs = class _CursorRuleTypeFileGlobs extends __protoMessage314 {
  constructor(data) {
    super();
    this.globs = [];
    proto3.util.initPartial(data, this);
...
var CursorRuleTypeAgentFetched = class _CursorRuleTypeAgentFetched extends __protoMessage314 {
  constructor(data) {
    super();
    this.description = "";
    proto3.util.initPartial(data, this);
...
var CursorRuleTypeManuallyAttached = class _CursorRuleTypeManuallyAttached extends __protoMessage314 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var CursorRuleType = class _CursorRuleType extends __protoMessage314 {
  constructor(data) {
    super();
...
var CursorRule = class _CursorRule extends __protoMessage314 {
  constructor(data) {
    super();
    this.fullPath = "";
    this.content = "";
