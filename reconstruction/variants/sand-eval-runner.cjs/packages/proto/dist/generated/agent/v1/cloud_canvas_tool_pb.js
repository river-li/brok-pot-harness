...
var WriteCanvasFailReason = /* @__PURE__ */ enumType2(proto3, __protoPackage80, "WriteCanvasFailReason", [[0, "UNSPECIFIED"], [1, "TYPECHECK_FAILED"], [2, "COMPILE_FAILED"], [3, "TOO_LARGE"], [4, "UNAVAILABLE"], [5, "NOT_FOUND"], [6, "REFUSED"]], 1);
var ReadCanvasFailReason = /* @__PURE__ */ enumType2(proto3, __protoPackage80, "ReadCanvasFailReason", [[0, "UNSPECIFIED"], [1, "NOT_FOUND"], [2, "UNAVAILABLE"], [3, "REFUSED"], [4, "INVALID_REFERENCE"]], 1);
var CloudCanvasToolDiagnosticPosition = class _CloudCanvasToolDiagnosticPosition extends __protoMessage380 {
  constructor(data) {
    super();
    this.line = 0;
    this.character = 0;
...
var CloudCanvasToolDiagnosticRange = class _CloudCanvasToolDiagnosticRange extends __protoMessage380 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var CloudCanvasToolDiagnostic = class _CloudCanvasToolDiagnostic extends __protoMessage380 {
  constructor(data) {
    super();
    this.message = "";
    proto3.util.initPartial(data, this);
...
var WriteCanvasArgs = class _WriteCanvasArgs extends __protoMessage380 {
  constructor(data) {
    super();
    this.contents = "";
    proto3.util.initPartial(data, this);
...
var WriteCanvasSuccess = class _WriteCanvasSuccess extends __protoMessage380 {
  constructor(data) {
    super();
    this.canvasId = "";
    this.url = "";
...
var WriteCanvasFailure = class _WriteCanvasFailure extends __protoMessage380 {
  constructor(data) {
    super();
...
var WriteCanvasResult = class _WriteCanvasResult extends __protoMessage380 {
  constructor(data) {
    super();
...
var WriteCanvasToolCall = class _WriteCanvasToolCall extends __protoMessage380 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ReadCanvasArgs = class _ReadCanvasArgs extends __protoMessage380 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ReadCanvasSuccess = class _ReadCanvasSuccess extends __protoMessage380 {
  constructor(data) {
    super();
    this.canvasId = "";
    this.url = "";
...
var ReadCanvasFailure = class _ReadCanvasFailure extends __protoMessage380 {
  constructor(data) {
    super();
...
var ReadCanvasResult = class _ReadCanvasResult extends __protoMessage380 {
  constructor(data) {
    super();
    this.result = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var ReadCanvasToolCall = class _ReadCanvasToolCall extends __protoMessage380 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
