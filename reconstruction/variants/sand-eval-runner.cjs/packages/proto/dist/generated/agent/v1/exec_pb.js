...
init_compact();
var __protoPackage105 = "agent.v1.";
var __protoMessage3104 = class extends CompactMessage {
  static get runtime() {
...
var ExecClientStreamClose = class _ExecClientStreamClose extends __protoMessage3104 {
  constructor(data) {
    super();
    this.id = 0;
...
var ExecClientThrow = class _ExecClientThrow extends __protoMessage3104 {
  constructor(data) {
    super();
    this.id = 0;
    this.error = "";
...
var ExecClientHeartbeat = class _ExecClientHeartbeat extends __protoMessage3104 {
  constructor(data) {
    super();
    this.id = 0;
    proto3.util.initPartial(data, this);
...
var ExecClientControlMessage = class _ExecClientControlMessage extends __protoMessage3104 {
  constructor(data) {
    super();
...
var ExecServerAbort = class _ExecServerAbort extends __protoMessage3104 {
  constructor(data) {
    super();
    this.id = 0;
    proto3.util.initPartial(data, this);
...
var ExecServerControlMessage = class _ExecServerControlMessage extends __protoMessage3104 {
  constructor(data) {
    super();
    this.message = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var SpanContext = class _SpanContext extends __protoMessage3104 {
  constructor(data) {
    super();
    this.traceId = "";
    this.spanId = "";
...
var ExecServerMessage = class _ExecServerMessage extends __protoMessage3104 {
  constructor(data) {
    super();
    this.id = 0;
    this.execId = "";
...
var ExecClientMessage = class _ExecClientMessage extends __protoMessage3104 {
  constructor(data) {
    super();
    this.id = 0;
    this.execId = "";
...
var ExecuteHookArgs = class _ExecuteHookArgs extends __protoMessage3104 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ExecuteHookResult = class _ExecuteHookResult extends __protoMessage3104 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ExecuteHookRequest = class _ExecuteHookRequest extends __protoMessage3104 {
  constructor(data) {
    super();
...
var ExecuteHookResponse = class _ExecuteHookResponse extends __protoMessage3104 {
  constructor(data) {
    super();
