 ...
 * Source: ../packages/proto/dist/generated/agent/v1/agent_store_conflict_exec_pb.js
 * Bundle: sand-host/sand-eval-runner.cjs
 * See reconstruction-manifest.json for exact byte ranges. */
// @recovered-fragment 1/1
init_esm13();
init_compact();
var __protoPackage103 = "agent.v1.";
var __protoMessage3102 = class extends CompactMessage {
  static get runtime() {
...
var AgentStoreConflictCursor = class _AgentStoreConflictCursor extends __protoMessage3102 {
  constructor(data) {
    super();
    this.journalEpoch = "";
...
var AgentStoreConflictArgs = class _AgentStoreConflictArgs extends __protoMessage3102 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var AgentStoreConflictEvent = class _AgentStoreConflictEvent extends __protoMessage3102 {
  constructor(data) {
    super();
    this.v = 0;
    this.eventId = "";
...
var AgentStoreConflictResult = class _AgentStoreConflictResult extends __protoMessage3102 {
  constructor(data) {
    super();
...
var AgentStoreConflictSuccess = class _AgentStoreConflictSuccess extends __protoMessage3102 {
  constructor(data) {
    super();
    this.events = [];
    this.gap = false;
...
var AgentStoreConflictError = class _AgentStoreConflictError extends __protoMessage3102 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
