...
// @recovered-fragment 1/8
init_esm13();
init_subagents_pb();

// @recovered-fragment 2/8
init_apply_agent_diff_tool_pb();

// @recovered-fragment 3/8
init_generate_image_tool_pb();

// @recovered-fragment 4/8
init_computer_use_tool_pb();

// @recovered-fragment 5/8
init_report_bugfix_results_tool_pb();
init_ai_attribution_tool_pb();

// @recovered-fragment 6/8
init_hook_additional_context_pb();

// @recovered-fragment 7/8
init_shell_exec_pb();

// @recovered-fragment 8/8
init_compact();
var __protoPackage87 = "agent.v1.";
var __protoMessage386 = class extends CompactMessage {
  static get runtime() {
...
var AgentMode = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "AgentMode", [[0, "UNSPECIFIED"], [1, "AGENT"], [2, "ASK"], [3, "PLAN"], [4, "DEBUG"], [5, "TRIAGE"], [6, "PROJECT"], [7, "MULTITASK"], [8, "CUSTOM"]], 1);
var BackgroundTaskKind = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "BackgroundTaskKind", [[0, "UNSPECIFIED"], [1, "SHELL"], [2, "SUBAGENT"]], 1);
var BackgroundTaskStatus = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "BackgroundTaskStatus", [[0, "UNSPECIFIED"], [1, "SUCCESS"], [2, "ERROR"], [3, "ABORTED"]], 1);
var BackgroundTaskNotificationContext = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "BackgroundTaskNotificationContext", [[0, "UNSPECIFIED"], [1, "USER_DRIVEN_INTERACTIVE_CHILD"]], 1);
var SubagentRunStatus = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "SubagentRunStatus", [[0, "UNSPECIFIED"], [1, "RUNNING"], [2, "BACKGROUNDED"], [3, "SUCCESS"], [4, "ERROR"], [5, "ABORTED"]], 1);
var SubagentDispatchTool = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "SubagentDispatchTool", [[0, "UNSPECIFIED"], [1, "TASK"], [2, "CREATE_AGENT"], [3, "SEND_TO_AGENT"]], 1);
var CustomModeSource = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "CustomModeSource", [[0, "UNSPECIFIED"], [1, "AGENT_SKILL"], [2, "PLUGIN_SKILL"], [3, "REPO_SKILL"], [4, "MANAGED_SKILL"]], 1);
var SimulatedMsgReason = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "SimulatedMsgReason", [[0, "UNSPECIFIED"], [1, "PLAN_EXECUTION"], [2, "COMMIT_REMINDER"], [3, "BACKGROUND_TASK_COMPLETION"], [4, "DIFF_TAB_COMMIT"], [5, "DIFF_TAB_COMMIT_AND_PUSH"], [6, "DIFF_TAB_PUSH"], [7, "DIFF_TAB_CREATE_PR"], [8, "DIFF_TAB_FIX_MERGE_CONFLICTS"], [9, "USER_SENT_TO_SUBAGENT"], [10, "USER_INTERRUPTED_SUBAGENT"], [11, "USER_QUEUED_TO_SUBAGENT"], [12, "BABYSIT_PR_IN_CLOUD"], [13, "CI_PANEL_INVESTIGATE_FAILURE"], [14, "MULTITASK"], [15, "BUILD_IN_PARALLEL"], [16, "MULTITASK_SPLIT_PRS"], [17, "APPLY_LOCALLY"], [18, "CHECKOUT_BRANCH"], [19, "DIFF_TAB_UPDATE_BRANCH"], [20, "PR_TAB_BUGBOT_FIX"], [22, "RUN_BUGBOT_REVIEW"], [23, "RUN_SECURITY_REVIEW"], [24, "FSD_APPLY_FINDING"], [25, "FSD_UNDO_FINDING"], [26, "FSD_START"], [27, "FSD_PR_INTERRUPT"], [28, "SUBSCRIPTION"], [29, "DIFF_TAB_CREATE_BRANCH"], [30, "AGENT_STORE_CONFLICT"], [31, "GOAL_CONTINUATION"], [32, "PROJECT_KICKOFF"], [33, "MARKDOWN_PROMPT_BUTTON"], [34, "USER_QUICK_ACTION"]], 1);
var SubscriptionSource = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "SubscriptionSource", [[0, "UNSPECIFIED"], [1, "SLACK"], [2, "GITHUB"], [3, "LINEAR"], [4, "ORIGIN"]], 1);
var ThinkingStyle = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "ThinkingStyle", [[0, "UNSPECIFIED"], [1, "DEFAULT"], [2, "CODEX"], [3, "GPT5"]], 1);
var ResponseComparisonDisplayOrder = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "ResponseComparisonDisplayOrder", [[0, "UNSPECIFIED"], [1, "PARENT_FIRST"], [2, "ALTERNATE_FIRST"]], 1);
var ResponseComparisonSkipReason = /* @__PURE__ */ enumType2(proto3, __protoPackage87, "ResponseComparisonSkipReason", [[0, "UNSPECIFIED"], [1, "ALTERNATE_TOOL_CALL"], [2, "INFERENCE_ERROR"], [3, "TIMEOUT"], [4, "CANCELLED"]], 1);
var TaskArgs = class _TaskArgs extends __protoMessage386 {
  constructor(data) {
    super();
    this.description = "";
    this.prompt = "";
...
var TargetMachine = class _TargetMachine extends __protoMessage386 {
  constructor(data) {
    super();
...
var SameMachineTarget = class _SameMachineTarget extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var NewCloudVmTarget = class _NewCloudVmTarget extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SelfHostedWorkerTarget = class _SelfHostedWorkerTarget extends __protoMessage386 {
  constructor(data) {
    super();
    this.workerId = "";
    proto3.util.initPartial(data, this);
...
var SelfHostedPoolTarget = class _SelfHostedPoolTarget extends __protoMessage386 {
  constructor(data) {
    super();
    this.labels = [];
    proto3.util.initPartial(data, this);
...
var SelfHostedWorkerLabel = class _SelfHostedWorkerLabel extends __protoMessage386 {
  constructor(data) {
    super();
    this.key = "";
    this.value = "";
...
var TaskSuccess = class _TaskSuccess extends __protoMessage386 {
  constructor(data) {
    super();
...
var TaskError = class _TaskError extends __protoMessage386 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var TaskResult = class _TaskResult extends __protoMessage386 {
  constructor(data) {
    super();
...
var TaskToolCall = class _TaskToolCall extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var TaskToolCallDelta = class _TaskToolCallDelta extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SetActiveBranchArgs = class _SetActiveBranchArgs extends __protoMessage386 {
  constructor(data) {
    super();
    this.path = "";
    this.branchName = "";
...
var SetActiveBranchSuccess = class _SetActiveBranchSuccess extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SetActiveBranchError = class _SetActiveBranchError extends __protoMessage386 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var SetActiveBranchResult = class _SetActiveBranchResult extends __protoMessage386 {
  constructor(data) {
    super();
    this.result = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var SetActiveBranchToolCall = class _SetActiveBranchToolCall extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ToolCall = class _ToolCall extends __protoMessage386 {
  constructor(data) {
    super();
...
var TruncatedToolCallArgs = class _TruncatedToolCallArgs extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var TruncatedToolCallSuccess = class _TruncatedToolCallSuccess extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var TruncatedToolCallError = class _TruncatedToolCallError extends __protoMessage386 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var TruncatedToolCallResult = class _TruncatedToolCallResult extends __protoMessage386 {
  constructor(data) {
    super();
    this.result = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var TruncatedToolCall = class _TruncatedToolCall extends __protoMessage386 {
  constructor(data) {
    super();
...
var ToolCallDelta = class _ToolCallDelta extends __protoMessage386 {
  constructor(data) {
    super();
...
var ConversationStep = class _ConversationStep extends __protoMessage386 {
  constructor(data) {
    super();
...
var ConversationAction = class _ConversationAction extends __protoMessage386 {
  constructor(data) {
    super();
...
var TriggeringUserInfo = class _TriggeringUserInfo extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var BackgroundTaskCompletionAction = class _BackgroundTaskCompletionAction extends __protoMessage386 {
  constructor(data) {
    super();
    this.completions = [];
    proto3.util.initPartial(data, this);
...
var BackgroundTaskCompletion = class _BackgroundTaskCompletion extends __protoMessage386 {
  constructor(data) {
    super();
    this.taskId = "";
...
var SubagentRunState = class _SubagentRunState extends __protoMessage386 {
  constructor(data) {
    super();
...
var SubagentDispatchStep = class _SubagentDispatchStep extends __protoMessage386 {
  constructor(data) {
    super();
    this.stepIndex = 0;
    this.toolCallId = "";
...
var CancelSubagentAction = class _CancelSubagentAction extends __protoMessage386 {
  constructor(data) {
    super();
    this.subagentId = "";
    proto3.util.initPartial(data, this);
...
var BackgroundShellAction = class _BackgroundShellAction extends __protoMessage386 {
  constructor(data) {
    super();
    this.toolCallId = "";
    proto3.util.initPartial(data, this);
...
var BackgroundSubagentAction = class _BackgroundSubagentAction extends __protoMessage386 {
  constructor(data) {
    super();
    this.toolCallId = "";
    proto3.util.initPartial(data, this);
...
var InterruptedPendingToolCallResolution = class _InterruptedPendingToolCallResolution extends __protoMessage386 {
  constructor(data) {
    super();
    this.toolCallId = "";
...
var InterruptedPendingToolCallResolutions = class _InterruptedPendingToolCallResolutions extends __protoMessage386 {
  constructor(data) {
    super();
    this.resolutions = [];
    proto3.util.initPartial(data, this);
...
var ConversationHistory = class _ConversationHistory extends __protoMessage386 {
  constructor(data) {
    super();
    this.messages = [];
    proto3.util.initPartial(data, this);
...
var ConversationHistoryMessage = class _ConversationHistoryMessage extends __protoMessage386 {
  constructor(data) {
    super();
    this.message = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var ConversationHistoryUserMessage = class _ConversationHistoryUserMessage extends __protoMessage386 {
  constructor(data) {
    super();
    this.content = [];
    proto3.util.initPartial(data, this);
...
var ConversationHistoryUserContent = class _ConversationHistoryUserContent extends __protoMessage386 {
  constructor(data) {
    super();
...
var ConversationHistoryTextContent = class _ConversationHistoryTextContent extends __protoMessage386 {
  constructor(data) {
    super();
    this.text = "";
    proto3.util.initPartial(data, this);
...
var ConversationHistoryImageContent = class _ConversationHistoryImageContent extends __protoMessage386 {
  constructor(data) {
    super();
    this.data = "";
    proto3.util.initPartial(data, this);
...
var ConversationHistoryAssistantMessage = class _ConversationHistoryAssistantMessage extends __protoMessage386 {
  constructor(data) {
    super();
    this.content = [];
    proto3.util.initPartial(data, this);
...
var ConversationHistoryAssistantContent = class _ConversationHistoryAssistantContent extends __protoMessage386 {
  constructor(data) {
    super();
    this.content = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var ConversationHistoryReasoningContent = class _ConversationHistoryReasoningContent extends __protoMessage386 {
  constructor(data) {
    super();
    this.text = "";
    proto3.util.initPartial(data, this);
...
var ConversationHistoryRedactedReasoningContent = class _ConversationHistoryRedactedReasoningContent extends __protoMessage386 {
  constructor(data) {
    super();
    this.data = "";
    proto3.util.initPartial(data, this);
...
var ConversationHistoryToolCall = class _ConversationHistoryToolCall extends __protoMessage386 {
  constructor(data) {
    super();
    this.toolCallId = "";
    this.toolName = "";
...
var ConversationHistoryToolMessage = class _ConversationHistoryToolMessage extends __protoMessage386 {
  constructor(data) {
    super();
    this.toolCallId = "";
    this.toolName = "";
...
var ConversationHistoryToolResultContent = class _ConversationHistoryToolResultContent extends __protoMessage386 {
  constructor(data) {
    super();
    this.content = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var UserMessageAction = class _UserMessageAction extends __protoMessage386 {
  constructor(data) {
    super();
...
var SubscriptionNotificationAction = class _SubscriptionNotificationAction extends __protoMessage386 {
  constructor(data) {
    super();
    this.notifications = [];
    proto3.util.initPartial(data, this);
...
var GoalContinuationAction = class _GoalContinuationAction extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var InjectContextAction = class _InjectContextAction extends __protoMessage386 {
  constructor(data) {
    super();
    this.injectionId = "";
    this.expectedRunId = "";
...
var UserContextInjection = class _UserContextInjection extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SystemContextInjection = class _SystemContextInjection extends __protoMessage386 {
  constructor(data) {
    super();
    this.producer = "";
    this.content = "";
...
var ContextInjectionState = class _ContextInjectionState extends __protoMessage386 {
  constructor(data) {
    super();
...
var ContextInjectionQueued = class _ContextInjectionQueued extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ContextInjectionDelivered = class _ContextInjectionDelivered extends __protoMessage386 {
  constructor(data) {
    super();
    this.step = 0;
...
var ContextInjectionQueuedForNextTurn = class _ContextInjectionQueuedForNextTurn extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ContextInjectionCancelled = class _ContextInjectionCancelled extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ContextInjectionRejected = class _ContextInjectionRejected extends __protoMessage386 {
  constructor(data) {
    super();
    this.reason = "";
    proto3.util.initPartial(data, this);
...
var SubmittedCustomMode = class _SubmittedCustomMode extends __protoMessage386 {
  constructor(data) {
    super();
    this.id = "";
    this.label = "";
...
var CustomModeDescriptor = class _CustomModeDescriptor extends __protoMessage386 {
  constructor(data) {
    super();
    this.id = "";
    this.label = "";
...
var SubmittedExitedCustomMode = class _SubmittedExitedCustomMode extends __protoMessage386 {
  constructor(data) {
    super();
    this.id = "";
    this.label = "";
...
var CustomModeExitIntent = class _CustomModeExitIntent extends __protoMessage386 {
  constructor(data) {
    super();
...
var CustomModeIntent = class _CustomModeIntent extends __protoMessage386 {
  constructor(data) {
    super();
...
var CancelAction = class _CancelAction extends __protoMessage386 {
  constructor(data) {
    super();
    this.reason = "";
    proto3.util.initPartial(data, this);
...
var ResumeAction = class _ResumeAction extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var AsyncAskQuestionCompletionAction = class _AsyncAskQuestionCompletionAction extends __protoMessage386 {
  constructor(data) {
    super();
...
var SummarizeAction = class _SummarizeAction extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ShellCommandAction = class _ShellCommandAction extends __protoMessage386 {
  constructor(data) {
    super();
    this.execId = "";
    proto3.util.initPartial(data, this);
...
var StartPlanAction = class _StartPlanAction extends __protoMessage386 {
  constructor(data) {
    super();
    this.isSpec = false;
    proto3.util.initPartial(data, this);
...
var ExecutePlanAction = class _ExecutePlanAction extends __protoMessage386 {
  constructor(data) {
    super();
...
var SubscriptionEventDisplay = class _SubscriptionEventDisplay extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var UserDisplayInfo = class _UserDisplayInfo extends __protoMessage386 {
  constructor(data) {
    super();
    this.userId = 0;
    proto3.util.initPartial(data, this);
...
var ExecutePlanInfo = class _ExecutePlanInfo extends __protoMessage386 {
  constructor(data) {
    super();
    this.planId = "";
    this.planTitle = "";
...
var ProjectDetails = class _ProjectDetails extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ProjectSubagentDetails = class _ProjectSubagentDetails extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ProjectSideChatDetails = class _ProjectSideChatDetails extends __protoMessage386 {
  constructor(data) {
    super();
    this.storeDir = "";
    proto3.util.initPartial(data, this);
...
var UserMessage = class _UserMessage extends __protoMessage386 {
  constructor(data) {
    super();
    this.text = "";
    this.messageId = "";
...
var UserMessage_SimulatedMessageMetadata = class _UserMessage_SimulatedMessageMetadata extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var AssistantMessage = class _AssistantMessage extends __protoMessage386 {
  constructor(data) {
    super();
    this.text = "";
    proto3.util.initPartial(data, this);
...
var ThinkingMessage = class _ThinkingMessage extends __protoMessage386 {
  constructor(data) {
    super();
    this.text = "";
    this.durationMs = 0;
...
var ShellCommand = class _ShellCommand extends __protoMessage386 {
  constructor(data) {
    super();
    this.command = "";
    proto3.util.initPartial(data, this);
...
var ShellOutput = class _ShellOutput extends __protoMessage386 {
  constructor(data) {
    super();
    this.stdout = "";
    this.stderr = "";
...
var ConversationTurn = class _ConversationTurn extends __protoMessage386 {
  constructor(data) {
    super();
...
var ConversationPlan = class _ConversationPlan extends __protoMessage386 {
  constructor(data) {
    super();
    this.plan = "";
    proto3.util.initPartial(data, this);
...
var PlanRegistryEntry = class _PlanRegistryEntry extends __protoMessage386 {
  constructor(data) {
    super();
    this.id = "";
    this.path = "";
...
var GoalState = class _GoalState extends __protoMessage386 {
  constructor(data) {
    super();
    this.conversationId = "";
    this.goalId = "";
...
var ConversationTurnStructure = class _ConversationTurnStructure extends __protoMessage386 {
  constructor(data) {
    super();
    this.turn = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var AgentConversationTurn = class _AgentConversationTurn extends __protoMessage386 {
  constructor(data) {
    super();
    this.steps = [];
    proto3.util.initPartial(data, this);
...
var AgentConversationTurnStructure = class _AgentConversationTurnStructure extends __protoMessage386 {
  constructor(data) {
    super();
...
var ShellConversationTurn = class _ShellConversationTurn extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ShellConversationTurnStructure = class _ShellConversationTurnStructure extends __protoMessage386 {
  constructor(data) {
    super();
...
var ConversationSummary = class _ConversationSummary extends __protoMessage386 {
  constructor(data) {
    super();
    this.summary = "";
    proto3.util.initPartial(data, this);
...
var ConversationSummaryArchive = class _ConversationSummaryArchive extends __protoMessage386 {
  constructor(data) {
    super();
...
var PromptTokenBreakdownCategory = class _PromptTokenBreakdownCategory extends __protoMessage386 {
  constructor(data) {
    super();
    this.id = "";
    this.label = "";
...
var PromptTokenBreakdownSnapshot = class _PromptTokenBreakdownSnapshot extends __protoMessage386 {
  constructor(data) {
    super();
...
var PromptContextSourceRef = class _PromptContextSourceRef extends __protoMessage386 {
  constructor(data) {
    super();
    this.sourceType = "";
    this.messageIndex = 0;
...
var PromptContextNode = class _PromptContextNode extends __protoMessage386 {
  constructor(data) {
    super();
    this.id = "";
    this.kind = "";
...
var PromptContextUsageTree = class _PromptContextUsageTree extends __protoMessage386 {
  constructor(data) {
    super();
...
var PromptContextUsageSnapshot = class _PromptContextUsageSnapshot extends __protoMessage386 {
  constructor(data) {
    super();
...
var ConversationTokenDetails = class _ConversationTokenDetails extends __protoMessage386 {
  constructor(data) {
    super();
    this.usedTokens = 0;
    this.maxTokens = 0;
...
var FileState = class _FileState extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var FileStateStructure = class _FileStateStructure extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var StepTiming = class _StepTiming extends __protoMessage386 {
  constructor(data) {
    super();
...
var ConversationState = class _ConversationState extends __protoMessage386 {
  constructor(data) {
    super();
    this.rootPromptMessagesJson = [];
    this.turns = [];
...
var CommunicateUpdateHistoryEntry = class _CommunicateUpdateHistoryEntry extends __protoMessage386 {
  constructor(data) {
    super();
    this.step = "";
    this.messageIndex = 0;
...
var CommunicateUpdateTurnState = class _CommunicateUpdateTurnState extends __protoMessage386 {
  constructor(data) {
    super();
    this.history = [];
    proto3.util.initPartial(data, this);
...
var SubagentPersistedState = class _SubagentPersistedState extends __protoMessage386 {
  constructor(data) {
    super();
...
var CloudSubagentReference = class _CloudSubagentReference extends __protoMessage386 {
  constructor(data) {
    super();
    this.bcId = "";
    proto3.util.initPartial(data, this);
...
var TrackedGitRepo = class _TrackedGitRepo extends __protoMessage386 {
  constructor(data) {
    super();
    this.repoPath = "";
    this.branchName = "";
...
var ConversationStateStructure = class _ConversationStateStructure extends __protoMessage386 {
  constructor(data) {
    super();
    this.rootPromptMessagesJson = [];
    this.turns = [];
...
var ThinkingDetails = class _ThinkingDetails extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ClientLlmGatewayCredential = class _ClientLlmGatewayCredential extends __protoMessage386 {
  constructor(data) {
    super();
    this.bearerToken = "";
    proto3.util.initPartial(data, this);
...
var ModelDetails2 = class _ModelDetails extends __protoMessage386 {
  constructor(data) {
    super();
    this.modelId = "";
    this.displayModelId = "";
...
var SubagentModelOverride = class _SubagentModelOverride extends __protoMessage386 {
  constructor(data) {
    super();
    this.subagentType = "";
...
var PreFetchedBlob = class _PreFetchedBlob extends __protoMessage386 {
  constructor(data) {
    super();
...
var AgentRunRequest = class _AgentRunRequest extends __protoMessage386 {
  constructor(data) {
    super();
...
var TextDeltaUpdate = class _TextDeltaUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.text = "";
...
var RoutedModelUpdate = class _RoutedModelUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.displayName = "";
    proto3.util.initPartial(data, this);
...
var ToolCallStartedUpdate = class _ToolCallStartedUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.callId = "";
    this.modelCallId = "";
...
var ToolCallCompletedUpdate = class _ToolCallCompletedUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.callId = "";
    this.modelCallId = "";
...
var ToolCallDeltaUpdate = class _ToolCallDeltaUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.callId = "";
    this.modelCallId = "";
...
var PartialToolCallUpdate = class _PartialToolCallUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.callId = "";
    this.argsTextDelta = "";
...
var ThinkingDeltaUpdate = class _ThinkingDeltaUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.text = "";
    proto3.util.initPartial(data, this);
...
var ThinkingCompletedUpdate = class _ThinkingCompletedUpdate extends __protoMessage386 {
  constructor(data) {
    super();
...
var TokenDeltaUpdate = class _TokenDeltaUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.tokens = 0;
    proto3.util.initPartial(data, this);
...
var SummaryUpdate = class _SummaryUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.summary = "";
    proto3.util.initPartial(data, this);
...
var SummaryStartedUpdate = class _SummaryStartedUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var HeartbeatUpdate = class _HeartbeatUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SummaryCompletedUpdate = class _SummaryCompletedUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ShellOutputDeltaUpdate = class _ShellOutputDeltaUpdate extends __protoMessage386 {
  constructor(data) {
    super();
...
var TurnEndedUpdate = class _TurnEndedUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var UserMessageAppendedUpdate = class _UserMessageAppendedUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var StepStartedUpdate = class _StepStartedUpdate extends __protoMessage386 {
  constructor(data) {
    super();
...
var StepCompletedUpdate = class _StepCompletedUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.stepId = protoInt64.zero;
...
var PromptSuggestionUpdate = class _PromptSuggestionUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.suggestion = "";
    proto3.util.initPartial(data, this);
...
var ActiveBranchChange = class _ActiveBranchChange extends __protoMessage386 {
  constructor(data) {
    super();
    this.path = "";
    this.branchName = "";
...
var FeedbackRequestCategory = class _FeedbackRequestCategory extends __protoMessage386 {
  constructor(data) {
    super();
    this.id = "";
    this.label = "";
...
var FeedbackRequestCategoryGroup = class _FeedbackRequestCategoryGroup extends __protoMessage386 {
  constructor(data) {
    super();
    this.id = "";
    this.prompt = "";
...
var FeedbackRequestUpdate = class _FeedbackRequestUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.requestId = "";
    this.categories = [];
...
var ResponseComparisonStarted = class _ResponseComparisonStarted extends __protoMessage386 {
  constructor(data) {
    super();
...
var ResponseComparisonTextDelta = class _ResponseComparisonTextDelta extends __protoMessage386 {
  constructor(data) {
    super();
    this.text = "";
    proto3.util.initPartial(data, this);
...
var ResponseComparisonCompleted = class _ResponseComparisonCompleted extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ResponseComparisonSkipped = class _ResponseComparisonSkipped extends __protoMessage386 {
  constructor(data) {
    super();
...
var ResponseComparisonUpdate = class _ResponseComparisonUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.comparisonId = "";
    this.event = { case: void 0 };
...
var InteractionUpdate = class _InteractionUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.message = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var ContextInjectionStateUpdate = class _ContextInjectionStateUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.injectionId = "";
    proto3.util.initPartial(data, this);
...
var PostRequestPromptUpdate = class _PostRequestPromptUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.title = "";
    this.message = "";
...
var GrokBotNudgeUpdate = class _GrokBotNudgeUpdate extends __protoMessage386 {
  constructor(data) {
    super();
    this.job = "";
    this.description = "";
...
var InteractionQuery = class _InteractionQuery extends __protoMessage386 {
  constructor(data) {
    super();
    this.id = 0;
...
var InteractionResponse = class _InteractionResponse extends __protoMessage386 {
  constructor(data) {
    super();
    this.id = 0;
    this.result = { case: void 0 };
...
var AskQuestionInteractionQuery = class _AskQuestionInteractionQuery extends __protoMessage386 {
  constructor(data) {
    super();
    this.toolCallId = "";
    proto3.util.initPartial(data, this);
...
var AskQuestionInteractionResponse = class _AskQuestionInteractionResponse extends __protoMessage386 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var TaskToolCallArgsProto = class _TaskToolCallArgsProto extends __protoMessage386 {
  constructor(data) {
    super();
    this.description = "";
    this.prompt = "";
...
var SubagentCredentials = class _SubagentCredentials extends __protoMessage386 {
  constructor(data) {
    super();
    this.credentials = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var CloudSubagentInheritedContext = class _CloudSubagentInheritedContext extends __protoMessage386 {
  constructor(data) {
    super();
    this.resolved = false;
...
var PreparedTaskSubagent = class _PreparedTaskSubagent extends __protoMessage386 {
  constructor(data) {
    super();
    this.subagentId = "";
