...
var UpdatePrCodeTourExecutionMode = /* @__PURE__ */ enumType2(proto3, __protoPackage58, "UpdatePrCodeTourExecutionMode", [[0, "UNSPECIFIED"], [1, "SERVER_SCHEDULED"], [2, "CLIENT_REQUIRED"], [3, "SKIPPED"], [4, "EDITED"]], 1);
var UpdatePrCodeTourArgs = class _UpdatePrCodeTourArgs extends __protoMessage358 {
  constructor(data) {
    super();
    this.feedback = "";
    this.toolCallId = "";
...
var UpdatePrCodeTourResult = class _UpdatePrCodeTourResult extends __protoMessage358 {
  constructor(data) {
    super();
...
var UpdatePrCodeTourSuccess = class _UpdatePrCodeTourSuccess extends __protoMessage358 {
  constructor(data) {
    super();
    this.revisionId = "";
    this.message = "";
...
var UpdatePrCodeTourError = class _UpdatePrCodeTourError extends __protoMessage358 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var UpdatePrCodeTourToolCall = class _UpdatePrCodeTourToolCall extends __protoMessage358 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
