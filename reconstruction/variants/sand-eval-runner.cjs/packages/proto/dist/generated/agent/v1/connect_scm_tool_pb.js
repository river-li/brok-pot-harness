...
var ConnectScmArgs = class _ConnectScmArgs extends __protoMessage373 {
  constructor(data) {
    super();
    this.toolCallId = "";
...
var ConnectScmGithub = class _ConnectScmGithub extends __protoMessage373 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ConnectScmGithubRepository = class _ConnectScmGithubRepository extends __protoMessage373 {
  constructor(data) {
    super();
    this.owner = "";
    this.repo = "";
...
var ConnectScmResult = class _ConnectScmResult extends __protoMessage373 {
  constructor(data) {
    super();
...
var ConnectScmSuccess = class _ConnectScmSuccess extends __protoMessage373 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ConnectScmError = class _ConnectScmError extends __protoMessage373 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var ConnectScmRejected = class _ConnectScmRejected extends __protoMessage373 {
  constructor(data) {
    super();
    this.reason = "";
    proto3.util.initPartial(data, this);
...
var ConnectScmToolCall = class _ConnectScmToolCall extends __protoMessage373 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ConnectScmRequestQuery = class _ConnectScmRequestQuery extends __protoMessage373 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ConnectScmRequestResponse = class _ConnectScmRequestResponse extends __protoMessage373 {
  constructor(data) {
    super();
    this.result = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var ConnectScmRequestResponse_Approved = class _ConnectScmRequestResponse_Approved extends __protoMessage373 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ConnectScmRequestResponse_Rejected = class _ConnectScmRequestResponse_Rejected extends __protoMessage373 {
  constructor(data) {
    super();
    this.reason = "";
    proto3.util.initPartial(data, this);
...
var ConnectScmRequestResponse_Failed = class _ConnectScmRequestResponse_Failed extends __protoMessage373 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
