...
init_esm13();
init_compact();
var __protoPackage88 = "agent.v1.";
var __protoMessage387 = class extends CompactMessage {
  static get runtime() {
...
var WriteArgs = class _WriteArgs extends __protoMessage387 {
  constructor(data) {
    super();
    this.path = "";
    this.fileText = "";
...
var WriteResult = class _WriteResult extends __protoMessage387 {
  constructor(data) {
    super();
...
var WriteSuccess = class _WriteSuccess extends __protoMessage387 {
  constructor(data) {
    super();
    this.path = "";
    this.linesCreated = 0;
...
var WritePermissionDenied = class _WritePermissionDenied extends __protoMessage387 {
  constructor(data) {
    super();
    this.path = "";
    this.directory = "";
...
var WriteNoSpace = class _WriteNoSpace extends __protoMessage387 {
  constructor(data) {
    super();
    this.path = "";
    proto3.util.initPartial(data, this);
...
var WriteError = class _WriteError extends __protoMessage387 {
  constructor(data) {
    super();
    this.path = "";
    this.error = "";
...
var WriteRejected = class _WriteRejected extends __protoMessage387 {
  constructor(data) {
    super();
    this.path = "";
    this.reason = "";
