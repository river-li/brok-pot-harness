...
init_ls_exec_pb();
init_compact();
var __protoPackage86 = "agent.v1.";
var __protoMessage385 = class extends CompactMessage {
  static get runtime() {
...
var SelectedPluginCapabilityType = /* @__PURE__ */ enumType2(proto3, __protoPackage86, "SelectedPluginCapabilityType", [[0, "UNSPECIFIED"], [1, "COMMAND"], [2, "SKILL"], [3, "SUBAGENT"]], 1);
var SelectedImage = class _SelectedImage extends __protoMessage385 {
  constructor(data) {
    super();
...
var SelectedImage_BlobIdWithData = class _SelectedImage_BlobIdWithData extends __protoMessage385 {
  constructor(data) {
    super();
...
var SelectedImage_Dimension = class _SelectedImage_Dimension extends __protoMessage385 {
  constructor(data) {
    super();
    this.width = 0;
    this.height = 0;
...
var PromptUploadRef = class _PromptUploadRef extends __protoMessage385 {
  constructor(data) {
    super();
    this.uploadId = "";
    proto3.util.initPartial(data, this);
...
var SelectedDocument = class _SelectedDocument extends __protoMessage385 {
  constructor(data) {
    super();
    this.dataOrBlobId = { case: void 0 };
    this.uuid = "";
...
var SelectedDocument_BlobIdWithData = class _SelectedDocument_BlobIdWithData extends __protoMessage385 {
  constructor(data) {
    super();
    this.blobId = new Uint8Array(0);
    this.data = new Uint8Array(0);
...
var SelectedVideo = class _SelectedVideo extends __protoMessage385 {
  constructor(data) {
    super();
    this.dataOrBlobId = { case: void 0 };
    this.uuid = "";
...
var SelectedVideo_BlobIdWithData = class _SelectedVideo_BlobIdWithData extends __protoMessage385 {
  constructor(data) {
    super();
    this.blobId = new Uint8Array(0);
    this.data = new Uint8Array(0);
...
var SelectedVideo_SignedUrl = class _SelectedVideo_SignedUrl extends __protoMessage385 {
  constructor(data) {
    super();
    this.url = "";
    this.key = "";
...
var ExtraContextEntry = class _ExtraContextEntry extends __protoMessage385 {
  constructor(data) {
    super();
    this.dataOrBlobId = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var SelectedFile = class _SelectedFile extends __protoMessage385 {
  constructor(data) {
    super();
    this.content = "";
    this.path = "";
...
var SelectedCodeSelection = class _SelectedCodeSelection extends __protoMessage385 {
  constructor(data) {
    super();
    this.content = "";
    this.path = "";
...
var SelectedTerminal = class _SelectedTerminal extends __protoMessage385 {
  constructor(data) {
    super();
    this.content = "";
    proto3.util.initPartial(data, this);
...
var SelectedTerminalSelection = class _SelectedTerminalSelection extends __protoMessage385 {
  constructor(data) {
    super();
    this.content = "";
    proto3.util.initPartial(data, this);
...
var SelectedFolder = class _SelectedFolder extends __protoMessage385 {
  constructor(data) {
    super();
    this.path = "";
    proto3.util.initPartial(data, this);
...
var SelectedExternalLink = class _SelectedExternalLink extends __protoMessage385 {
  constructor(data) {
    super();
    this.url = "";
    this.uuid = "";
...
var SelectedCursorRule = class _SelectedCursorRule extends __protoMessage385 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SelectedGitDiff = class _SelectedGitDiff extends __protoMessage385 {
  constructor(data) {
    super();
    this.content = "";
...
var SelectedGitDiffFromBranchToMain = class _SelectedGitDiffFromBranchToMain extends __protoMessage385 {
  constructor(data) {
    super();
    this.content = "";
    this.fullContentLengthCharCount = 0;
...
var SelectedGitCommit = class _SelectedGitCommit extends __protoMessage385 {
  constructor(data) {
    super();
    this.sha = "";
    this.message = "";
...
var SelectedPullRequest = class _SelectedPullRequest extends __protoMessage385 {
  constructor(data) {
    super();
    this.number = 0;
    this.url = "";
...
var SelectedGitPRDiffSelection = class _SelectedGitPRDiffSelection extends __protoMessage385 {
  constructor(data) {
    super();
    this.prUrl = "";
    this.filePath = "";
...
var SelectedPluginCapabilityRef = class _SelectedPluginCapabilityRef extends __protoMessage385 {
  constructor(data) {
    super();
    this.pluginId = "";
...
var SelectedCursorCommand = class _SelectedCursorCommand extends __protoMessage385 {
  constructor(data) {
    super();
    this.name = "";
    this.content = "";
...
var SelectedDocumentation = class _SelectedDocumentation extends __protoMessage385 {
  constructor(data) {
    super();
    this.docId = "";
    this.name = "";
...
var SelectedPastChat = class _SelectedPastChat extends __protoMessage385 {
  constructor(data) {
    super();
    this.agentId = "";
    this.name = "";
...
var RecentAgent = class _RecentAgent extends __protoMessage385 {
  constructor(data) {
    super();
    this.name = "";
    this.path = "";
...
var RecentAgentsContext = class _RecentAgentsContext extends __protoMessage385 {
  constructor(data) {
    super();
    this.recentAgents = [];
    proto3.util.initPartial(data, this);
...
var CallFrame = class _CallFrame extends __protoMessage385 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var StackTrace = class _StackTrace extends __protoMessage385 {
  constructor(data) {
    super();
    this.callFrames = [];
    proto3.util.initPartial(data, this);
...
var SelectedConsoleLog = class _SelectedConsoleLog extends __protoMessage385 {
  constructor(data) {
    super();
    this.message = "";
    this.timestamp = 0;
...
var SelectedUIElement = class _SelectedUIElement extends __protoMessage385 {
  constructor(data) {
    super();
    this.element = "";
    this.xpath = "";
...
var SelectedSubagent = class _SelectedSubagent extends __protoMessage385 {
  constructor(data) {
    super();
    this.name = "";
    proto3.util.initPartial(data, this);
...
var SelectedBrowser = class _SelectedBrowser extends __protoMessage385 {
  constructor(data) {
    super();
    this.browserId = "";
    this.url = "";
...
var SelectedAgenticGitActionCommitParams = class _SelectedAgenticGitActionCommitParams extends __protoMessage385 {
  constructor(data) {
    super();
    this.filesToCommit = [];
...
var SelectedAgenticGitActionCreateBranchParams = class _SelectedAgenticGitActionCreateBranchParams extends __protoMessage385 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SelectedAgenticGitFileWithStatus = class _SelectedAgenticGitFileWithStatus extends __protoMessage385 {
  constructor(data) {
    super();
    this.path = "";
    proto3.util.initPartial(data, this);
...
var SelectedAgenticGitActionPushParams = class _SelectedAgenticGitActionPushParams extends __protoMessage385 {
  constructor(data) {
    super();
    this.filesToPush = [];
    proto3.util.initPartial(data, this);
...
var SelectedAgenticGitActionFixMergeConflictsParams = class _SelectedAgenticGitActionFixMergeConflictsParams extends __protoMessage385 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SelectedAgenticGitActionBabysitPrInCloudParams = class _SelectedAgenticGitActionBabysitPrInCloudParams extends __protoMessage385 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SelectedAgenticGitActionUpdateBranchParams = class _SelectedAgenticGitActionUpdateBranchParams extends __protoMessage385 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SelectedAgenticGitActionPullLocallyParams = class _SelectedAgenticGitActionPullLocallyParams extends __protoMessage385 {
  constructor(data) {
    super();
    this.remoteBranch = "";
    proto3.util.initPartial(data, this);
...
var SelectedAgenticGitAction = class _SelectedAgenticGitAction extends __protoMessage385 {
  constructor(data) {
    super();
...
var SelectedGitBranchContext = class _SelectedGitBranchContext extends __protoMessage385 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SelectedContext = class _SelectedContext extends __protoMessage385 {
  constructor(data) {
    super();
    this.selectedImages = [];
    this.extraContext = [];
...
var InvocationContext = class _InvocationContext extends __protoMessage385 {
  constructor(data) {
    super();
...
var InvocationContext_SlackThread = class _InvocationContext_SlackThread extends __protoMessage385 {
  constructor(data) {
    super();
    this.thread = "";
    proto3.util.initPartial(data, this);
...
var InvocationContext_MicrosoftTeamsThread = class _InvocationContext_MicrosoftTeamsThread extends __protoMessage385 {
  constructor(data) {
    super();
    this.thread = "";
    proto3.util.initPartial(data, this);
...
var InvocationContext_GithubPR = class _InvocationContext_GithubPR extends __protoMessage385 {
  constructor(data) {
    super();
    this.title = "";
    this.description = "";
...
var InvocationContext_IdeState = class _InvocationContext_IdeState extends __protoMessage385 {
  constructor(data) {
    super();
    this.visibleFiles = [];
...
var InvocationContext_IdeState_File = class _InvocationContext_IdeState_File extends __protoMessage385 {
  constructor(data) {
    super();
    this.path = "";
    this.totalLines = 0;
...
var InvocationContext_IdeState_File_CursorPosition = class _InvocationContext_IdeState_File_CursorPosition extends __protoMessage385 {
  constructor(data) {
    super();
    this.line = 0;
    this.text = "";
...
var InvocationContext_IdeState_ViewedPullRequest = class _InvocationContext_IdeState_ViewedPullRequest extends __protoMessage385 {
  constructor(data) {
    super();
    this.number = 0;
    this.url = "";
