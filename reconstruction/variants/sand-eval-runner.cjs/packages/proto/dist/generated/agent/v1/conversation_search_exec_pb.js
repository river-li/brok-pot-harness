...
var ConversationSearchSource = /* @__PURE__ */ enumType2(proto3, __protoPackage74, "ConversationSearchSource", [[0, "UNSPECIFIED"], [1, "LOCAL"], [2, "CLOUD_CACHE"]], 1);
var ConversationSearchArgs = class _ConversationSearchArgs extends __protoMessage374 {
  constructor(data) {
    super();
    this.query = "";
    this.toolCallId = "";
...
var ConversationSearchResult = class _ConversationSearchResult extends __protoMessage374 {
  constructor(data) {
    super();
...
var ConversationSearchSuccess = class _ConversationSearchSuccess extends __protoMessage374 {
  constructor(data) {
    super();
    this.hits = [];
...
var ConversationSearchHit = class _ConversationSearchHit extends __protoMessage374 {
  constructor(data) {
    super();
    this.conversationId = "";
    this.title = "";
...
var ConversationSearchError = class _ConversationSearchError extends __protoMessage374 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
