...
var SendMessageText = class _SendMessageText extends __protoMessage362 {
  constructor(data) {
    super();
    this.content = "";
...
var SendMessageAttachment = class _SendMessageAttachment extends __protoMessage362 {
  constructor(data) {
    super();
    this.url = "";
    proto3.util.initPartial(data, this);
...
var SendMessageArgs = class _SendMessageArgs extends __protoMessage362 {
  constructor(data) {
    super();
...
var SendMessageSuccess = class _SendMessageSuccess extends __protoMessage362 {
  constructor(data) {
    super();
...
var SendMessageError = class _SendMessageError extends __protoMessage362 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var SendMessageResult = class _SendMessageResult extends __protoMessage362 {
  constructor(data) {
    super();
...
var SendMessageToolCall = class _SendMessageToolCall extends __protoMessage362 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
