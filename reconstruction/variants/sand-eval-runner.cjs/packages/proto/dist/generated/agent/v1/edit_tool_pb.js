...
var EditArgs = class _EditArgs extends __protoMessage317 {
  constructor(data) {
    super();
    this.path = "";
...
var EditResult = class _EditResult extends __protoMessage317 {
  constructor(data) {
    super();
...
var EditSuccess = class _EditSuccess extends __protoMessage317 {
  constructor(data) {
    super();
    this.path = "";
...
var EditFileNotFound = class _EditFileNotFound extends __protoMessage317 {
  constructor(data) {
    super();
    this.path = "";
    proto3.util.initPartial(data, this);
...
var EditReadPermissionDenied = class _EditReadPermissionDenied extends __protoMessage317 {
  constructor(data) {
    super();
    this.path = "";
    proto3.util.initPartial(data, this);
...
var EditWritePermissionDenied = class _EditWritePermissionDenied extends __protoMessage317 {
  constructor(data) {
    super();
    this.path = "";
    this.error = "";
...
var EditRejected = class _EditRejected extends __protoMessage317 {
  constructor(data) {
    super();
    this.path = "";
    this.reason = "";
...
var EditError = class _EditError extends __protoMessage317 {
  constructor(data) {
    super();
    this.path = "";
    this.error = "";
...
var EditToolCall = class _EditToolCall extends __protoMessage317 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var EditToolCallDelta = class _EditToolCallDelta extends __protoMessage317 {
  constructor(data) {
    super();
