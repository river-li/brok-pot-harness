...
init_compact();
var __protoPackage107 = "agent.v1.";
var __protoMessage3106 = class extends CompactMessage {
  static get runtime() {
...
var LocalPromptQualityInvocationStatus = /* @__PURE__ */ enumType2(proto3, __protoPackage107, "LocalPromptQualityInvocationStatus", [[0, "UNSPECIFIED"], [1, "SUCCESS"], [2, "ERRORED"], [3, "ABORTED"]], 1);
var LocalAgentMailboxGapReason = /* @__PURE__ */ enumType2(proto3, __protoPackage107, "LocalAgentMailboxGapReason", [[0, "UNSPECIFIED"], [1, "TRIMMED"], [2, "LOST"]], 1);
var LocalAgentMailboxEndedReason = /* @__PURE__ */ enumType2(proto3, __protoPackage107, "LocalAgentMailboxEndedReason", [[0, "UNSPECIFIED"], [1, "NO_ACTIVE_SUBSCRIPTIONS"], [2, "STORE_DELETED"], [3, "MIGRATED_TO_CLOUD"]], 1);
var ClientHeartbeat = class _ClientHeartbeat extends __protoMessage3106 {
  constructor(data) {
    super();
...
var PrewarmRequest = class _PrewarmRequest extends __protoMessage3106 {
  constructor(data) {
    super();
...
var AgentClientMessage = class _AgentClientMessage extends __protoMessage3106 {
  constructor(data) {
    super();
...
var TtftBreakdown = class _TtftBreakdown extends __protoMessage3106 {
  constructor(data) {
    super();
...
var AgentServerMessage = class _AgentServerMessage extends __protoMessage3106 {
  constructor(data) {
    super();
    this.message = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var NameAgentRequest = class _NameAgentRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    this.userMessage = "";
    proto3.util.initPartial(data, this);
...
var NameAgentResponse = class _NameAgentResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    this.name = "";
    proto3.util.initPartial(data, this);
...
var UpdateConversationMetadataRequest = class _UpdateConversationMetadataRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversationId = "";
    this.workspacePaths = [];
...
var UpdateConversationMetadataResponse = class _UpdateConversationMetadataResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GetPromptContextUsageRequest = class _GetPromptContextUsageRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversationId = "";
...
var GetPromptContextUsageResponse = class _GetPromptContextUsageResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var CreateTranscriptOverviewRequest = class _CreateTranscriptOverviewRequest extends __protoMessage3106 {
  constructor(data) {
    super();
...
var CreateTranscriptOverviewResponse = class _CreateTranscriptOverviewResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    this.overview = "";
    proto3.util.initPartial(data, this);
...
var GetUsableModelsRequest = class _GetUsableModelsRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    this.customModelIds = [];
    proto3.util.initPartial(data, this);
...
var GetUsableModelsResponse = class _GetUsableModelsResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    this.models = [];
    proto3.util.initPartial(data, this);
...
var GetDefaultModelForCliRequest = class _GetDefaultModelForCliRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GetDefaultModelForCliResponse = class _GetDefaultModelForCliResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GetAllowedModelIntentsRequest = class _GetAllowedModelIntentsRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GetAllowedModelIntentsResponse = class _GetAllowedModelIntentsResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    this.modelIntents = [];
    proto3.util.initPartial(data, this);
...
var BlobEntry = class _BlobEntry extends __protoMessage3106 {
  constructor(data) {
    super();
...
var UploadConversationBlobsRequest = class _UploadConversationBlobsRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversationId = "";
    this.blobs = [];
...
var UploadConversationBlobsResponse = class _UploadConversationBlobsResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var LocalPromptQualityInvocation = class _LocalPromptQualityInvocation extends __protoMessage3106 {
  constructor(data) {
    super();
    this.invocationId = "";
...
var UploadLocalAgentRunToPromptQualityRequest = class _UploadLocalAgentRunToPromptQualityRequest extends __protoMessage3106 {
  constructor(data) {
    super();
...
var UploadLocalAgentRunToPromptQualityResponse = class _UploadLocalAgentRunToPromptQualityResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    this.requestId = "";
...
var GetSignedUrlForAttachedMediaRequest = class _GetSignedUrlForAttachedMediaRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversationId = "";
    proto3.util.initPartial(data, this);
...
var GetSignedUrlForAttachedMediaResponse = class _GetSignedUrlForAttachedMediaResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    this.key = "";
    this.postUrl = "";
...
var NotifyConversationCloneRequest = class _NotifyConversationCloneRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversationId = "";
...
var NotifyConversationCloneResponse = class _NotifyConversationCloneResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GetNewChatNudgeLegacyModelPickerRequest = class _GetNewChatNudgeLegacyModelPickerRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    this.currentModel = "";
    this.maxMode = false;
...
var GetNewChatNudgeLegacyModelPickerResponse = class _GetNewChatNudgeLegacyModelPickerResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var NudgeBumpVariant = class _NudgeBumpVariant extends __protoMessage3106 {
  constructor(data) {
    super();
    this.bannerMessage = "";
    proto3.util.initPartial(data, this);
...
var NudgeAskVariant = class _NudgeAskVariant extends __protoMessage3106 {
  constructor(data) {
    super();
    this.popupMessage = "";
    this.acceptLabel = "";
...
var NudgeSilentSwitchVariant = class _NudgeSilentSwitchVariant extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var NewChatNudge = class _NewChatNudge extends __protoMessage3106 {
  constructor(data) {
    super();
    this.nudgeId = "";
    this.targetModel = "";
...
var ListLocalSubscriptionToolsRequest = class _ListLocalSubscriptionToolsRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var LocalSubscriptionToolDefinition = class _LocalSubscriptionToolDefinition extends __protoMessage3106 {
  constructor(data) {
    super();
    this.toolName = "";
    this.description = "";
...
var ListLocalSubscriptionToolsResponse = class _ListLocalSubscriptionToolsResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    this.tools = [];
    proto3.util.initPartial(data, this);
...
var CallLocalSubscriptionToolRequest = class _CallLocalSubscriptionToolRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversationId = "";
    this.toolName = "";
...
var CallLocalSubscriptionToolResponse = class _CallLocalSubscriptionToolResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    this.resultJson = "";
    this.isError = false;
...
var SubscriptionDeliveryEntry = class _SubscriptionDeliveryEntry extends __protoMessage3106 {
  constructor(data) {
    super();
    this.subscriptionId = "";
    this.eventId = "";
...
var SubscriptionRemovedEntry = class _SubscriptionRemovedEntry extends __protoMessage3106 {
  constructor(data) {
    super();
    this.subscriptionId = "";
    this.inboxRelPath = "";
...
var LocalAgentMailboxEntry = class _LocalAgentMailboxEntry extends __protoMessage3106 {
  constructor(data) {
    super();
...
var StreamLocalAgentMailboxRequest = class _StreamLocalAgentMailboxRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversations = [];
    proto3.util.initPartial(data, this);
...
var StreamLocalAgentMailboxRequest_ConversationCursor = class _StreamLocalAgentMailboxRequest_ConversationCursor extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversationId = "";
    this.afterOffset = "";
...
var LocalAgentMailboxDelivery = class _LocalAgentMailboxDelivery extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversationId = "";
    this.offset = "";
...
var LocalAgentMailboxGap = class _LocalAgentMailboxGap extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversationId = "";
    this.afterOffset = "";
...
var LocalAgentMailboxEnded = class _LocalAgentMailboxEnded extends __protoMessage3106 {
  constructor(data) {
    super();
    this.conversationId = "";
...
var StreamLocalAgentMailboxHeartbeat = class _StreamLocalAgentMailboxHeartbeat extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var StreamLocalAgentMailboxResponse = class _StreamLocalAgentMailboxResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    this.message = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var GetNewChatNudgeParameterizedModelPickerRequest = class _GetNewChatNudgeParameterizedModelPickerRequest extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GetNewChatNudgeParameterizedModelPickerResponse = class _GetNewChatNudgeParameterizedModelPickerResponse extends __protoMessage3106 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var NewChatNudgeV2 = class _NewChatNudgeV2 extends __protoMessage3106 {
  constructor(data) {
    super();
    this.nudgeId = "";
    this.experimentName = "";
