...
var PiGrepToolCall = class _PiGrepToolCall extends __protoMessage370 {
  constructor(data) {
    super();
...
var PiGrepToolArgs = class _PiGrepToolArgs extends __protoMessage370 {
  constructor(data) {
    super();
    this.pattern = "";
    proto3.util.initPartial(data, this);
...
var PiGrepToolResult = class _PiGrepToolResult extends __protoMessage370 {
  constructor(data) {
    super();
...
var PiGrepToolSuccess = class _PiGrepToolSuccess extends __protoMessage370 {
  constructor(data) {
    super();
    this.output = "";
...
var PiGrepToolError = class _PiGrepToolError extends __protoMessage370 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
