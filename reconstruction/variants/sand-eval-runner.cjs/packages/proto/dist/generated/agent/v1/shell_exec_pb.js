...
var init_shell_exec_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/shell_exec_pb.js"() {
    ...
    TimeoutBehavior = /* @__PURE__ */ enumType2(proto3, __protoPackage7, "TimeoutBehavior", [[0, "UNSPECIFIED"], [1, "CANCEL"], [2, "BACKGROUND"]], 1);
    ShellBackgroundReason = /* @__PURE__ */ enumType2(proto3, __protoPackage7, "ShellBackgroundReason", [[0, "UNSPECIFIED"], [1, "TIMEOUT"], [2, "USER_REQUEST"]], 1);
    ForceBackgroundShellStatus = /* @__PURE__ */ enumType2(proto3, __protoPackage7, "ForceBackgroundShellStatus", [[0, "UNSPECIFIED"], [1, "ACCEPTED"], [2, "NOT_FOUND"]], 1);
    ShellAbortReason = /* @__PURE__ */ enumType2(proto3, __protoPackage7, "ShellAbortReason", [[0, "UNSPECIFIED"], [1, "USER_ABORT"], [2, "TIMEOUT"]], 1);
    ShellCommandParsingResult = class _ShellCommandParsingResult extends __protoMessage37 {
      constructor(data) {
        super();
    ...
    ShellCommandParsingResult_ExecutableCommandArg = class _ShellCommandParsingResult_ExecutableCommandArg extends __protoMessage37 {
      constructor(data) {
        super();
        this.type = "";
        this.value = "";
    ...
    ShellCommandParsingResult_ExecutableCommand = class _ShellCommandParsingResult_ExecutableCommand extends __protoMessage37 {
      constructor(data) {
        super();
        this.name = "";
        this.args = [];
    ...
    ShellCommandParsingResult_Redirect = class _ShellCommandParsingResult_Redirect extends __protoMessage37 {
      constructor(data) {
        super();
        this.operator = "";
        this.destinationFds = [];
    ...
    CommandClassifierResult = class _CommandClassifierResult extends __protoMessage37 {
      constructor(data) {
        super();
        this.commands = [];
    ...
    CommandClassifierResult_SuggestedSandboxMode = /* @__PURE__ */ enumType2(proto3, __protoPackage7, "CommandClassifierResult.SuggestedSandboxMode", [[0, "UNSPECIFIED"], [1, "SANDBOX"], [2, "NO_SANDBOX"], [3, "UNDETERMINED"]], 1);
    CommandClassifierResult_ClassifiedCommand = class _CommandClassifierResult_ClassifiedCommand extends __protoMessage37 {
      constructor(data) {
        super();
        this.name = "";
        this.arguments = [];
    ...
    ShellOutputNotificationConfig = class _ShellOutputNotificationConfig extends __protoMessage37 {
      constructor(data) {
        super();
        this.pattern = "";
        this.reason = "";
    ...
    ForceBackgroundShellArgs = class _ForceBackgroundShellArgs extends __protoMessage37 {
      constructor(data) {
        super();
        this.toolCallId = "";
        proto3.util.initPartial(data, this);
    ...
    ForceBackgroundShellResult = class _ForceBackgroundShellResult extends __protoMessage37 {
      constructor(data) {
        super();
    ...
    ShellHookApprovalRequirement = class _ShellHookApprovalRequirement extends __protoMessage37 {
      constructor(data) {
        super();
    ...
    ShellHookApprovalRequirement_Kind = /* @__PURE__ */ enumType2(proto3, __protoPackage7, "ShellHookApprovalRequirement.Kind", [[0, "UNSPECIFIED"], [1, "FORCE_PROMPT"]], 1);
    ShellArgs = class _ShellArgs extends __protoMessage37 {
      constructor(data) {
        super();
        this.command = "";
    ...
    ShellResult = class _ShellResult extends __protoMessage37 {
      constructor(data) {
        super();
    ...
    ShellStreamStdout = class _ShellStreamStdout extends __protoMessage37 {
      constructor(data) {
        super();
        this.data = "";
        proto3.util.initPartial(data, this);
    ...
    ShellStreamStderr = class _ShellStreamStderr extends __protoMessage37 {
      constructor(data) {
        super();
        this.data = "";
        proto3.util.initPartial(data, this);
    ...
    ShellStreamExit = class _ShellStreamExit extends __protoMessage37 {
      constructor(data) {
        super();
        this.code = 0;
        this.cwd = "";
    ...
    ShellStreamStart = class _ShellStreamStart extends __protoMessage37 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ShellStreamBackgrounded = class _ShellStreamBackgrounded extends __protoMessage37 {
      constructor(data) {
        super();
        this.shellId = 0;
        this.command = "";
    ...
    ShellStreamHookContext = class _ShellStreamHookContext extends __protoMessage37 {
      constructor(data) {
        super();
    ...
    ShellSandboxUnsupported = class _ShellSandboxUnsupported extends __protoMessage37 {
      constructor(data) {
        super();
        this.command = "";
        this.workingDirectory = "";
    ...
    ShellStream = class _ShellStream extends __protoMessage37 {
      constructor(data) {
        super();
    ...
    ShellSuccess = class _ShellSuccess extends __protoMessage37 {
      constructor(data) {
        super();
        this.command = "";
        this.workingDirectory = "";
    ...
    ShellFailure = class _ShellFailure extends __protoMessage37 {
      constructor(data) {
        super();
        this.command = "";
        this.workingDirectory = "";
    ...
    ShellTimeout = class _ShellTimeout extends __protoMessage37 {
      constructor(data) {
        super();
        this.command = "";
        this.workingDirectory = "";
    ...
    ShellRejected = class _ShellRejected extends __protoMessage37 {
      constructor(data) {
        super();
        this.command = "";
        this.workingDirectory = "";
    ...
    ShellPermissionDenied = class _ShellPermissionDenied extends __protoMessage37 {
      constructor(data) {
        super();
        this.command = "";
        this.workingDirectory = "";
    ...
    ShellSpawnError = class _ShellSpawnError extends __protoMessage37 {
      constructor(data) {
        super();
        this.command = "";
        this.workingDirectory = "";
