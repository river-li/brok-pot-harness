...
var ApiKeyCredentials = class _ApiKeyCredentials extends __protoMessage3 {
  constructor(data) {
    super();
    this.apiKey = "";
...
var AzureCredentials = class _AzureCredentials extends __protoMessage3 {
  constructor(data) {
    super();
    this.apiKey = "";
    this.baseUrl = "";
...
var BedrockCredentials = class _BedrockCredentials extends __protoMessage3 {
  constructor(data) {
    super();
    this.accessKey = "";
    this.secretKey = "";
...
var RequestedModel = class _RequestedModel extends __protoMessage3 {
  constructor(data) {
    super();
    this.modelId = "";
    this.maxMode = false;
...
var RequestedModel_ModelParameterValue = class _RequestedModel_ModelParameterValue extends __protoMessage3 {
  constructor(data) {
    super();
    this.id = "";
    this.value = "";
