...
var __protoPackage5, __protoMessage35, Range2, Position, OutputLocation, SmartModeApproval;
var init_utils_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/utils_pb.js"() {
    "use strict";
    init_esm13();
    init_compact();
    __protoPackage5 = "agent.v1.";
    ...
    Range2 = class _Range extends __protoMessage35 {
      constructor(data) {
        super();
    ...
    Position = class _Position extends __protoMessage35 {
      constructor(data) {
        super();
        this.line = 0;
        this.column = 0;
    ...
    OutputLocation = class _OutputLocation extends __protoMessage35 {
      constructor(data) {
        super();
        this.filePath = "";
    ...
    SmartModeApproval = class _SmartModeApproval extends __protoMessage35 {
      constructor(data) {
        super();
        this.requestId = "";
        this.reason = "";
