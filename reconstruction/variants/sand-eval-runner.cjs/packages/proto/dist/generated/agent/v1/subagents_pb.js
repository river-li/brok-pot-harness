...
var init_subagents_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/subagents_pb.js"() {
    ...
    CustomSubagentPermissionMode = /* @__PURE__ */ enumType2(proto3, __protoPackage3, "CustomSubagentPermissionMode", [[0, "UNSPECIFIED"], [1, "DEFAULT"], [2, "READONLY"], [3, "AGENT_ONLY"]], 1);
    SubagentExecutionEnvironment = /* @__PURE__ */ enumType2(proto3, __protoPackage3, "SubagentExecutionEnvironment", [[0, "UNSPECIFIED"], [1, "LOCAL"], [2, "CLOUD"]], 1);
    SubagentBackgroundReason = /* @__PURE__ */ enumType2(proto3, __protoPackage3, "SubagentBackgroundReason", [[0, "UNSPECIFIED"], [1, "AGENT_REQUEST"], [2, "USER_REQUEST"], [3, "QUEUED_FOLLOW_UP"]], 1);
    BackgroundTaskCompletionReason = /* @__PURE__ */ enumType2(proto3, __protoPackage3, "BackgroundTaskCompletionReason", [[0, "UNSPECIFIED"], [1, "TASK_FINISHED"], [2, "TASK_PROGRESS"], [3, "WORKER_REPARENTED"], [4, "WORKER_MESSAGE"], [5, "WORKER_NEEDS_ATTENTION"]], 1);
    TaskMode = /* @__PURE__ */ enumType2(proto3, __protoPackage3, "TaskMode", [[0, "UNSPECIFIED"], [1, "AGENT"], [2, "PLAN"]], 1);
    SubagentType = class _SubagentType extends __protoMessage33 {
      constructor(data) {
        super();
    ...
    SubagentTypeUnspecified = class _SubagentTypeUnspecified extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeComputerUse = class _SubagentTypeComputerUse extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeExplore = class _SubagentTypeExplore extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeMediaReview = class _SubagentTypeMediaReview extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeBash = class _SubagentTypeBash extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeShell = class _SubagentTypeShell extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeBrowserUse = class _SubagentTypeBrowserUse extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeVmSetupHelper = class _SubagentTypeVmSetupHelper extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeDebug = class _SubagentTypeDebug extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeCursorGuide = class _SubagentTypeCursorGuide extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeWatchVideo = class _SubagentTypeWatchVideo extends __protoMessage33 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SubagentTypeCustom = class _SubagentTypeCustom extends __protoMessage33 {
      constructor(data) {
        super();
        this.name = "";
        proto3.util.initPartial(data, this);
    ...
    CustomSubagent = class _CustomSubagent extends __protoMessage33 {
      constructor(data) {
        super();
        this.fullPath = "";
        this.name = "";
