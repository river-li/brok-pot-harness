...
var ReadLintsToolCall = class _ReadLintsToolCall extends __protoMessage321 {
  constructor(data) {
    super();
...
var ReadLintsToolArgs = class _ReadLintsToolArgs extends __protoMessage321 {
  constructor(data) {
    super();
    this.paths = [];
    proto3.util.initPartial(data, this);
...
var ReadLintsToolResult = class _ReadLintsToolResult extends __protoMessage321 {
  constructor(data) {
    super();
...
var ReadLintsToolSuccess = class _ReadLintsToolSuccess extends __protoMessage321 {
  constructor(data) {
    super();
...
var FileDiagnostics = class _FileDiagnostics extends __protoMessage321 {
  constructor(data) {
    super();
    this.path = "";
    this.diagnostics = [];
...
var DiagnosticItem = class _DiagnosticItem extends __protoMessage321 {
  constructor(data) {
    super();
...
var DiagnosticRange = class _DiagnosticRange extends __protoMessage321 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ReadLintsToolError = class _ReadLintsToolError extends __protoMessage321 {
  constructor(data) {
    super();
    this.errorMessage = "";
    proto3.util.initPartial(data, this);
