...
var EditPrLabelsArgs = class _EditPrLabelsArgs extends __protoMessage360 {
  constructor(data) {
    super();
    this.toolCallId = "";
    this.prUrl = "";
...
var EditPrLabelsResult = class _EditPrLabelsResult extends __protoMessage360 {
  constructor(data) {
    super();
...
var EditPrLabelsSuccess = class _EditPrLabelsSuccess extends __protoMessage360 {
  constructor(data) {
    super();
    this.prUrl = "";
    this.prNumber = 0;
...
var EditPrLabelsError = class _EditPrLabelsError extends __protoMessage360 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var EditPrLabelsToolCall = class _EditPrLabelsToolCall extends __protoMessage360 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
