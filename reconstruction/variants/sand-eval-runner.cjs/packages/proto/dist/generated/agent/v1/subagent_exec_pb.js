...
init_subagents_pb();
init_compact();
var __protoPackage90 = "agent.v1.";
var __protoMessage389 = class extends CompactMessage {
  static get runtime() {
...
var ForceBackgroundSubagentStatus = /* @__PURE__ */ enumType2(proto3, __protoPackage90, "ForceBackgroundSubagentStatus", [[0, "UNSPECIFIED"], [1, "ACCEPTED"], [2, "NOT_FOUND"]], 1);
var SubagentArgs = class _SubagentArgs extends __protoMessage389 {
  constructor(data) {
    super();
    this.toolCallId = "";
    this.subagentType = "";
...
var ClientContinuationConfig = class _ClientContinuationConfig extends __protoMessage389 {
  constructor(data) {
    super();
...
var SubagentResult = class _SubagentResult extends __protoMessage389 {
  constructor(data) {
    super();
...
var SubagentAwaitArgs = class _SubagentAwaitArgs extends __protoMessage389 {
  constructor(data) {
    super();
    this.agentId = "";
    this.timeoutMs = 0;
...
var SubagentAwaitResult = class _SubagentAwaitResult extends __protoMessage389 {
  constructor(data) {
    super();
    this.result = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var SubagentAwaitComplete = class _SubagentAwaitComplete extends __protoMessage389 {
  constructor(data) {
    super();
    this.agentId = "";
...
var SubagentAwaitStillRunning = class _SubagentAwaitStillRunning extends __protoMessage389 {
  constructor(data) {
    super();
    this.agentId = "";
    proto3.util.initPartial(data, this);
...
var SubagentAwaitNotFound = class _SubagentAwaitNotFound extends __protoMessage389 {
  constructor(data) {
    super();
    this.agentId = "";
    proto3.util.initPartial(data, this);
...
var SubagentAwaitError = class _SubagentAwaitError extends __protoMessage389 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var SubagentSuccess = class _SubagentSuccess extends __protoMessage389 {
  constructor(data) {
    super();
    this.agentId = "";
    this.toolCallCount = 0;
...
var SubagentError = class _SubagentError extends __protoMessage389 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var ForceBackgroundSubagentArgs = class _ForceBackgroundSubagentArgs extends __protoMessage389 {
  constructor(data) {
    super();
    this.toolCallId = "";
    proto3.util.initPartial(data, this);
...
var ForceBackgroundSubagentResult = class _ForceBackgroundSubagentResult extends __protoMessage389 {
  constructor(data) {
    super();
