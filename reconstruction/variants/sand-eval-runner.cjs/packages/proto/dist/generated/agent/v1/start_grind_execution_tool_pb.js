...
var StartGrindExecutionArgs = class _StartGrindExecutionArgs extends __protoMessage345 {
  constructor(data) {
    super();
    this.toolCallId = "";
...
var StartGrindExecutionResult = class _StartGrindExecutionResult extends __protoMessage345 {
  constructor(data) {
    super();
...
var StartGrindExecutionSuccess = class _StartGrindExecutionSuccess extends __protoMessage345 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var StartGrindExecutionError = class _StartGrindExecutionError extends __protoMessage345 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var StartGrindExecutionToolCall = class _StartGrindExecutionToolCall extends __protoMessage345 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
