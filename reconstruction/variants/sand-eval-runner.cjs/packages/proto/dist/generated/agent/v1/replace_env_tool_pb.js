...
var ReplaceEnvMode = /* @__PURE__ */ enumType2(proto3, __protoPackage59, "ReplaceEnvMode", [[0, "UNSPECIFIED"], [1, "CUSTOM"], [2, "CLEAN_SLATE"], [3, "DEFAULT"]], 1);
var RepoCheckoutRefOverride = class _RepoCheckoutRefOverride extends __protoMessage359 {
  constructor(data) {
    super();
    this.repoUrl = "";
    this.ref = "";
...
var ReplaceEnvConfig = class _ReplaceEnvConfig extends __protoMessage359 {
  constructor(data) {
    super();
    this.installScript = "";
...
var ReplaceEnvArgs = class _ReplaceEnvArgs extends __protoMessage359 {
  constructor(data) {
    super();
...
var ReplaceEnvSuccess = class _ReplaceEnvSuccess extends __protoMessage359 {
  constructor(data) {
    super();
    this.setupLogs = "";
    proto3.util.initPartial(data, this);
...
var ReplaceEnvFailure = class _ReplaceEnvFailure extends __protoMessage359 {
  constructor(data) {
    super();
    this.errorMessage = "";
    this.setupLogs = "";
...
var ReplaceEnvResult = class _ReplaceEnvResult extends __protoMessage359 {
  constructor(data) {
    super();
...
var ReplaceEnvToolCall = class _ReplaceEnvToolCall extends __protoMessage359 {
  constructor(data) {
    super();
...
var ReplaceEnvToolCallDelta = class _ReplaceEnvToolCallDelta extends __protoMessage359 {
  constructor(data) {
    super();
    this.associatedPodKey = "";
    proto3.util.initPartial(data, this);
