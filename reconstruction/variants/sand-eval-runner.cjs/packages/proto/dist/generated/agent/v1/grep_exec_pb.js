...
var GrepArgs = class _GrepArgs extends __protoMessage312 {
  constructor(data) {
    super();
    this.pattern = "";
    this.toolCallId = "";
...
var GrepResult = class _GrepResult extends __protoMessage312 {
  constructor(data) {
    super();
...
var GrepError = class _GrepError extends __protoMessage312 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var GrepSuccess = class _GrepSuccess extends __protoMessage312 {
  constructor(data) {
    super();
    this.pattern = "";
    this.path = "";
...
var GrepUnionResult = class _GrepUnionResult extends __protoMessage312 {
  constructor(data) {
    super();
    this.result = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var GrepCountResult = class _GrepCountResult extends __protoMessage312 {
  constructor(data) {
    super();
    this.counts = [];
    this.totalFiles = 0;
...
var GrepFileCount = class _GrepFileCount extends __protoMessage312 {
  constructor(data) {
    super();
    this.file = "";
    this.count = 0;
...
var GrepFilesResult = class _GrepFilesResult extends __protoMessage312 {
  constructor(data) {
    super();
    this.files = [];
    this.totalFiles = 0;
...
var GrepContentResult = class _GrepContentResult extends __protoMessage312 {
  constructor(data) {
    super();
    this.matches = [];
    this.totalLines = 0;
...
var GrepFileMatch = class _GrepFileMatch extends __protoMessage312 {
  constructor(data) {
    super();
    this.file = "";
    this.matches = [];
...
var GrepContentMatch = class _GrepContentMatch extends __protoMessage312 {
  constructor(data) {
    super();
    this.lineNumber = 0;
    this.content = "";
