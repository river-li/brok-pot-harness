...
var McpAuthArgs = class _McpAuthArgs extends __protoMessage351 {
  constructor(data) {
    super();
...
var McpAuthResult = class _McpAuthResult extends __protoMessage351 {
  constructor(data) {
    super();
...
var McpAuthSuccess = class _McpAuthSuccess extends __protoMessage351 {
  constructor(data) {
    super();
    this.serverIdentifier = "";
    proto3.util.initPartial(data, this);
...
var McpAuthError = class _McpAuthError extends __protoMessage351 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var McpAuthRejected = class _McpAuthRejected extends __protoMessage351 {
  constructor(data) {
    super();
    this.reason = "";
    proto3.util.initPartial(data, this);
...
var McpAuthToolCall = class _McpAuthToolCall extends __protoMessage351 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var McpAuthRequestQuery = class _McpAuthRequestQuery extends __protoMessage351 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var McpAuthRequestResponse = class _McpAuthRequestResponse extends __protoMessage351 {
  constructor(data) {
    super();
    this.result = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var McpAuthRequestResponse_Approved = class _McpAuthRequestResponse_Approved extends __protoMessage351 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var McpAuthRequestResponse_Rejected = class _McpAuthRequestResponse_Rejected extends __protoMessage351 {
  constructor(data) {
    super();
    this.reason = "";
    proto3.util.initPartial(data, this);
