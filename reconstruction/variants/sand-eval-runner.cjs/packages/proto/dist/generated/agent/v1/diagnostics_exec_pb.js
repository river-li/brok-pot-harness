...
var DiagnosticSeverity = /* @__PURE__ */ enumType2(proto3, __protoPackage20, "DiagnosticSeverity", [[0, "UNSPECIFIED"], [1, "ERROR"], [2, "WARNING"], [3, "INFORMATION"], [4, "HINT"]], 1);
var DiagnosticsArgs = class _DiagnosticsArgs extends __protoMessage320 {
  constructor(data) {
    super();
    this.path = "";
    this.toolCallId = "";
...
var DiagnosticsResult = class _DiagnosticsResult extends __protoMessage320 {
  constructor(data) {
    super();
...
var DiagnosticsSuccess = class _DiagnosticsSuccess extends __protoMessage320 {
  constructor(data) {
    super();
    this.path = "";
    this.diagnostics = [];
  ...
  static $() {
    return ["DiagnosticsSuccess|1 path 9|2 diagnostics #0*|3 total_diagnostics 5", Diagnostic];
  }
};
var Diagnostic = class _Diagnostic extends __protoMessage320 {
  constructor(data) {
    super();
...
var DiagnosticsError = class _DiagnosticsError extends __protoMessage320 {
  constructor(data) {
    super();
    this.path = "";
    this.error = "";
...
var DiagnosticsRejected = class _DiagnosticsRejected extends __protoMessage320 {
  constructor(data) {
    super();
    this.path = "";
    this.reason = "";
...
var DiagnosticsFileNotFound = class _DiagnosticsFileNotFound extends __protoMessage320 {
  constructor(data) {
    super();
    this.path = "";
    proto3.util.initPartial(data, this);
...
var DiagnosticsPermissionDenied = class _DiagnosticsPermissionDenied extends __protoMessage320 {
  constructor(data) {
    super();
    this.path = "";
    proto3.util.initPartial(data, this);
