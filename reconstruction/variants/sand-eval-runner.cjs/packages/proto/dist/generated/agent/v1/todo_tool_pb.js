...
var TodoStatus = /* @__PURE__ */ enumType2(proto3, __protoPackage16, "TodoStatus", [[0, "UNSPECIFIED"], [1, "PENDING"], [2, "IN_PROGRESS"], [3, "COMPLETED"], [4, "CANCELLED"]], 1);
var TodoItem = class _TodoItem extends __protoMessage316 {
  constructor(data) {
    super();
    this.id = "";
    this.content = "";
...
var UpdateTodosToolCall = class _UpdateTodosToolCall extends __protoMessage316 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var UpdateTodosArgs = class _UpdateTodosArgs extends __protoMessage316 {
  constructor(data) {
    super();
    this.todos = [];
    this.merge = false;
...
var UpdateTodosResult = class _UpdateTodosResult extends __protoMessage316 {
  constructor(data) {
    super();
...
var UpdateTodosSuccess = class _UpdateTodosSuccess extends __protoMessage316 {
  constructor(data) {
    super();
    this.todos = [];
    this.totalCount = 0;
...
var UpdateTodosError = class _UpdateTodosError extends __protoMessage316 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var ReadTodosToolCall = class _ReadTodosToolCall extends __protoMessage316 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ReadTodosArgs = class _ReadTodosArgs extends __protoMessage316 {
  constructor(data) {
    super();
    this.statusFilter = [];
    this.idFilter = [];
...
var ReadTodosResult = class _ReadTodosResult extends __protoMessage316 {
  constructor(data) {
    super();
    this.result = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var ReadTodosSuccess = class _ReadTodosSuccess extends __protoMessage316 {
  constructor(data) {
    super();
    this.todos = [];
    this.totalCount = 0;
...
var ReadTodosError = class _ReadTodosError extends __protoMessage316 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
