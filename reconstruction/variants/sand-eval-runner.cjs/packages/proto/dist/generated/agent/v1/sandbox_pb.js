...
var __protoPackage4, __protoMessage34, NetworkPolicyLoggingConfig, NetworkPolicy, NetworkPolicy_DefaultAction, SandboxPolicy, SandboxPolicy_Type, SandboxPolicy_ReadBoundaryMode;
var init_sandbox_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/sandbox_pb.js"() {
    "use strict";
    init_esm13();
    init_compact();
    __protoPackage4 = "agent.v1.";
    ...
    NetworkPolicyLoggingConfig = class _NetworkPolicyLoggingConfig extends __protoMessage34 {
      constructor(data) {
        super();
    ...
    NetworkPolicy = class _NetworkPolicy extends __protoMessage34 {
      constructor(data) {
        super();
        this.deny = [];
        this.allow = [];
    ...
    NetworkPolicy_DefaultAction = /* @__PURE__ */ enumType2(proto3, __protoPackage4, "NetworkPolicy.DefaultAction", [[0, "UNSPECIFIED"], [1, "ALLOW"], [2, "DENY"]], 1);
    SandboxPolicy = class _SandboxPolicy extends __protoMessage34 {
      constructor(data) {
        super();
    ...
    SandboxPolicy_Type = /* @__PURE__ */ enumType2(proto3, __protoPackage4, "SandboxPolicy.Type", [[0, "UNSPECIFIED"], [1, "INSECURE_NONE"], [2, "WORKSPACE_READWRITE"], [3, "WORKSPACE_READONLY"]], 1);
    SandboxPolicy_ReadBoundaryMode = /* @__PURE__ */ enumType2(proto3, __protoPackage4, "SandboxPolicy.ReadBoundaryMode", [[0, "UNSPECIFIED"], [1, "SYSTEM"], [2, "WORKSPACE"]], 1);
  }
});
