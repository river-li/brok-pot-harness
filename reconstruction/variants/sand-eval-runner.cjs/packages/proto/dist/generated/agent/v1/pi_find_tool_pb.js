...
var PiFindToolCall = class _PiFindToolCall extends __protoMessage371 {
  constructor(data) {
    super();
...
var PiFindToolArgs = class _PiFindToolArgs extends __protoMessage371 {
  constructor(data) {
    super();
    this.pattern = "";
    proto3.util.initPartial(data, this);
...
var PiFindToolResult = class _PiFindToolResult extends __protoMessage371 {
  constructor(data) {
    super();
...
var PiFindToolSuccess = class _PiFindToolSuccess extends __protoMessage371 {
  constructor(data) {
    super();
    this.output = "";
    proto3.util.initPartial(data, this);
...
var PiFindToolError = class _PiFindToolError extends __protoMessage371 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
