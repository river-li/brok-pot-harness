...
var PullRequestStatus = /* @__PURE__ */ enumType2(proto3, __protoPackage50, "PullRequestStatus", [[0, "UNSPECIFIED"], [1, "OPEN"], [2, "CLOSED"]], 1);
var PrManagementArgs = class _PrManagementArgs extends __protoMessage350 {
  constructor(data) {
    super();
    this.toolCallId = "";
...
var CreatePrAction = class _CreatePrAction extends __protoMessage350 {
  constructor(data) {
    super();
    this.title = "";
    this.body = "";
...
var UpdatePrAction = class _UpdatePrAction extends __protoMessage350 {
  constructor(data) {
    super();
    this.addLabels = [];
    this.removeLabels = [];
...
var PostCommentAction = class _PostCommentAction extends __protoMessage350 {
  constructor(data) {
    super();
    this.body = "";
    proto3.util.initPartial(data, this);
...
var ResolveCommentAction = class _ResolveCommentAction extends __protoMessage350 {
  constructor(data) {
    super();
...
var GetCiStatusAction = class _GetCiStatusAction extends __protoMessage350 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SetPrStatusAction = class _SetPrStatusAction extends __protoMessage350 {
  constructor(data) {
    super();
...
var PrManagementResult = class _PrManagementResult extends __protoMessage350 {
  constructor(data) {
    super();
...
var PrManagementSuccess = class _PrManagementSuccess extends __protoMessage350 {
  constructor(data) {
    super();
    this.prUrl = "";
    this.prNumber = 0;
...
var PrManagementError = class _PrManagementError extends __protoMessage350 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var PrManagementRejected = class _PrManagementRejected extends __protoMessage350 {
  constructor(data) {
    super();
    this.reason = "";
    proto3.util.initPartial(data, this);
...
var PrManagementRegistered = class _PrManagementRegistered extends __protoMessage350 {
  constructor(data) {
    super();
    this.message = "";
    this.title = "";
...
var PrManagementNeedsConfirmation = class _PrManagementNeedsConfirmation extends __protoMessage350 {
  constructor(data) {
    super();
    this.message = "";
...
var PrManagementToolCall = class _PrManagementToolCall extends __protoMessage350 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var PrManagementRequestQuery = class _PrManagementRequestQuery extends __protoMessage350 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
