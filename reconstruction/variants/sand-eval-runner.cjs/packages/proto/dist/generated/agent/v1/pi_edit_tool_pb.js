...
var PiEditReplacement = class _PiEditReplacement extends __protoMessage368 {
  constructor(data) {
    super();
    this.oldText = "";
    this.newText = "";
...
var PiEditToolCall = class _PiEditToolCall extends __protoMessage368 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var PiEditToolArgs = class _PiEditToolArgs extends __protoMessage368 {
  constructor(data) {
    super();
    this.path = "";
    this.edits = [];
...
var PiEditToolResult = class _PiEditToolResult extends __protoMessage368 {
  constructor(data) {
    super();
...
var PiEditToolSuccess = class _PiEditToolSuccess extends __protoMessage368 {
  constructor(data) {
    super();
    this.output = "";
    this.diff = "";
...
var PiEditToolError = class _PiEditToolError extends __protoMessage368 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var PiEditToolRejected = class _PiEditToolRejected extends __protoMessage368 {
  constructor(data) {
    super();
    this.reason = "";
    proto3.util.initPartial(data, this);
