...
var GoalStatus = /* @__PURE__ */ enumType2(proto3, __protoPackage76, "GoalStatus", [[0, "UNSPECIFIED"], [1, "ACTIVE"], [2, "PAUSED"], [3, "COMPLETE"], [4, "CLEARED"]], 1);
var CreateGoalArgs = class _CreateGoalArgs extends __protoMessage376 {
  constructor(data) {
    super();
    this.objective = "";
...
var CreateGoalSuccess = class _CreateGoalSuccess extends __protoMessage376 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GoalError = class _GoalError extends __protoMessage376 {
  constructor(data) {
    super();
    this.error = "";
    proto3.util.initPartial(data, this);
...
var CreateGoalResult = class _CreateGoalResult extends __protoMessage376 {
  constructor(data) {
    super();
...
var CreateGoalToolCall = class _CreateGoalToolCall extends __protoMessage376 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var UpdateGoalArgs = class _UpdateGoalArgs extends __protoMessage376 {
  constructor(data) {
    super();
...
var UpdateGoalSuccess = class _UpdateGoalSuccess extends __protoMessage376 {
  constructor(data) {
    super();
    this.status = GoalStatus.UNSPECIFIED;
    proto3.util.initPartial(data, this);
...
var UpdateGoalResult = class _UpdateGoalResult extends __protoMessage376 {
  constructor(data) {
    super();
    this.result = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var UpdateGoalToolCall = class _UpdateGoalToolCall extends __protoMessage376 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
