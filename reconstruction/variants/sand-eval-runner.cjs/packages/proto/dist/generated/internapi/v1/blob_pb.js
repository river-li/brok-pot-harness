...
init_esm13();
init_compact();
var __protoPackage138 = "internapi.v1.";
var __protoMessage3133 = class extends CompactMessage {
  static get runtime() {
...
var BlobType = /* @__PURE__ */ enumType2(proto3, __protoPackage138, "BlobType", [[0, "UNSPECIFIED"], [1, "IMAGE"], [2, "INVOCATION_CONTEXT"], [3, "EXTRA_CONTEXT"], [4, "GIT_PR_DIFF_SELECTION"], [5, "SELECTED_PULL_REQUEST"], [6, "TEXT"], [7, "RICH_TEXT"], [8, "EXTERNAL_LINK_PDF"], [9, "DOCUMENT"], [10, "VIDEO"]], 1);
var ImageBlobData = class _ImageBlobData extends __protoMessage3133 {
  constructor(data) {
    super();
    this.mimeType = "";
...
var BlobData = class _BlobData extends __protoMessage3133 {
  constructor(data) {
    super();
...
var BlobDataPerMessage = class _BlobDataPerMessage extends __protoMessage3133 {
  constructor(data) {
    super();
    this.blobData = [];
    proto3.util.initPartial(data, this);
