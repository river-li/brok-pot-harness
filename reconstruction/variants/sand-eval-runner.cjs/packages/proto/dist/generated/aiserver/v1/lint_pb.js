...
init_utils_pb2();
init_compact();
var __protoPackage122 = "aiserver.v1.";
var __protoMessage3120 = class extends CompactMessage {
  static get runtime() {
...
var LintDiscriminator = /* @__PURE__ */ enumType2(proto3, __protoPackage122, "LintDiscriminator", [[0, "UNSPECIFIED"], [1, "SPECIFIC_RULES"], [2, "COMPILE_ERRORS"], [3, "CHANGE_BEHAVIOR"], [5, "RELEVANCE"], [6, "USER_AWARENESS"], [7, "CORRECTNESS"], [8, "CHUNKING"], [9, "TYPO"], [10, "CONFIDENCE"], [11, "DISMISSED_BUGS"]], 1);
var LintGenerator = /* @__PURE__ */ enumType2(proto3, __protoPackage122, "LintGenerator", [[0, "UNSPECIFIED"], [1, "NAIVE"], [2, "COMMENT_PIPELINE"], [3, "SIMPLE_BUG"], [4, "SIMPLE_LINT_RULES"]], 1);
var LintDiscriminatorResult = class _LintDiscriminatorResult extends __protoMessage3120 {
  constructor(data) {
    super();
...
var AiLintBug = class _AiLintBug extends __protoMessage3120 {
  constructor(data) {
    super();
...
var LogprobsLintPayload = class _LogprobsLintPayload extends __protoMessage3120 {
  constructor(data) {
    super();
    this.chunk = "";
...
var AiLintRule = class _AiLintRule extends __protoMessage3120 {
  constructor(data) {
    super();
    this.text = "";
    proto3.util.initPartial(data, this);
