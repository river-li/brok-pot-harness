...
init_utils_pb2();
init_compact();
var __protoPackage111 = "aiserver.v1.";
var __protoMessage3110 = class extends CompactMessage {
  static get runtime() {
...
var ComposerCapabilityRequest = class _ComposerCapabilityRequest extends __protoMessage3110 {
  constructor(data) {
    super();
...
var ComposerCapabilityRequest_SchemaProperty = class _ComposerCapabilityRequest_SchemaProperty extends __protoMessage3110 {
  constructor(data) {
    super();
    this.type = "";
    proto3.util.initPartial(data, this);
...
var ComposerCapabilityRequest_LoopOnLintsCapability = class _ComposerCapabilityRequest_LoopOnLintsCapability extends __protoMessage3110 {
  constructor(data) {
    super();
    this.linterErrors = [];
    proto3.util.initPartial(data, this);
...
var ComposerCapabilityRequest_LoopOnTestsCapability = class _ComposerCapabilityRequest_LoopOnTestsCapability extends __protoMessage3110 {
  constructor(data) {
    super();
    this.testNames = [];
    proto3.util.initPartial(data, this);
...
var ComposerCapabilityRequest_MegaPlannerCapability = class _ComposerCapabilityRequest_MegaPlannerCapability extends __protoMessage3110 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ComposerCapabilityRequest_LoopOnCommandCapability = class _ComposerCapabilityRequest_LoopOnCommandCapability extends __protoMessage3110 {
  constructor(data) {
    super();
    this.command = "";
    proto3.util.initPartial(data, this);
...
var ComposerCapabilityRequest_ToolCallCapability = class _ComposerCapabilityRequest_ToolCallCapability extends __protoMessage3110 {
  constructor(data) {
    super();
    this.toolSchemas = [];
    this.relevantFiles = [];
...
var ComposerCapabilityRequest_DiffReviewCapability = class _ComposerCapabilityRequest_DiffReviewCapability extends __protoMessage3110 {
  constructor(data) {
    super();
    this.diffs = [];
    proto3.util.initPartial(data, this);
...
var ComposerCapabilityRequest_DiffReviewCapability_SimpleFileDiff = class _ComposerCapabilityRequest_DiffReviewCapability_SimpleFileDiff extends __protoMessage3110 {
  constructor(data) {
    super();
...
var ComposerCapabilityRequest_DiffReviewCapability_SimpleFileDiff_Chunk = class _ComposerCapabilityRequest_DiffReviewCapability_SimpleFileDiff_Chunk extends __protoMessage3110 {
  constructor(data) {
    super();
    this.oldLines = [];
    this.newLines = [];
...
var ComposerCapabilityRequest_DecomposerCapability = class _ComposerCapabilityRequest_DecomposerCapability extends __protoMessage3110 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ComposerCapabilityRequest_ContextPickingCapability = class _ComposerCapabilityRequest_ContextPickingCapability extends __protoMessage3110 {
  constructor(data) {
    super();
...
var ComposerCapabilityRequest_EditTrailCapability = class _ComposerCapabilityRequest_EditTrailCapability extends __protoMessage3110 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ComposerCapabilityRequest_AutoContextCapability = class _ComposerCapabilityRequest_AutoContextCapability extends __protoMessage3110 {
  constructor(data) {
    super();
...
var ComposerCapabilityRequest_ContextPlannerCapability = class _ComposerCapabilityRequest_ContextPlannerCapability extends __protoMessage3110 {
  constructor(data) {
    super();
...
var ComposerCapabilityRequest_RememberThisCapability = class _ComposerCapabilityRequest_RememberThisCapability extends __protoMessage3110 {
  constructor(data) {
    super();
    this.memory = "";
    proto3.util.initPartial(data, this);
...
var ComposerCapabilityRequest_CursorRulesCapability = class _ComposerCapabilityRequest_CursorRulesCapability extends __protoMessage3110 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ComposerCapabilityContext = class _ComposerCapabilityContext extends __protoMessage3110 {
  constructor(data) {
    super();
    this.data = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var ComposerCapabilityContext_SlackIntegrationContext = class _ComposerCapabilityContext_SlackIntegrationContext extends __protoMessage3110 {
  constructor(data) {
    super();
    this.thread = "";
    proto3.util.initPartial(data, this);
...
var ComposerCapabilityContext_MicrosoftTeamsIntegrationContext = class _ComposerCapabilityContext_MicrosoftTeamsIntegrationContext extends __protoMessage3110 {
  constructor(data) {
    super();
    this.thread = "";
    proto3.util.initPartial(data, this);
...
var ComposerCapabilityContext_GithubPRContext = class _ComposerCapabilityContext_GithubPRContext extends __protoMessage3110 {
  constructor(data) {
    super();
    this.title = "";
    this.description = "";
...
var ComposerCapabilityContext_GithubPRContext_CodeTourContext = class _ComposerCapabilityContext_GithubPRContext_CodeTourContext extends __protoMessage3110 {
  constructor(data) {
    super();
    this.changeId = "";
    this.headSha = "";
