...
init_esm13();
init_compact();
var __protoPackage145 = "aiserver.v1.";
var __protoMessage3138 = class extends CompactMessage {
  static get runtime() {
...
var AgentStartupTraceEvent = class _AgentStartupTraceEvent extends __protoMessage3138 {
  constructor(data) {
    super();
...
var AgentStartupTraceEvent_ContextLink = class _AgentStartupTraceEvent_ContextLink extends __protoMessage3138 {
  constructor(data) {
    super();
    this.name = "";
    this.href = "";
...
var AgentStartupTraceEvent_SpanStarted = class _AgentStartupTraceEvent_SpanStarted extends __protoMessage3138 {
  constructor(data) {
    super();
    this.spanId = "";
    this.name = "";
...
var AgentStartupTraceEvent_SpanEnded = class _AgentStartupTraceEvent_SpanEnded extends __protoMessage3138 {
  constructor(data) {
    super();
    this.spanId = "";
    proto3.util.initPartial(data, this);
...
var AgentStartupTraceEvent_UserAction = class _AgentStartupTraceEvent_UserAction extends __protoMessage3138 {
  constructor(data) {
    super();
    this.turnIndex = 0;
    proto3.util.initPartial(data, this);
...
var AgentStartupTraceEvent_TurnClose = class _AgentStartupTraceEvent_TurnClose extends __protoMessage3138 {
  constructor(data) {
    super();
    this.turnIndex = 0;
    proto3.util.initPartial(data, this);
