...
init_utils_pb2();
init_compact();
var __protoPackage114 = "aiserver.v1.";
var __protoMessage3113 = class extends CompactMessage {
  static get runtime() {
...
var BugLocation = class _BugLocation extends __protoMessage3113 {
  constructor(data) {
    super();
    this.file = "";
    this.startLine = 0;
...
var BugReport = class _BugReport extends __protoMessage3113 {
  constructor(data) {
    super();
    this.locations = [];
    this.id = "";
...
var BugReports = class _BugReports extends __protoMessage3113 {
  constructor(data) {
    super();
    this.bugReports = [];
    proto3.util.initPartial(data, this);
...
var StreamBugBotRequest = class _StreamBugBotRequest extends __protoMessage3113 {
  constructor(data) {
    super();
    this.contextFiles = [];
...
var StreamBugBotRequest_Range = class _StreamBugBotRequest_Range extends __protoMessage3113 {
  constructor(data) {
    super();
    this.startLine = 0;
