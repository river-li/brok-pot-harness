...
init_compact();
var __protoPackage113 = "aiserver.v1.";
var __protoMessage3112 = class extends CompactMessage {
  static get runtime() {
...
var ChunkType = /* @__PURE__ */ enumType2(proto3, __protoPackage113, "ChunkType", [[0, "UNSPECIFIED"], [1, "CODEBASE"], [2, "LONG_FILE"], [3, "DOCS"]], 1);
var SubagentType2 = /* @__PURE__ */ enumType2(proto3, __protoPackage113, "SubagentType", [[0, "UNSPECIFIED"], [1, "DEEP_SEARCH"], [2, "FIX_LINTS"], [3, "TASK"], [4, "SPEC"]], 1);
var ConversationSummary2 = class _ConversationSummary extends __protoMessage3112 {
  constructor(data) {
    super();
    this.summary = "";
...
var ContextToRank = class _ContextToRank extends __protoMessage3112 {
  constructor(data) {
    super();
...
var RankedContext = class _RankedContext extends __protoMessage3112 {
  constructor(data) {
    super();
    this.score = 0;
    proto3.util.initPartial(data, this);
...
var DocumentationCitation = class _DocumentationCitation extends __protoMessage3112 {
  constructor(data) {
    super();
    this.chunks = [];
    proto3.util.initPartial(data, this);
...
var WebCitation = class _WebCitation extends __protoMessage3112 {
  constructor(data) {
    super();
    this.references = [];
    proto3.util.initPartial(data, this);
...
var WebReference = class _WebReference extends __protoMessage3112 {
  constructor(data) {
    super();
    this.title = "";
    this.url = "";
...
var DocsReference = class _DocsReference extends __protoMessage3112 {
  constructor(data) {
    super();
    this.title = "";
    this.url = "";
...
var AiWebSearchResult = class _AiWebSearchResult extends __protoMessage3112 {
  constructor(data) {
    super();
    this.content = "";
    this.title = "";
...
var StatusUpdate = class _StatusUpdate extends __protoMessage3112 {
  constructor(data) {
    super();
    this.message = "";
    proto3.util.initPartial(data, this);
...
var StatusUpdates = class _StatusUpdates extends __protoMessage3112 {
  constructor(data) {
    super();
    this.updates = [];
    proto3.util.initPartial(data, this);
...
var RerankDocumentsRequest = class _RerankDocumentsRequest extends __protoMessage3112 {
  constructor(data) {
    super();
    this.query = "";
    this.documents = [];
...
var RerankDocumentsResponse = class _RerankDocumentsResponse extends __protoMessage3112 {
  constructor(data) {
    super();
    this.documents = [];
    proto3.util.initPartial(data, this);
...
var Document = class _Document extends __protoMessage3112 {
  constructor(data) {
    super();
    this.content = "";
    this.id = "";
...
var DocumentIdsWithScores = class _DocumentIdsWithScores extends __protoMessage3112 {
  constructor(data) {
    super();
    this.documentId = "";
    this.score = 0;
...
var ComposerFileDiffHistory = class _ComposerFileDiffHistory extends __protoMessage3112 {
  constructor(data) {
    super();
    this.fileName = "";
    this.diffHistory = [];
...
var StreamUnifiedChatRequest_UnifiedMode = /* @__PURE__ */ enumType2(proto3, __protoPackage113, "StreamUnifiedChatRequest.UnifiedMode", [[0, "UNSPECIFIED"], [1, "CHAT"], [2, "AGENT"], [3, "EDIT"], [4, "CUSTOM"], [5, "PLAN"], [6, "DEBUG"]], 1);
var ContextPiece = class _ContextPiece extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    this.content = "";
...
var ContextWindowStatus = class _ContextWindowStatus extends __protoMessage3112 {
  constructor(data) {
    super();
...
var ServiceStatusUpdate = class _ServiceStatusUpdate extends __protoMessage3112 {
  constructor(data) {
    super();
    this.message = "";
    this.codicon = "";
...
var SymbolLink = class _SymbolLink extends __protoMessage3112 {
  constructor(data) {
    super();
    this.symbolName = "";
...
var FileLink = class _FileLink extends __protoMessage3112 {
  constructor(data) {
    super();
    this.displayName = "";
    this.relativeWorkspacePath = "";
...
var RedDiff = class _RedDiff extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    this.redRanges = [];
...
var DiffFile = class _DiffFile extends __protoMessage3112 {
  constructor(data) {
    super();
    this.fileDetails = "";
    this.fileName = "";
...
var ViewableCommitProps = class _ViewableCommitProps extends __protoMessage3112 {
  constructor(data) {
    super();
    this.description = "";
    this.message = "";
...
var ViewablePRProps = class _ViewablePRProps extends __protoMessage3112 {
  constructor(data) {
    super();
    this.title = "";
    this.body = "";
...
var ViewableDiffProps = class _ViewableDiffProps extends __protoMessage3112 {
  constructor(data) {
    super();
    this.files = [];
    this.diffPreface = "";
...
var ViewableGitContext = class _ViewableGitContext extends __protoMessage3112 {
  constructor(data) {
    super();
    this.diffData = [];
    proto3.util.initPartial(data, this);
...
var ConversationMessage = class _ConversationMessage extends __protoMessage3112 {
  constructor(data) {
    super();
    this.text = "";
...
var ConversationMessage_CodeChunk_Intent = /* @__PURE__ */ enumType2(proto3, __protoPackage113, "ConversationMessage.CodeChunk.Intent", [[0, "UNSPECIFIED"], [1, "COMPOSER_FILE"], [2, "COMPRESSED_COMPOSER_FILE"], [3, "RECENTLY_VIEWED_FILE"], [4, "OUTLINE"], [5, "MENTIONED_FILE"], [6, "CODE_SELECTION"], [7, "AI_EDITED_FILE"], [8, "VISIBLE_FILE"], [9, "TERMINAL_SELECTION"]], 1);
var ConversationMessage_CodeChunk_SummarizationStrategy = /* @__PURE__ */ enumType2(proto3, __protoPackage113, "ConversationMessage.CodeChunk.SummarizationStrategy", [[0, "NONE_UNSPECIFIED"], [1, "SUMMARIZED"], [2, "EMBEDDED"]], 1);
var ConversationMessage_CodeChunk_CodeChunkGitContext = class _ConversationMessage_CodeChunk_CodeChunkGitContext extends __protoMessage3112 {
  constructor(data) {
    super();
    this.gitInfo = [];
    proto3.util.initPartial(data, this);
...
var ConversationMessage_CodeChunk_CodeChunkGitContext_CodeChunkGitInfo = class _ConversationMessage_CodeChunk_CodeChunkGitContext_CodeChunkGitInfo extends __protoMessage3112 {
  constructor(data) {
    super();
    this.commit = "";
    this.author = "";
...
var ConversationMessage_ToolResult = class _ConversationMessage_ToolResult extends __protoMessage3112 {
  constructor(data) {
    super();
    this.toolCallId = "";
    this.toolName = "";
...
var ConversationMessage_NotepadContext = class _ConversationMessage_NotepadContext extends __protoMessage3112 {
  constructor(data) {
    super();
    this.name = "";
    this.text = "";
...
var ConversationMessage_ComposerContext = class _ConversationMessage_ComposerContext extends __protoMessage3112 {
  constructor(data) {
    super();
    this.name = "";
    proto3.util.initPartial(data, this);
...
var ConversationMessage_EditLocation = class _ConversationMessage_EditLocation extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    this.contextLines = "";
...
var ConversationMessage_EditTrailContext = class _ConversationMessage_EditTrailContext extends __protoMessage3112 {
  constructor(data) {
    super();
    this.uniqueId = "";
...
var ConversationMessage_ApproximateLintError = class _ConversationMessage_ApproximateLintError extends __protoMessage3112 {
  constructor(data) {
    super();
    this.message = "";
    this.value = "";
...
var ConversationMessage_Lints = class _ConversationMessage_Lints extends __protoMessage3112 {
  constructor(data) {
    super();
...
var ConversationMessage_RecentLocation = class _ConversationMessage_RecentLocation extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    this.lineNumber = 0;
...
var ConversationMessage_RenderedDiff = class _ConversationMessage_RenderedDiff extends __protoMessage3112 {
  constructor(data) {
    super();
    this.startLineNumber = 0;
...
var ConversationMessage_HumanChange = class _ConversationMessage_HumanChange extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    this.renderedDiffs = [];
...
var ConversationMessage_Thinking = class _ConversationMessage_Thinking extends __protoMessage3112 {
  constructor(data) {
    super();
    this.text = "";
    this.signature = "";
...
var ConversationMessage_DiffSinceLastApply = class _ConversationMessage_DiffSinceLastApply extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    proto3.util.initPartial(data, this);
...
var ConversationMessage_DeletedFile = class _ConversationMessage_DeletedFile extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    proto3.util.initPartial(data, this);
...
var ConversationMessage_KnowledgeItem = class _ConversationMessage_KnowledgeItem extends __protoMessage3112 {
  constructor(data) {
    super();
    this.title = "";
    this.knowledge = "";
...
var ConversationMessage_DocumentationSelection = class _ConversationMessage_DocumentationSelection extends __protoMessage3112 {
  constructor(data) {
    super();
    this.docId = "";
    this.name = "";
...
var ConversationMessage_IdeEditorsState = class _ConversationMessage_IdeEditorsState extends __protoMessage3112 {
  constructor(data) {
    super();
...
var ConversationMessage_IdeEditorsState_File = class _ConversationMessage_IdeEditorsState_File extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativePath = "";
    proto3.util.initPartial(data, this);
...
var ConversationMessage_PlanUpdate = class _ConversationMessage_PlanUpdate extends __protoMessage3112 {
  constructor(data) {
    super();
    this.currentPlan = "";
...
var ConversationMessage_SimulatedMessageMetadata = class _ConversationMessage_SimulatedMessageMetadata extends __protoMessage3112 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ConversationMessage_McpDescriptor = class _ConversationMessage_McpDescriptor extends __protoMessage3112 {
  constructor(data) {
    super();
    this.folderPath = "";
    this.tools = [];
...
var ConversationMessage_McpDescriptor_Tool = class _ConversationMessage_McpDescriptor_Tool extends __protoMessage3112 {
  constructor(data) {
    super();
    this.toolName = "";
    proto3.util.initPartial(data, this);
...
var CurrentFileLocationData = class _CurrentFileLocationData extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    this.lineNumber = 0;
...
var FolderInfo = class _FolderInfo extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativePath = "";
    this.files = [];
...
var FolderFileInfo = class _FolderFileInfo extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativePath = "";
    this.content = "";
...
var InterpreterResult = class _InterpreterResult extends __protoMessage3112 {
  constructor(data) {
    super();
    this.output = "";
    this.success = false;
...
var SimpleFileDiff = class _SimpleFileDiff extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    this.chunks = [];
...
var SimpleFileDiff_Chunk = class _SimpleFileDiff_Chunk extends __protoMessage3112 {
  constructor(data) {
    super();
    this.oldLines = [];
    this.newLines = [];
...
var Commit = class _Commit extends __protoMessage3112 {
  constructor(data) {
    super();
    this.sha = "";
    this.message = "";
...
var PullRequest = class _PullRequest extends __protoMessage3112 {
  constructor(data) {
    super();
    this.title = "";
    this.body = "";
...
var SuggestedCodeBlock = class _SuggestedCodeBlock extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    proto3.util.initPartial(data, this);
...
var UserResponseToSuggestedCodeBlock = class _UserResponseToSuggestedCodeBlock extends __protoMessage3112 {
  constructor(data) {
    super();
...
var UserResponseToSuggestedCodeBlock_UserResponseType = /* @__PURE__ */ enumType2(proto3, __protoPackage113, "UserResponseToSuggestedCodeBlock.UserResponseType", [[0, "UNSPECIFIED"], [1, "ACCEPT"], [2, "REJECT"], [3, "MODIFY"]], 1);
var ContextRerankingCandidateFile = class _ContextRerankingCandidateFile extends __protoMessage3112 {
  constructor(data) {
    super();
    this.fileName = "";
    this.fileContent = "";
...
var ComposerFileDiff = class _ComposerFileDiff extends __protoMessage3112 {
  constructor(data) {
    super();
    this.chunks = [];
...
var ComposerFileDiff_Editor = /* @__PURE__ */ enumType2(proto3, __protoPackage113, "ComposerFileDiff.Editor", [[0, "UNSPECIFIED"], [1, "AI"], [2, "HUMAN"]], 1);
var ComposerFileDiff_ChunkDiff = class _ComposerFileDiff_ChunkDiff extends __protoMessage3112 {
  constructor(data) {
    super();
    this.diffString = "";
    this.oldStart = 0;
...
var DiffHistoryData = class _DiffHistoryData extends __protoMessage3112 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    this.diffs = [];
...
var SubagentReturnCall = class _SubagentReturnCall extends __protoMessage3112 {
  constructor(data) {
    super();
...
var DeepSearchSubagentReturnValue = class _DeepSearchSubagentReturnValue extends __protoMessage3112 {
  constructor(data) {
    super();
    this.contextItems = [];
    proto3.util.initPartial(data, this);
...
var DeepSearchSubagentReturnValue_ContextItem = class _DeepSearchSubagentReturnValue_ContextItem extends __protoMessage3112 {
  constructor(data) {
    super();
    this.file = "";
    this.explanation = "";
...
var FixLintsSubagentReturnValue = class _FixLintsSubagentReturnValue extends __protoMessage3112 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var TaskSubagentReturnValue = class _TaskSubagentReturnValue extends __protoMessage3112 {
  constructor(data) {
    super();
    this.summary = "";
    proto3.util.initPartial(data, this);
...
var SpecSubagentReturnValue = class _SpecSubagentReturnValue extends __protoMessage3112 {
  constructor(data) {
    super();
    this.summary = "";
...
var StringReplacement = class _StringReplacement extends __protoMessage3112 {
  constructor(data) {
    super();
    this.oldString = "";
    this.newString = "";
...
var ProjectLayout = class _ProjectLayout extends __protoMessage3112 {
  constructor(data) {
    super();
    this.rootPath = "";
    proto3.util.initPartial(data, this);
...
var ProjectLayoutDirectoryContent = class _ProjectLayoutDirectoryContent extends __protoMessage3112 {
  constructor(data) {
    super();
    this.directories = [];
    this.files = [];
...
var ProjectLayoutDirectory = class _ProjectLayoutDirectory extends __protoMessage3112 {
  constructor(data) {
    super();
    this.name = "";
    proto3.util.initPartial(data, this);
...
var ProjectLayoutFile = class _ProjectLayoutFile extends __protoMessage3112 {
  constructor(data) {
    super();
    this.name = "";
    proto3.util.initPartial(data, this);
