...
init_esm13();
init_compact();
var __protoPackage2 = "aiserver.v1.";
...
var InferenceReason = /* @__PURE__ */ enumType2(proto3, __protoPackage2, "InferenceReason", [[0, "UNSPECIFIED"], [1, "GEMINI_VIDEO_SUBAGENT"]], 1);
var InferenceMessageRole = /* @__PURE__ */ enumType2(proto3, __protoPackage2, "InferenceMessageRole", [[0, "UNSPECIFIED"], [1, "USER"], [2, "ASSISTANT"], [3, "TOOL"], [4, "SYSTEM"]], 1);
var InferenceStreamErrorType = /* @__PURE__ */ enumType2(proto3, __protoPackage2, "InferenceStreamErrorType", [[0, "UNSPECIFIED"], [1, "UNKNOWN"], [2, "INPUT_TOKEN_LIMIT"], [3, "OUTPUT_TOKEN_LIMIT"], [4, "RATE_LIMIT"], [5, "AUTHENTICATION"], [6, "PERMISSION"], [7, "OVERLOADED"], [8, "CONTENT_FILTER"]], 1);
var RunInferenceRoutingRole = /* @__PURE__ */ enumType2(proto3, __protoPackage2, "RunInferenceRoutingRole", [[0, "UNSPECIFIED"], [1, "USER"], [2, "ASSISTANT"]], 1);
var InferenceStreamRequest = class _InferenceStreamRequest extends __protoMessage32 {
  constructor(data) {
    super();
    this.messages = [];
    this.tools = [];
...
var InferenceRequestedModel = class _InferenceRequestedModel extends __protoMessage32 {
  constructor(data) {
    super();
    this.modelId = "";
    this.maxMode = false;
...
var InferenceModelParameterValue = class _InferenceModelParameterValue extends __protoMessage32 {
  constructor(data) {
    super();
    this.id = "";
    this.value = "";
...
var InferenceCoreMessage = class _InferenceCoreMessage extends __protoMessage32 {
  constructor(data) {
    super();
...
var InferenceReasoningPart = class _InferenceReasoningPart extends __protoMessage32 {
  constructor(data) {
    super();
...
var InferenceContentParts = class _InferenceContentParts extends __protoMessage32 {
  constructor(data) {
    super();
    this.parts = [];
    proto3.util.initPartial(data, this);
...
var InferenceContentPart = class _InferenceContentPart extends __protoMessage32 {
  constructor(data) {
    super();
...
var InferenceTextPart = class _InferenceTextPart extends __protoMessage32 {
  constructor(data) {
    super();
    this.text = "";
    proto3.util.initPartial(data, this);
...
var InferenceImagePart = class _InferenceImagePart extends __protoMessage32 {
  constructor(data) {
    super();
    this.data = "";
    proto3.util.initPartial(data, this);
...
var InferenceFilePart = class _InferenceFilePart extends __protoMessage32 {
  constructor(data) {
    super();
    this.data = "";
    this.mediaType = "";
...
var InferenceToolCall = class _InferenceToolCall extends __protoMessage32 {
  constructor(data) {
    super();
    this.toolCallId = "";
    this.toolName = "";
...
var InferenceAgentTool = class _InferenceAgentTool extends __protoMessage32 {
  constructor(data) {
    super();
    this.name = "";
    this.description = "";
...
var InferenceCustomToolFormat = class _InferenceCustomToolFormat extends __protoMessage32 {
  constructor(data) {
    super();
    this.type = "";
    this.definition = "";
...
var InferenceNamedProviderDefinedTool = class _InferenceNamedProviderDefinedTool extends __protoMessage32 {
  constructor(data) {
    super();
    this.name = "";
    this.id = "";
...
var InferenceModelConfig = class _InferenceModelConfig extends __protoMessage32 {
  constructor(data) {
    super();
    this.stopSequences = [];
    proto3.util.initPartial(data, this);
...
var InferenceStreamResponse = class _InferenceStreamResponse extends __protoMessage32 {
  constructor(data) {
    super();
...
var InferenceImageDescriptionsInfo = class _InferenceImageDescriptionsInfo extends __protoMessage32 {
  constructor(data) {
    super();
    this.descriptions = [];
    proto3.util.initPartial(data, this);
...
var InferenceImageDescription = class _InferenceImageDescription extends __protoMessage32 {
  constructor(data) {
    super();
    this.messageIndex = 0;
    this.partIndex = 0;
...
var InferenceTextStreamPart = class _InferenceTextStreamPart extends __protoMessage32 {
  constructor(data) {
    super();
    this.text = "";
    this.isFinal = false;
...
var InferenceThinkingStreamPart = class _InferenceThinkingStreamPart extends __protoMessage32 {
  constructor(data) {
    super();
    this.text = "";
    this.isFinal = false;
...
var InferenceToolCallStreamPart = class _InferenceToolCallStreamPart extends __protoMessage32 {
  constructor(data) {
    super();
    this.toolCallId = "";
    this.toolName = "";
...
var InferenceUsageInfo = class _InferenceUsageInfo extends __protoMessage32 {
  constructor(data) {
    super();
    this.promptTokens = 0;
...
var InferenceExtendedUsageInfo = class _InferenceExtendedUsageInfo extends __protoMessage32 {
  constructor(data) {
    super();
    this.inputTokens = 0;
    this.outputTokens = 0;
...
var InferenceResponseInfo = class _InferenceResponseInfo extends __protoMessage32 {
  constructor(data) {
    super();
    this.id = "";
    this.model = "";
...
var InferenceResponseMessage = class _InferenceResponseMessage extends __protoMessage32 {
  constructor(data) {
    super();
    this.id = "";
    this.role = InferenceMessageRole.UNSPECIFIED;
...
var InferenceToolResultContent = class _InferenceToolResultContent extends __protoMessage32 {
  constructor(data) {
    super();
    this.parts = [];
    proto3.util.initPartial(data, this);
...
var InferenceToolResultPart = class _InferenceToolResultPart extends __protoMessage32 {
  constructor(data) {
    super();
    this.toolCallId = "";
    this.toolName = "";
...
var InferenceExtraData = class _InferenceExtraData extends __protoMessage32 {
  constructor(data) {
    super();
    this.tokenLogprobs = [];
    this.tokenIds = [];
...
var InferenceTokenLogprobs = class _InferenceTokenLogprobs extends __protoMessage32 {
  constructor(data) {
    super();
    this.values = [];
    proto3.util.initPartial(data, this);
...
var InferenceTokenIds = class _InferenceTokenIds extends __protoMessage32 {
  constructor(data) {
    super();
    this.values = [];
    proto3.util.initPartial(data, this);
...
var InferenceRoutingRow = class _InferenceRoutingRow extends __protoMessage32 {
  constructor(data) {
    super();
    this.values = [];
    proto3.util.initPartial(data, this);
...
var InferenceProviderMetadataInfo = class _InferenceProviderMetadataInfo extends __protoMessage32 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var InferenceInvocationIdInfo = class _InferenceInvocationIdInfo extends __protoMessage32 {
  constructor(data) {
    super();
    this.invocationId = "";
    proto3.util.initPartial(data, this);
...
var InferenceStreamError = class _InferenceStreamError extends __protoMessage32 {
  constructor(data) {
    super();
    this.message = "";
    this.code = "";
...
var InferenceProviderOptions = class _InferenceProviderOptions extends __protoMessage32 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var InferenceCursorOptions = class _InferenceCursorOptions extends __protoMessage32 {
  constructor(data) {
    super();
...
var InferenceAnthropicOptions = class _InferenceAnthropicOptions extends __protoMessage32 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var InferenceCacheControl = class _InferenceCacheControl extends __protoMessage32 {
  constructor(data) {
    super();
    this.type = "";
    proto3.util.initPartial(data, this);
...
var AgentFollowupCategorizationRequest = class _AgentFollowupCategorizationRequest extends __protoMessage32 {
  constructor(data) {
    super();
    this.requestId = "";
...
var AgentPostTurnLabelingRequest = class _AgentPostTurnLabelingRequest extends __protoMessage32 {
  constructor(data) {
    super();
    this.requestId = "";
    this.messages = [];
...
var RunInferenceClientMessage = class _RunInferenceClientMessage extends __protoMessage32 {
  constructor(data) {
    super();
...
var RunInferenceRunRequest = class _RunInferenceRunRequest extends __protoMessage32 {
  constructor(data) {
    super();
    this.conversationId = "";
...
var RunInferenceRoutingMessage = class _RunInferenceRoutingMessage extends __protoMessage32 {
  constructor(data) {
    super();
...
var RunInferenceInvokeModel = class _RunInferenceInvokeModel extends __protoMessage32 {
  constructor(data) {
    super();
    this.invocationId = "";
    proto3.util.initPartial(data, this);
...
var RunInferenceCancelInvocation = class _RunInferenceCancelInvocation extends __protoMessage32 {
  constructor(data) {
    super();
    this.invocationId = "";
    proto3.util.initPartial(data, this);
...
var RunInferenceFinishRun = class _RunInferenceFinishRun extends __protoMessage32 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var RunInferenceServerMessage = class _RunInferenceServerMessage extends __protoMessage32 {
  constructor(data) {
    super();
    this.message = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var RunInferenceHeartbeat = class _RunInferenceHeartbeat extends __protoMessage32 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var RunInferenceRunReady = class _RunInferenceRunReady extends __protoMessage32 {
  constructor(data) {
    super();
...
var RunInferencePromptModelMetadata = class _RunInferencePromptModelMetadata extends __protoMessage32 {
  constructor(data) {
    super();
    this.vendor = "";
    this.promptVersion = "";
...
var RunInferenceAskQuestionConfig = class _RunInferenceAskQuestionConfig extends __protoMessage32 {
  constructor(data) {
    super();
    this.toolName = "";
...
var RunInferenceAgentModeConfig = class _RunInferenceAgentModeConfig extends __protoMessage32 {
  constructor(data) {
    super();
    this.modeId = "";
...
var RunInferenceSwitchModeToolConfig = class _RunInferenceSwitchModeToolConfig extends __protoMessage32 {
  constructor(data) {
    super();
    this.targetModes = [];
    proto3.util.initPartial(data, this);
...
var RunInferenceFlagValue = class _RunInferenceFlagValue extends __protoMessage32 {
  constructor(data) {
    super();
...
var RunInferenceLoopNudgeConfig = class _RunInferenceLoopNudgeConfig extends __protoMessage32 {
  constructor(data) {
    super();
...
var RunInferenceInvocationResponse = class _RunInferenceInvocationResponse extends __protoMessage32 {
  constructor(data) {
    super();
    this.invocationId = "";
    proto3.util.initPartial(data, this);
...
var RunInferenceInvocationEnd = class _RunInferenceInvocationEnd extends __protoMessage32 {
  constructor(data) {
    super();
    this.invocationId = "";
    proto3.util.initPartial(data, this);
...
var RunInferenceInvocationError = class _RunInferenceInvocationError extends __protoMessage32 {
  constructor(data) {
    super();
    this.code = 0;
    this.message = "";
...
var RunInferenceErrorDetail = class _RunInferenceErrorDetail extends __protoMessage32 {
  constructor(data) {
    super();
    this.type = "";
