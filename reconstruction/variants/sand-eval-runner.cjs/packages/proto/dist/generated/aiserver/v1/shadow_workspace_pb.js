...
init_esm13();
init_compact();
var __protoPackage112 = "aiserver.v1.";
var __protoMessage3111 = class extends CompactMessage {
  static get runtime() {
...
var GetLintsForChangeResponse = class _GetLintsForChangeResponse extends __protoMessage3111 {
  constructor(data) {
    super();
    this.lints = [];
...
var GetLintsForChangeResponse_Lint = class _GetLintsForChangeResponse_Lint extends __protoMessage3111 {
  constructor(data) {
    super();
    this.message = "";
    this.severity = "";
...
var GetLintsForChangeResponse_Lint_QuickFix = class _GetLintsForChangeResponse_Lint_QuickFix extends __protoMessage3111 {
  constructor(data) {
    super();
    this.message = "";
    this.kind = "";
...
var GetLintsForChangeResponse_Lint_QuickFix_Edit = class _GetLintsForChangeResponse_Lint_QuickFix_Edit extends __protoMessage3111 {
  constructor(data) {
    super();
    this.relativeWorkspacePath = "";
    this.text = "";
