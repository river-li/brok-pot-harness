...
init_esm13();
init_compact();
var __protoPackage144 = "aiserver.v1.";
var __protoMessage3137 = class extends CompactMessage {
  static get runtime() {
...
var PRCheckStatus = class _PRCheckStatus extends __protoMessage3137 {
  constructor(data) {
    super();
    this.overallState = "";
    this.successCount = 0;
...
var PRCheck = class _PRCheck extends __protoMessage3137 {
  constructor(data) {
    super();
    this.name = "";
    this.status = "";
