...
init_esm13();
init_compact();
var __protoPackage124 = "aiserver.v1.";
var __protoMessage3122 = class extends CompactMessage {
  static get runtime() {
...
var UsageEventKind = /* @__PURE__ */ enumType2(proto3, __protoPackage124, "UsageEventKind", [[0, "UNSPECIFIED"], [1, "USAGE_BASED"], [2, "USER_API_KEY"], [3, "INCLUDED_IN_PRO"], [4, "INCLUDED_IN_BUSINESS"], [5, "ERRORED_NOT_CHARGED"], [6, "ABORTED_NOT_CHARGED"], [7, "CUSTOM_SUBSCRIPTION"], [8, "INCLUDED_IN_PRO_PLUS"], [9, "INCLUDED_IN_ULTRA"], [10, "FREE_CREDIT"]], 1);
var ModelSelectionSnapshot = class _ModelSelectionSnapshot extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelId = "";
    this.maxMode = false;
...
var ModelSelectionSnapshot_ModelParameterValue = class _ModelSelectionSnapshot_ModelParameterValue extends __protoMessage3122 {
  constructor(data) {
    super();
    this.id = "";
    this.value = "";
...
var UsageEventDetails = class _UsageEventDetails extends __protoMessage3122 {
  constructor(data) {
    super();
...
var UsageEventDetails_PromptHook = class _UsageEventDetails_PromptHook extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
    proto3.util.initPartial(data, this);
...
var UsageEventDetails_BugFinderTriggerV1 = class _UsageEventDetails_BugFinderTriggerV1 extends __protoMessage3122 {
  constructor(data) {
    super();
...
var UsageEventDetails_BugBot = class _UsageEventDetails_BugBot extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
...
var UsageEventDetails_Chat = class _UsageEventDetails_Chat extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
    proto3.util.initPartial(data, this);
...
var UsageEventDetails_FastApply = class _UsageEventDetails_FastApply extends __protoMessage3122 {
  constructor(data) {
    super();
...
var UsageEventDetails_Composer = class _UsageEventDetails_Composer extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
    proto3.util.initPartial(data, this);
...
var UsageEventDetails_ToolCallComposer = class _UsageEventDetails_ToolCallComposer extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
    proto3.util.initPartial(data, this);
...
var UsageEventDetails_WarmComposer = class _UsageEventDetails_WarmComposer extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
    proto3.util.initPartial(data, this);
...
var UsageEventDetails_ContextChat = class _UsageEventDetails_ContextChat extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
    proto3.util.initPartial(data, this);
...
var UsageEventDetails_CmdK = class _UsageEventDetails_CmdK extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
    proto3.util.initPartial(data, this);
...
var UsageEventDetails_TerminalCmdK = class _UsageEventDetails_TerminalCmdK extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
    proto3.util.initPartial(data, this);
...
var UsageEventDetails_AiReviewAcceptedComment = class _UsageEventDetails_AiReviewAcceptedComment extends __protoMessage3122 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var UsageEventDetails_InterpreterChat = class _UsageEventDetails_InterpreterChat extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
    proto3.util.initPartial(data, this);
...
var UsageEventDetails_SlashEdit = class _UsageEventDetails_SlashEdit extends __protoMessage3122 {
  constructor(data) {
    super();
    this.modelIntent = "";
    proto3.util.initPartial(data, this);
...
var UsageEventDetails_AgentSdkManagedProduct = class _UsageEventDetails_AgentSdkManagedProduct extends __protoMessage3122 {
  constructor(data) {
    super();
    this.managedType = "";
...
var UsageEvent = class _UsageEvent extends __protoMessage3122 {
  constructor(data) {
    super();
...
var UsageEventDisplay = class _UsageEventDisplay extends __protoMessage3122 {
  constructor(data) {
    super();
    this.timestamp = protoInt64.zero;
    this.model = "";
...
var TokenUsage = class _TokenUsage extends __protoMessage3122 {
  constructor(data) {
    super();
    this.inputTokens = 0;
    this.outputTokens = 0;
