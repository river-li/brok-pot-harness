 ...
 * Source: ../packages/proto/dist/generated/aiserver/v1/agent_store_pb.js
 * Bundle: sand-host/sand-eval-runner.cjs
 * See reconstruction-manifest.json for exact byte ranges. */
// @recovered-fragment 1/1
init_esm13();
init_compact();
var __protoPackage136 = "aiserver.v1.";
var __protoMessage3131 = class extends CompactMessage {
  static get runtime() {
    return defineOwn(this, "runtime", proto3);
  }
  static $p() {
    return __protoPackage136;
  }
};
var AgentStoreKind = /* @__PURE__ */ enumType2(proto3, __protoPackage136, "AgentStoreKind", [[0, "UNSPECIFIED"], [1, "CLOUD"], [2, "LOCAL"], [3, "AUTOMATION"], [4, "USER"], [5, "TEAM"], [6, "NAMED_AGENT"]], 1);
var AgentStoreSourceKind = /* @__PURE__ */ enumType2(proto3, __protoPackage136, "AgentStoreSourceKind", [[0, "UNSPECIFIED"], [1, "CLOUD"], [2, "LOCAL"], [3, "AUTOMATION"], [4, "USER"], [5, "TEAM"], [6, "NAMED_AGENT"]], 1);
var AgentStoreEntryKind = /* @__PURE__ */ enumType2(proto3, __protoPackage136, "AgentStoreEntryKind", [[0, "UNSPECIFIED"], [1, "DIRECTORY"], [2, "FILE"]], 1);
var AgentStoreTombstoneMode = /* @__PURE__ */ enumType2(proto3, __protoPackage136, "AgentStoreTombstoneMode", [[0, "UNSPECIFIED"], [1, "INCLUDE"], [2, "OMIT"], [3, "SINCE"]], 1);
var AgentStoreDirectoryListingMode = /* @__PURE__ */ enumType2(proto3, __protoPackage136, "AgentStoreDirectoryListingMode", [[0, "UNSPECIFIED"], [1, "DIRECTORY_PAGE"], [2, "COMPLETE_FLAT_STORE"], [3, "COMPLETE_FLAT_SUBTREE"]], 1);
var AgentStoreMultipartOperationFailureCode = /* @__PURE__ */ enumType2(proto3, __protoPackage136, "AgentStoreMultipartOperationFailureCode", [[0, "UNSPECIFIED"], [1, "PRECONDITION_FAILED"], [2, "UPLOAD_NOT_FOUND"], [3, "INVALID_PARTS"], [4, "CHECKSUM_MISMATCH"], [5, "TRANSIENT"], [6, "INTERNAL"], [7, "RESTART_REQUIRED"]], 1);
var AgentStoreDeleteFileStatus = /* @__PURE__ */ enumType2(proto3, __protoPackage136, "AgentStoreDeleteFileStatus", [[0, "UNSPECIFIED"], [1, "DELETED"], [2, "ALREADY_DELETED"], [3, "CONFLICT"]], 1);
var AgentStoreUndeleteFileStatus = /* @__PURE__ */ enumType2(proto3, __protoPackage136, "AgentStoreUndeleteFileStatus", [[0, "UNSPECIFIED"], [1, "RESTORED"], [2, "NOT_DELETED"], [3, "CONFLICT"], [4, "UNRECOVERABLE"], [5, "TOO_LARGE"]], 1);
var AgentStoreShareVisibility = /* @__PURE__ */ enumType2(proto3, __protoPackage136, "AgentStoreShareVisibility", [[0, "UNSPECIFIED"], [2, "TEAM"], [3, "PUBLIC"]], 1);
var ListSharedAgentStoresScope = /* @__PURE__ */ enumType2(proto3, __protoPackage136, "ListSharedAgentStoresScope", [[0, "UNSPECIFIED"], [1, "MINE"], [2, "TEAM"]], 1);
var ListAgentStoresRequest = class _ListAgentStoresRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.n = 0;
...
var AgentStoreSourceRef = class _AgentStoreSourceRef extends __protoMessage3131 {
  constructor(data) {
    super();
...
var AgentStoreMount = class _AgentStoreMount extends __protoMessage3131 {
  constructor(data) {
    super();
...
var AgentStore = class _AgentStore extends __protoMessage3131 {
  constructor(data) {
    super();
    this.storeId = "";
    this.createdAtMs = 0;
...
var ListAgentStoresResponse = class _ListAgentStoresResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.stores = [];
    this.hasMore = false;
...
var ListAgentStoreEntriesRequest = class _ListAgentStoreEntriesRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.storeId = "";
    this.relativePath = "";
...
var AgentStoreEntry = class _AgentStoreEntry extends __protoMessage3131 {
  constructor(data) {
    super();
    this.name = "";
    this.relativePath = "";
...
var ListAgentStoreEntriesResponse = class _ListAgentStoreEntriesResponse extends __protoMessage3131 {
  constructor(data) {
    super();
...
var ReadAgentStoreFileRequest = class _ReadAgentStoreFileRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.storeId = "";
    this.relativePath = "";
...
var ReadAgentStoreFileResponse = class _ReadAgentStoreFileResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.content = "";
    proto3.util.initPartial(data, this);
...
var MintAgentStoreTokenRequest = class _MintAgentStoreTokenRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.agentId = "";
    proto3.util.initPartial(data, this);
...
var MintAgentStoreTokenResponse = class _MintAgentStoreTokenResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.token = "";
...
var AgentStoreFileEntry = class _AgentStoreFileEntry extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
    this.etag = "";
...
var ListAgentStoreFilesRequest = class _ListAgentStoreFilesRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.agentId = "";
...
var ListAgentStoreFilesResponse = class _ListAgentStoreFilesResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.files = [];
    this.tombstones = [];
...
var AgentStoreTombstone = class _AgentStoreTombstone extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
    this.tombstoneEtag = "";
...
var ListAgentStoreDirectoryRequest = class _ListAgentStoreDirectoryRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relativePath = "";
    this.pageSize = 0;
...
var ListAgentStoreDirectoryResponse = class _ListAgentStoreDirectoryResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.files = [];
    this.subdirs = [];
...
var AgentStoreReadInstruction = class _AgentStoreReadInstruction extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
    this.url = "";
...
var PresignAgentStoreReadsRequest = class _PresignAgentStoreReadsRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.agentId = "";
    this.relPaths = [];
...
var PresignAgentStoreReadsResponse = class _PresignAgentStoreReadsResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.instructions = [];
    proto3.util.initPartial(data, this);
...
var AgentStoreMultipartUploadPartDescriptor = class _AgentStoreMultipartUploadPartDescriptor extends __protoMessage3131 {
  constructor(data) {
    super();
    this.partNumber = 0;
...
var AgentStoreWriteFileEntry = class _AgentStoreWriteFileEntry extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
    this.sizeBytes = protoInt64.zero;
...
var AgentStoreConflictWriteInstruction = class _AgentStoreConflictWriteInstruction extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
    this.url = "";
...
var AgentStoreLockRedirect = class _AgentStoreLockRedirect extends __protoMessage3131 {
  constructor(data) {
    super();
...
var AgentStoreWriteInstruction = class _AgentStoreWriteInstruction extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
    this.url = "";
...
var AgentStoreMultipartWriteInstruction = class _AgentStoreMultipartWriteInstruction extends __protoMessage3131 {
  constructor(data) {
    super();
    this.parts = [];
...
var AgentStoreMultipartUploadPartInstruction = class _AgentStoreMultipartUploadPartInstruction extends __protoMessage3131 {
  constructor(data) {
    super();
    this.partNumber = 0;
    this.url = "";
...
var AgentStoreMultipartUploadContext = class _AgentStoreMultipartUploadContext extends __protoMessage3131 {
  constructor(data) {
    super();
    this.uploadId = "";
    this.storeId = "";
...
var PresignAgentStoreWritesRequest = class _PresignAgentStoreWritesRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.agentId = "";
    this.files = [];
...
var PresignAgentStoreWritesResponse = class _PresignAgentStoreWritesResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.instructions = [];
    proto3.util.initPartial(data, this);
...
var AgentStoreMultipartUploadedPart = class _AgentStoreMultipartUploadedPart extends __protoMessage3131 {
  constructor(data) {
    super();
    this.partNumber = 0;
    this.etag = "";
...
var AgentStoreMultipartWriteCompletion = class _AgentStoreMultipartWriteCompletion extends __protoMessage3131 {
  constructor(data) {
    super();
    this.parts = [];
    proto3.util.initPartial(data, this);
...
var CompleteAgentStoreMultipartWritesRequest = class _CompleteAgentStoreMultipartWritesRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.storeId = "";
    this.completions = [];
...
var AgentStoreMultipartWriteSuccess = class _AgentStoreMultipartWriteSuccess extends __protoMessage3131 {
  constructor(data) {
    super();
    this.etag = "";
    proto3.util.initPartial(data, this);
...
var AgentStoreMultipartOperationFailure = class _AgentStoreMultipartOperationFailure extends __protoMessage3131 {
  constructor(data) {
    super();
...
var AgentStoreMultipartWriteResult = class _AgentStoreMultipartWriteResult extends __protoMessage3131 {
  constructor(data) {
    super();
    this.inputIndex = 0;
    this.relPath = "";
...
var CompleteAgentStoreMultipartWritesResponse = class _CompleteAgentStoreMultipartWritesResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.results = [];
    proto3.util.initPartial(data, this);
...
var AgentStoreMultipartWriteAbort = class _AgentStoreMultipartWriteAbort extends __protoMessage3131 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var AbortAgentStoreMultipartWritesRequest = class _AbortAgentStoreMultipartWritesRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.storeId = "";
    this.uploads = [];
...
var AgentStoreMultipartAbortSuccess = class _AgentStoreMultipartAbortSuccess extends __protoMessage3131 {
  constructor(data) {
    super();
...
var AgentStoreMultipartAbortResult = class _AgentStoreMultipartAbortResult extends __protoMessage3131 {
  constructor(data) {
    super();
    this.inputIndex = 0;
    this.relPath = "";
...
var AbortAgentStoreMultipartWritesResponse = class _AbortAgentStoreMultipartWritesResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.results = [];
    proto3.util.initPartial(data, this);
...
var AgentStoreFileLockHolder = class _AgentStoreFileLockHolder extends __protoMessage3131 {
  constructor(data) {
    super();
    this.clientUuid = "";
    this.pid = 0;
...
var AcquireAgentStoreFileLockRequest = class _AcquireAgentStoreFileLockRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.storeId = "";
    this.relPath = "";
...
var AcquireAgentStoreFileLockResponse = class _AcquireAgentStoreFileLockResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.acquired = false;
    this.expiresAtMs = protoInt64.zero;
...
var RenewAgentStoreFileLockRequest = class _RenewAgentStoreFileLockRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.storeId = "";
    this.relPath = "";
...
var RenewAgentStoreFileLockResponse = class _RenewAgentStoreFileLockResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.renewed = false;
    this.expiresAtMs = protoInt64.zero;
...
var ReleaseAgentStoreFileLockRequest = class _ReleaseAgentStoreFileLockRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.storeId = "";
    this.relPath = "";
...
var ReleaseAgentStoreFileLockResponse = class _ReleaseAgentStoreFileLockResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.released = false;
    proto3.util.initPartial(data, this);
...
var GetAgentStoreFileLockRequest = class _GetAgentStoreFileLockRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.storeId = "";
    this.relPath = "";
...
var GetAgentStoreFileLockResponse = class _GetAgentStoreFileLockResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.held = false;
    this.expiresAtMs = protoInt64.zero;
...
var AgentStoreDeleteFileEntry = class _AgentStoreDeleteFileEntry extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
    this.baseEtag = "";
...
var AgentStoreDeleteFileResult = class _AgentStoreDeleteFileResult extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
...
var DeleteAgentStoreFilesRequest = class _DeleteAgentStoreFilesRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.files = [];
    proto3.util.initPartial(data, this);
...
var DeleteAgentStoreFilesResponse = class _DeleteAgentStoreFilesResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.results = [];
    proto3.util.initPartial(data, this);
...
var RmdirAgentStoreRequest = class _RmdirAgentStoreRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
    proto3.util.initPartial(data, this);
...
var RmdirAgentStoreResponse = class _RmdirAgentStoreResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var AgentStoreUndeleteFileEntry = class _AgentStoreUndeleteFileEntry extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
    this.tombstoneEtag = "";
...
var AgentStoreUndeleteFileResult = class _AgentStoreUndeleteFileResult extends __protoMessage3131 {
  constructor(data) {
    super();
    this.relPath = "";
...
var UndeleteAgentStoreFilesRequest = class _UndeleteAgentStoreFilesRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.files = [];
    proto3.util.initPartial(data, this);
...
var UndeleteAgentStoreFilesResponse = class _UndeleteAgentStoreFilesResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.results = [];
    proto3.util.initPartial(data, this);
...
var ListAgentStoreTombstonesRequest = class _ListAgentStoreTombstonesRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.storeId = "";
    this.pageSize = 0;
...
var ListAgentStoreTombstonesResponse = class _ListAgentStoreTombstonesResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.tombstones = [];
    this.nextPageToken = "";
...
var SharedAgentStoreInfo = class _SharedAgentStoreInfo extends __protoMessage3131 {
  constructor(data) {
    super();
    this.shareId = "";
    this.pathPrefix = "";
...
var ShareAgentStoreRequest = class _ShareAgentStoreRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.agentId = "";
    this.pathPrefix = "";
...
var ShareAgentStoreResponse = class _ShareAgentStoreResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.shareId = "";
    this.shareUrl = "";
...
var UnshareAgentStoreRequest = class _UnshareAgentStoreRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.shareId = "";
    proto3.util.initPartial(data, this);
...
var UnshareAgentStoreResponse = class _UnshareAgentStoreResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ListSharedAgentStoresRequest = class _ListSharedAgentStoresRequest extends __protoMessage3131 {
  constructor(data) {
    super();
    this.limit = 0;
    proto3.util.initPartial(data, this);
...
var SharedAgentStoreListing = class _SharedAgentStoreListing extends __protoMessage3131 {
  constructor(data) {
    super();
    this.shareId = "";
    this.agentId = "";
...
var ListSharedAgentStoresResponse = class _ListSharedAgentStoresResponse extends __protoMessage3131 {
  constructor(data) {
    super();
    this.listings = [];
    this.hasMore = false;
