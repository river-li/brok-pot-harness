...
init_compact();
var __protoPackage119 = "aiserver.v1.";
var __protoMessage3118 = class extends CompactMessage {
  static get runtime() {
...
var StreamCmdKResponse = class _StreamCmdKResponse extends __protoMessage3118 {
  constructor(data) {
    super();
...
var StreamCmdKResponse_EditStart = class _StreamCmdKResponse_EditStart extends __protoMessage3118 {
  constructor(data) {
    super();
...
var StreamCmdKResponse_EditStream = class _StreamCmdKResponse_EditStream extends __protoMessage3118 {
  constructor(data) {
    super();
    this.text = "";
    this.editId = 0;
...
var StreamCmdKResponse_EditEnd = class _StreamCmdKResponse_EditEnd extends __protoMessage3118 {
  constructor(data) {
    super();
...
var StreamCmdKResponse_Chat = class _StreamCmdKResponse_Chat extends __protoMessage3118 {
  constructor(data) {
    super();
    this.text = "";
    proto3.util.initPartial(data, this);
...
var StreamCmdKResponse_StatusUpdate = class _StreamCmdKResponse_StatusUpdate extends __protoMessage3118 {
  constructor(data) {
    super();
    this.messages = [];
    proto3.util.initPartial(data, this);
