...
init_esm13();
init_compact();
var __protoPackage148 = "aiserver.v1.";
var __protoMessage3141 = class extends CompactMessage {
  static get runtime() {
...
var SubjectScore = class _SubjectScore extends __protoMessage3141 {
  constructor(data) {
    super();
    this.subjectKey = "";
    this.score = 0;
...
var ProjectionScoreSet = class _ProjectionScoreSet extends __protoMessage3141 {
  constructor(data) {
    super();
...
var GetProjectionSnapshotRequest = class _GetProjectionSnapshotRequest extends __protoMessage3141 {
  constructor(data) {
    super();
    this.policyId = "";
...
var GetProjectionSnapshotResponse = class _GetProjectionSnapshotResponse extends __protoMessage3141 {
  constructor(data) {
    super();
    this.policyId = "";
