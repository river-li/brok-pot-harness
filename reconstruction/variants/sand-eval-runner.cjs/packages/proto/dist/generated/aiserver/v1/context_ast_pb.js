...
init_esm13();
init_compact();
var __protoPackage123 = "aiserver.v1.";
var __protoMessage3121 = class extends CompactMessage {
  static get runtime() {
...
var ContextAST = class _ContextAST extends __protoMessage3121 {
  constructor(data) {
    super();
    this.files = [];
...
var ContainerTree = class _ContainerTree extends __protoMessage3121 {
  constructor(data) {
    super();
...
var ContainerTreeNode = class _ContainerTreeNode extends __protoMessage3121 {
  constructor(data) {
    super();
...
var ContainerTreeNode_Symbol = class _ContainerTreeNode_Symbol extends __protoMessage3121 {
  constructor(data) {
    super();
    this.docString = "";
    this.value = "";
...
var ContainerTreeNode_Container = class _ContainerTreeNode_Container extends __protoMessage3121 {
  constructor(data) {
    super();
    this.docString = "";
    this.header = "";
...
var ContainerTreeNode_Blob = class _ContainerTreeNode_Blob extends __protoMessage3121 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ContainerTreeNode_Reference = class _ContainerTreeNode_Reference extends __protoMessage3121 {
  constructor(data) {
    super();
    this.value = "";
    this.relativeWorkspacePath = "";
