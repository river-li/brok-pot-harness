...
init_esm13();
init_compact();
var __protoPackage131 = "anyrun.v1.";
var __protoMessage3128 = class extends CompactMessage {
  static get runtime() {
...
var PrivateWorkerWaitReason = /* @__PURE__ */ enumType2(proto3, __protoPackage131, "PrivateWorkerWaitReason", [[0, "UNSPECIFIED"], [1, "NO_CONNECTED_WORKERS"], [2, "LABEL_MISMATCH"], [3, "OWNER_FILTERED"], [4, "SHARED_ASSIGNMENT_FILTERED"], [5, "ALL_BUSY"]], 1);
var ClonePurpose = /* @__PURE__ */ enumType2(proto3, __protoPackage131, "ClonePurpose", [[0, "UNSPECIFIED"], [1, "DOCKER_BUILD"], [2, "WORKSPACE_SETUP"]], 1);
var PodIdentity = class _PodIdentity extends __protoMessage3128 {
  constructor(data) {
    super();
    this.tenantId = "";
    this.podId = "";
...
var PodEvent = class _PodEvent extends __protoMessage3128 {
  constructor(data) {
    super();
...
var LifecycleProcessRestarted = class _LifecycleProcessRestarted extends __protoMessage3128 {
  constructor(data) {
    super();
    this.attempt = 0;
...
var LifecycleProcessExited = class _LifecycleProcessExited extends __protoMessage3128 {
  constructor(data) {
    super();
    this.exitCode = 0;
    this.commandName = "";
...
var SpanStarted = class _SpanStarted extends __protoMessage3128 {
  constructor(data) {
    super();
    this.spanId = "";
    this.name = "";
...
var SpanEnded = class _SpanEnded extends __protoMessage3128 {
  constructor(data) {
    super();
    this.spanId = "";
    proto3.util.initPartial(data, this);
...
var WaitingForWorkerStatus = class _WaitingForWorkerStatus extends __protoMessage3128 {
  constructor(data) {
    super();
    this.retryCount = 0;
    this.maxRetries = 0;
...
var HydrationProgress = class _HydrationProgress extends __protoMessage3128 {
  constructor(data) {
    super();
...
var PodErrorEvent = class _PodErrorEvent extends __protoMessage3128 {
  constructor(data) {
    super();
    this.errorMessage = "";
    proto3.util.initPartial(data, this);
...
var FeatureOutput = class _FeatureOutput extends __protoMessage3128 {
  constructor(data) {
    super();
    this.featureId = "";
    this.output = "";
...
var FeatureExitCode = class _FeatureExitCode extends __protoMessage3128 {
  constructor(data) {
    super();
    this.featureId = "";
...
var BuildStepStarted = class _BuildStepStarted extends __protoMessage3128 {
  constructor(data) {
    super();
    this.streamId = 0;
    this.step = 0;
...
var BuildStatusLine = class _BuildStatusLine extends __protoMessage3128 {
  constructor(data) {
    super();
    this.streamId = 0;
    this.timestamp = "";
...
var InternalBuildMessage = class _InternalBuildMessage extends __protoMessage3128 {
  constructor(data) {
    super();
    this.streamId = 0;
    this.content = "";
...
var ImagePullStarted = class _ImagePullStarted extends __protoMessage3128 {
  constructor(data) {
    super();
    this.imageName = "";
    this.pullId = "";
...
var ImagePullLayerUpdate = class _ImagePullLayerUpdate extends __protoMessage3128 {
  constructor(data) {
    super();
    this.imageName = "";
    this.pullId = "";
...
var ProgressDetail = class _ProgressDetail extends __protoMessage3128 {
  constructor(data) {
    super();
...
var ImagePullStatusUpdate = class _ImagePullStatusUpdate extends __protoMessage3128 {
  constructor(data) {
    super();
    this.imageName = "";
    this.pullId = "";
...
var ImagePullCompleted = class _ImagePullCompleted extends __protoMessage3128 {
  constructor(data) {
    super();
    this.imageName = "";
    this.pullId = "";
...
var InstallCommand = class _InstallCommand extends __protoMessage3128 {
  constructor(data) {
    super();
    this.name = "";
    this.command = "";
...
var CloneStarted = class _CloneStarted extends __protoMessage3128 {
  constructor(data) {
    super();
...
var CloneCompleted = class _CloneCompleted extends __protoMessage3128 {
  constructor(data) {
    super();
    this.purpose = ClonePurpose.UNSPECIFIED;
    proto3.util.initPartial(data, this);
