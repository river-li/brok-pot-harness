...
init_compact();
var __protoPackage133 = "anyrun.v1.";
var __protoMessage3130 = class extends CompactMessage {
  static get runtime() {
...
var PodCreatingPhase = /* @__PURE__ */ enumType2(proto3, __protoPackage133, "PodCreatingPhase", [[0, "UNSPECIFIED"], [1, "CLONE"], [2, "BUILD"], [3, "POST_CREATE"], [4, "UPDATE_CONTENT"], [5, "POST_START"], [6, "QUEUED"]], 1);
var GitCloneFailureCategory = /* @__PURE__ */ enumType2(proto3, __protoPackage133, "GitCloneFailureCategory", [[0, "UNSPECIFIED"], [1, "IP_ALLOW_LIST"], [2, "INVALID_CREDENTIALS"], [3, "SSO_REDIRECT"], [4, "PROXY_CONNECT"], [5, "CONNECTION_RESET"], [6, "TRANSPORT_INTERRUPTED"], [7, "REMOTE_FORBIDDEN"], [8, "UPSTREAM_BAD_GATEWAY"]], 1);
var ImagePullFailureCategory = /* @__PURE__ */ enumType2(proto3, __protoPackage133, "ImagePullFailureCategory", [[0, "UNSPECIFIED"], [1, "DENIED"], [2, "UNAUTHORIZED"], [3, "NOT_FOUND"], [4, "RATE_LIMITED"], [5, "UPSTREAM"]], 1);
...
var PodCreatingStatus = class _PodCreatingStatus extends __protoMessage3130 {
  constructor(data) {
    super();
...
var PodRunningStatus = class _PodRunningStatus extends __protoMessage3130 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var PodFailedStatus = class _PodFailedStatus extends __protoMessage3130 {
  constructor(data) {
    super();
    this.reason = "";
    proto3.util.initPartial(data, this);
...
var PodTerminatedStatus = class _PodTerminatedStatus extends __protoMessage3130 {
  constructor(data) {
    super();
    this.reason = "";
    proto3.util.initPartial(data, this);
...
var PodFailureDetails = class _PodFailureDetails extends __protoMessage3130 {
  constructor(data) {
    super();
...
var InstallCommandFailure = class _InstallCommandFailure extends __protoMessage3130 {
  constructor(data) {
    super();
    this.isSystem = false;
    proto3.util.initPartial(data, this);
...
var DockerBuildFailure = class _DockerBuildFailure extends __protoMessage3130 {
  constructor(data) {
    super();
    this.exitCode = protoInt64.zero;
    proto3.util.initPartial(data, this);
