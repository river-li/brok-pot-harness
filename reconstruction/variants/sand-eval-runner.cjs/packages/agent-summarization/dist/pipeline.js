 ...
 * Source: ../packages/agent-summarization/dist/pipeline.js
...
var logger28 = createLogger("summarization-pipeline");
function warnIfPreservedTailShapeInvalid(ctx, partitioned, options2) {
  ...
  logger28.warn(ctx, "[summarization-pipeline] preservedTailMessages shape invariant violated", {
    summarization: {
...
function runSummarizationPipeline(summarizer, ctx, messages, options2) {
  return __awaiter39(this, void 0, void 0, function* () {
    const partitioned = summarizer.partitionMessages(messages, options2);
