...
async function applyAskQuestionCompletion(ctx, args) {
  ...
  const recordedToolCallId = originalToolCallId.length > 0 ? originalToolCallId : (0, import_node_crypto20.randomUUID)();
  const promptToolCallId = (0, import_node_crypto20.randomUUID)();
