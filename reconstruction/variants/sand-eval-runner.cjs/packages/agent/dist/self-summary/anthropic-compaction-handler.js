 ...
 * Source: ../packages/agent/dist/self-summary/anthropic-compaction-handler.js
...
var __addDisposableResource27 = function(env, value, async) {
...
var __disposeResources27 = /* @__PURE__ */ (function(SuppressedError2) {
  return function(env) {
    function fail(e) {
...
var logger39 = createLogger("@anysphere/agent");
...
var AnthropicCompactionHandler = class {
  ...
  async generateSummary(ctx, partitioned, _options) {
    ...
    logger39.info(ctx, "[anthropic-compaction] generating summary via explicit user prompt");
...
${rawSummary.text}
  ...
  async summarize(ctx, messages, options2) {
    ...
    try {
      const spanCtxt = __addDisposableResource27(env_1, createSpan(ctx.withName("AnthropicCompactionHandler.summarize")), false);
      const innerCtx = spanCtxt.ctx;
      const startTime = performance.now();
      logger39.info(innerCtx, "[anthropic-compaction] summarize starting", {
      ...
      try {
        ...
        logger39.info(innerCtx, "[anthropic-compaction] summarize completed", {
