...
var logger48 = createLogger("agent/tools/computer-use/anthropic");
function createAnthropicComputerTool(config2) {
  ...
  const executeAction = async (parentCtx, interactionHandler, args, meta) => {
    ...
    try {
      const spanCtxt = __addDisposableResource30(env_1, createSpan(parentCtx.withName("computerUseExecute")), false);
      logger48.info(spanCtxt.ctx, "Executing computer action", {
