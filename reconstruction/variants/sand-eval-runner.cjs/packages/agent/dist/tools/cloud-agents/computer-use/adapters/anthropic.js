 ...
 * Source: ../packages/agent/dist/tools/cloud-agents/computer-use/adapters/anthropic.js
...
function makeCoordinate(tuple) {
  if (tuple === void 0) {
    return void 0;
  }
  return new Coordinate({ x: tuple[0], y: tuple[1] });
}
