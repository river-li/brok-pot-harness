...
`;
      ...
      const normalizedPath = dir.absPath.replaceAll(import_node_path40.default.win32.sep, import_node_path40.default.posix.sep);
      result2 = `${indent}- ${import_node_path40.default.posix.basename(normalizedPath)}${pathSep}
`;
    }
    const allChildren = [
      ...
      ...dir.childrenDirs.map((childDir) => {
        const normalizedPath = childDir.absPath.replaceAll(import_node_path40.default.win32.sep, import_node_path40.default.posix.sep);
        return {
          type: "dir",
          name: import_node_path40.default.posix.basename(normalizedPath),
          dir: childDir
        };
      })
    ];
