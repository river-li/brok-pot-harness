...
var execFileAsync = (0, import_node_util2.promisify)(import_node_child_process6.execFile);
...
function gitExecFile(file, args, options2) {
  return __awaiter19(this, void 0, void 0, function* () {
    const _a20 = options2 !== null && options2 !== void 0 ? options2 : {}, { env, encoding = "utf8" } = _a20, rest = __rest4(_a20, ["env", "encoding"]);
    const result = yield execFileAsync(file, args, Object.assign(Object.assign({}, rest), { encoding, env: withGitEnv(args, env) }));
    return {
