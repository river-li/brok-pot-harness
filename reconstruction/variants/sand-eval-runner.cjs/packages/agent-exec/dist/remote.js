 ...
 * Source: ../packages/agent-exec/dist/remote.js
...
var logger6 = createLogger("ExecutorResource");
...
var ExecutorResource = class {
  ...
  execute(parentCtx, args, options2) {
    return __awaiter12(this, void 0, void 0, function* () {
      ...
      try {
        const span = __addDisposableResource(env_1, createSpan(parentCtx.withName("ExecutorResource.execute")), false);
        const ctx = span.ctx;
        ...
        void (() => __awaiter12(this, void 0, void 0, function* () {
          var _a20, e_2, _b2, _c2;
          try {
            try {
              for (var _d = true, rest_1 = __asyncValues9(rest), rest_1_1; rest_1_1 = yield rest_1.next(), _a20 = rest_1_1.done, !_a20; _d = true) {
                _c2 = rest_1_1.value;
                _d = false;
                const message = _c2;
              ...
              try {
                if (!_d && !_a20 && (_b2 = rest_1.return)) yield _b2.call(rest_1);
              } finally {
                if (e_2) throw e_2.error;
              }
            }
          } catch (error3) {
            logger6.info(ctx, "Ignoring exec stream shutdown during detached drain", { error: error3 });
          }
        }))().catch(() => {
        });
        return resultValue;
...
var StreamExecutorResource = class {
  ...
  execute(parentCtx, args, options2) {
    return __asyncGenerator10(this, arguments, function* execute_1() {
      var _a20, e_3, _b2, _c2;
      const env_2 = { stack: [], error: void 0, hasError: false };
      try {
        const span = __addDisposableResource(env_2, createSpan(parentCtx.withName("StreamExecutorResource.execute")), false);
        const ctx = span.ctx;
        const spanContextData = getSpanContextData(ctx);
        const spanContext = spanContextData ? new SpanContext(spanContextData) : void 0;
        const messageStream = this.execManager.createExecInstance(ctx, (id) => {
        ...
        try {
          for (var _d = true, messageStream_1 = __asyncValues9(messageStream), messageStream_1_1; messageStream_1_1 = yield __await10(messageStream_1.next()), _a20 = messageStream_1_1.done, !_a20; _d = true) {
          ...
          try {
            if (!_d && !_a20 && (_b2 = messageStream_1.return)) yield __await10(_b2.call(messageStream_1));
          } finally {
