...
var FileBasedTokenStore = class _FileBasedTokenStore {
  ...
  loadMcpAuth() {
    return __awaiter37(this, void 0, void 0, function* () {
      try {
        const mcpAuth = yield (0, import_promises16.readFile)(this.mcpAuthPath, "utf8");
  ...
  loadTokens(identifier) {
    return __awaiter37(this, void 0, void 0, function* () {
      ...
      return (_a20 = mcpAuth[identifier]) === null || _a20 === void 0 ? void 0 : _a20.tokens;
    });
  }
  saveTokens(identifier, tokens) {
    return __awaiter37(this, void 0, void 0, function* () {
      yield this.withSaveLock(() => __awaiter37(this, void 0, void 0, function* () {
        const mcpAuth = yield this.mcpAuthPromise;
  ...
  loadClientInformation(identifier) {
    return __awaiter37(this, void 0, void 0, function* () {
      var _a20;
      const mcpAuth = yield this.mcpAuthPromise;
      return (_a20 = mcpAuth[identifier]) === null || _a20 === void 0 ? void 0 : _a20.clientInfo;
    });
  }
  withSaveLock(fn) {
    return __awaiter37(this, void 0, void 0, function* () {
  ...
  saveMcpAuth(data) {
    return __awaiter37(this, void 0, void 0, function* () {
      yield (0, import_promises16.mkdir)(path15.dirname(this.mcpAuthPath), { recursive: true });
      yield (0, import_promises16.writeFile)(this.mcpAuthPath, JSON.stringify(data, null, 2));
    });
  }
};
