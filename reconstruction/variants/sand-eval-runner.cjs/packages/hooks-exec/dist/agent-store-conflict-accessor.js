...
function extractWritePath(args) {
  ...
  return typeof path30 === "string" && path30.length > 0 ? path30 : void 0;
}
...
function awaitForceWrittenPathBeforeDrain(force, args, wake, options2) {
  return __awaiter42(this, void 0, void 0, function* () {
    const report = (event) => {
      var _a20;
      try {
        (_a20 = options2.onWriteBarrier) === null || _a20 === void 0 ? void 0 : _a20.call(options2, event);
      } catch (_b2) {
      }
    };
    ...
    const raced = yield Promise.race([
      forceOutcome,
      delay(options2.timeoutMs).then(() => "timeout")
    ]);
...
var AgentStoreConflictDrainResourceAccessor = class _AgentStoreConflictDrainResourceAccessor {
  ...
  constructor(inner, drain, wake, options2) {
    ...
    this.writeBarrierTimeoutMs = (_a20 = options2 === null || options2 === void 0 ? void 0 : options2.writeBarrierTimeoutMs) !== null && _a20 !== void 0 ? _a20 : DEFAULT_WRITE_BARRIER_TIMEOUT_MS;
  ...
  *entries() {
  ...
  wrapImpl(resourceSymbol, impl) {
    ...
    const appendDrain = (ctx, options2) => __awaiter42(this, void 0, void 0, function* () {
      ...
      const runPeek = (attachTo) => __awaiter42(this, void 0, void 0, function* () {
          ...
          if (isAsyncIterable(result)) {
            return (function wrapped() {
              return __asyncGenerator12(this, arguments, function* wrapped_1() {
                ...
                try {
                  try {
                    for (var _d = true, result_1 = __asyncValues11(result), result_1_1; result_1_1 = yield __await12(result_1.next()), _a20 = result_1_1.done, !_a20; _d = true) {
                    ...
                    try {
                      if (!_d && !_a20 && (_b2 = result_1.return)) yield __await12(_b2.call(result_1));
                    } finally {
