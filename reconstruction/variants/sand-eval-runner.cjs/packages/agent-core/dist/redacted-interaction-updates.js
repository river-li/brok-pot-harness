...
var RedactedUpdates = {
  ...
  userMessageAppended(userMessage) {
    ...
    return {
      ...
      message: {
        ...
        value: { _privacyMode: privacyMode, userMessage }
      }
    };
  },
  ...
  summaryCompleted(privacyMode, hookMessage, failed) {
    return {
      _privacyMode: privacyMode,
      message: {
        case: "summaryCompleted",
        value: { _privacyMode: privacyMode, hookMessage, failed }
      }
    };
  },
  ...
  activeBranchChange(path30, branchName) {
    const privacyMode = path30.__privacyMode;
    return {
      _privacyMode: privacyMode,
      message: {
        case: "activeBranchChange",
        value: { _privacyMode: privacyMode, path: path30, branchName }
      }
    };
  },
  feedbackRequest(requestId, canonicalModelName, privacyMode, categories, categoryGroups = [], copy = {}) {
