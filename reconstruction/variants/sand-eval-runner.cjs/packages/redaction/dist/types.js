...
var RedactedString = class {
   ...
   */
  __clone(newValue) {
    return new _a19(newValue, this.__classification, `${this.__fieldName}.clone`, __classPrivateFieldGet2(this, _RedactedString_privacyContext, "f"));
  }
  /**
  ...
  [(_RedactedString_value = /* @__PURE__ */ new WeakMap(), _RedactedString_privacyContext = /* @__PURE__ */ new WeakMap(), _RedactedString_instances = /* @__PURE__ */ new WeakSet(), _RedactedString_displayValue = function _RedactedString_displayValue2() {
    ...
    return new _a19(newValue, this.__classification, this.__fieldName, __classPrivateFieldGet2(this, _RedactedString_privacyContext, "f"));
