...
var SKILLIFY_HARNESS_SKILLS = [
  {
    ...
    description: 'When the user asks for anything recurring, scheduled, or event-driven, such as a reminder, digest, monitor, "let me know when", or a change to an existing routine, read before you create or change it.',
  ...
  },
  {
    ...
    description: "When a task needs your own desktop or browser, such as a website with no connector, a GUI app, or a sign-in only the user can complete, read before you dispatch the first browser or desktop subagent.",
