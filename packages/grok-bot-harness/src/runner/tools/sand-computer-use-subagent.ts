...
function computerUseSubagentDescription(options2) {
  ...
  return [
    ...combined ? [
      ...
      "Delegate a self-contained browser or desktop task to a background subagent that drives your box's desktop by screenshot, click, drag, type, key, scroll, and wait. It handles websites, GUI apps, file dialogs, and drag interactions."
    ],
