...
var description3 = [
  ...
  `The user gets one address. If ${SAND_LIST_EMAIL_INBOXES_TOOL_NAME} already shows a live one, do not claim another \u2014 the server refuses a second claim. Ask the user which address they want only when they have none.`,
