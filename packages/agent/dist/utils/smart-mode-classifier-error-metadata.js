...
function parseSmartModeClassifierFailureMetadata(error41) {
  if (error41 === void 0) {
    return void 0;
  }
  const markerIndex = error41.indexOf(METADATA_MARKER);
  if (markerIndex < 0) {
    return void 0;
  }
  const rawMetadata = error41.slice(markerIndex + METADATA_MARKER.length);
  try {
