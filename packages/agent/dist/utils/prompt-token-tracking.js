...
function trackPromptTokenUsage(params) {
  ...
  const { conversationHistoryTokens, conversationHistoryMessageCount } = countConversationHistoryTokens(messages2);
...
function countConversationHistoryTokens(messages2) {
  let conversationHistoryTokens = 0;
  const nonSystemMessages = messages2.filter((m2) => m2.role !== "system");
