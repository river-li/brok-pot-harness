...
function parseDynamicInvocationArgs(args) {
  ...
  const namespace = "namespace" in parsed2 ? parsed2.namespace : void 0;
  const server = "server" in parsed2 ? parsed2.server : void 0;
  const toolName = "toolName" in parsed2 ? parsed2.toolName : void 0;
  ...
  return {
    ...
    arguments: "arguments" in parsed2 ? parsed2.arguments : void 0
  };
}
