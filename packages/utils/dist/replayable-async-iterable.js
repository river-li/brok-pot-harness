    ...
    ReplayableAsyncIterable = class {
      ...
      consume(source) {
        return __awaiter14(this, void 0, void 0, function* () {
          ...
          try {
            try {
              for (_a19 = true, source_1 = __asyncValues4(source); source_1_1 = yield source_1.next(), _b2 = source_1_1.done, !_b2; _a19 = true) {
                _d = source_1_1.value;
                _a19 = false;
                const value = _d;
              ...
              try {
                if (!_a19 && !_b2 && (_c2 = source_1.return)) yield _c2.call(source_1);
              } finally {
      ...
      [Symbol.asyncIterator]() {
        return __asyncGenerator5(this, arguments, function* _a19() {
          let index = 0;
          while (true) {
            while (index < this.buffer.length) {
              yield yield __await5(this.buffer[index]);
              index++;
            }
            if (this.closed) {
              ...
              return yield __await5(void 0);
            }
            yield __await5(new Promise((resolve29) => {
              this.waiters.push(resolve29);
            }));
          }
        });
      }
