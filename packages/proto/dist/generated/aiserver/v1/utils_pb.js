...
var __protoPackage2, __protoMessage32, LintSeverity, FeatureType, EmbeddingModel, CursorPosition, SelectionWithOrientation, GetDiffRequest, GetDiffRequest_OutputFormat, GetDiffResponse, GetDiffResponse_SubmoduleDiff, SimplestRange, GitDiff, GitDiff_DiffType, FileDiff, FileDiff_Chunk, SimpleRange, CmdKDebugInfo, CmdKDebugInfo_UnsavedFiles, CmdKDebugInfo_OpenEditor, CmdKDebugInfo_CppFileDiffHistory, CmdKDebugInfo_PastThought, LineRange, CursorRange, DetailedLine, CodeBlock, CodeBlock_Signatures, GitCommit, FileGit, File2, Diagnostic, Diagnostic_DiagnosticSeverity, Diagnostic_RelatedInformation, Lint, BM25Chunk, CurrentFileInfo, CurrentFileInfo_NotebookCell, AzureState, BedrockState, ModelDetails, CloudAgentModelSelection, CloudAgentModelSelection_ParameterValue, ModelInfo, DataframeInfo, DataframeInfo_Column, LinterError, LinterErrors, LinterErrorsWithoutFileContents, CursorRule, ExplicitContext, MCPInstructions, DocumentSymbol, DocumentSymbol_SymbolKind, DocumentSymbol_Range, HoverDetails, UriComponents, DocumentSymbolWithText, ErrorDetails, ErrorDetails_Error, CustomErrorDetails, ErrorAnalyticsMetadata, PlanChoice, ErrorButton, ClientAction, ReloadWindowAction, DashboardAction, UpgradeChoice, UpgradeAction, SwitchModelAction, SwitchModelAction_ModelParameterValue, ConfigureSpendLimitAction, UrlAction, ImageProto, ImageProto_Dimension, ChatQuote, ChatExternalLink, ComposerExternalLink, CmdKExternalLink, CommitNote, CommitNoteWithEmbeddings, CommitDiffString, CodeChunk, CodeChunk_Intent, CodeChunk_SummarizationStrategy, RCPCallFrame, RCPStackTrace, RCPLogEntry, RCPUIElementPicked;
var init_utils_pb = __esm({
  "../packages/proto/dist/generated/aiserver/v1/utils_pb.js"() {
    "use strict";
    init_esm();
    init_compact();
    __protoPackage2 = "aiserver.v1.";
    __protoMessage32 = class extends CompactMessage {
      static get runtime() {
    ...
    LintSeverity = /* @__PURE__ */ enumType(proto3, __protoPackage2, "LintSeverity", [[0, "UNSPECIFIED"], [1, "ERROR"], [2, "WARNING"], [3, "INFO"], [4, "HINT"], [5, "AI"]], 1);
    FeatureType = /* @__PURE__ */ enumType(proto3, __protoPackage2, "FeatureType", [[0, "UNSPECIFIED"], [1, "EDIT"], [2, "GENERATE"], [3, "INLINE_LONG_COMPLETION"]], 1);
    EmbeddingModel = /* @__PURE__ */ enumType(proto3, __protoPackage2, "EmbeddingModel", [[0, "UNSPECIFIED"], [1, "VOYAGE_CODE_2"], [2, "TEXT_EMBEDDINGS_LARGE_3"], [3, "QWEN_1_5B_CUSTOM"], [4, "MOCK_CHUNKER_ERROR"], [5, "QWEN_1_5B_0618_CUSTOM"], [6, "QWEN_1_5B_0618_FP8_MM_CUSTOM"]], 1);
    CursorPosition = class _CursorPosition extends __protoMessage32 {
      constructor(data) {
        super();
        this.line = 0;
        this.column = 0;
    ...
    SelectionWithOrientation = class _SelectionWithOrientation extends __protoMessage32 {
      constructor(data) {
        super();
    ...
    GetDiffRequest = class _GetDiffRequest extends __protoMessage32 {
      constructor(data) {
        super();
        this.cwd = "";
        this.ref = "";
    ...
    GetDiffRequest_OutputFormat = /* @__PURE__ */ enumType(proto3, __protoPackage2, "GetDiffRequest.OutputFormat", [[0, "UNSPECIFIED"], [1, "NAME_STATUS"], [2, "NAME_STATUS_AND_NUMSTAT"], [3, "FILE_DIFFS"], [4, "DIFFS_WITH_BEFORE_AND_AFTER"]], 1);
    GetDiffResponse = class _GetDiffResponse extends __protoMessage32 {
      constructor(data) {
        super();
        this.submoduleDiffs = [];
        proto3.util.initPartial(data, this);
    ...
    GetDiffResponse_SubmoduleDiff = class _GetDiffResponse_SubmoduleDiff extends __protoMessage32 {
      constructor(data) {
        super();
        this.relativePath = "";
        this.errored = false;
    ...
    SimplestRange = class _SimplestRange extends __protoMessage32 {
      constructor(data) {
        super();
        this.startLine = 0;
    ...
    GitDiff = class _GitDiff extends __protoMessage32 {
      constructor(data) {
        super();
        this.diffs = [];
    ...
    GitDiff_DiffType = /* @__PURE__ */ enumType(proto3, __protoPackage2, "GitDiff.DiffType", [[0, "UNSPECIFIED"], [1, "DIFF_TO_HEAD"], [2, "DIFF_FROM_BRANCH_TO_MAIN"]], 1);
    FileDiff = class _FileDiff extends __protoMessage32 {
      constructor(data) {
        super();
        this.added = 0;
        this.removed = 0;
    ...
    FileDiff_Chunk = class _FileDiff_Chunk extends __protoMessage32 {
      constructor(data) {
        super();
        this.content = "";
        this.lines = [];
    ...
    SimpleRange = class _SimpleRange extends __protoMessage32 {
      constructor(data) {
        super();
    ...
    CmdKDebugInfo = class _CmdKDebugInfo extends __protoMessage32 {
      constructor(data) {
        super();
        this.remoteUrl = "";
        this.commitId = "";
    ...
    CmdKDebugInfo_UnsavedFiles = class _CmdKDebugInfo_UnsavedFiles extends __protoMessage32 {
      constructor(data) {
        super();
    ...
    CmdKDebugInfo_OpenEditor = class _CmdKDebugInfo_OpenEditor extends __protoMessage32 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
    ...
    CmdKDebugInfo_CppFileDiffHistory = class _CmdKDebugInfo_CppFileDiffHistory extends __protoMessage32 {
      constructor(data) {
        super();
        this.fileName = "";
        this.diffHistory = [];
    ...
    CmdKDebugInfo_PastThought = class _CmdKDebugInfo_PastThought extends __protoMessage32 {
      constructor(data) {
        super();
        this.text = "";
    ...
    LineRange = class _LineRange extends __protoMessage32 {
      constructor(data) {
        super();
        this.startLineNumber = 0;
        this.endLineNumberInclusive = 0;
    ...
    CursorRange = class _CursorRange extends __protoMessage32 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    DetailedLine = class _DetailedLine extends __protoMessage32 {
      constructor(data) {
        super();
        this.text = "";
        this.lineNumber = 0;
    ...
    CodeBlock = class _CodeBlock extends __protoMessage32 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.contents = "";
    ...
    CodeBlock_Signatures = class _CodeBlock_Signatures extends __protoMessage32 {
      constructor(data) {
        super();
        this.ranges = [];
        proto3.util.initPartial(data, this);
    ...
    GitCommit = class _GitCommit extends __protoMessage32 {
      constructor(data) {
        super();
        this.commit = "";
        this.author = "";
    ...
    FileGit = class _FileGit extends __protoMessage32 {
      constructor(data) {
        super();
        this.commits = [];
        proto3.util.initPartial(data, this);
    ...
    File2 = class _File extends __protoMessage32 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.contents = "";
    ...
    Diagnostic = class _Diagnostic extends __protoMessage32 {
      constructor(data) {
        super();
        this.message = "";
    ...
    Diagnostic_DiagnosticSeverity = /* @__PURE__ */ enumType(proto3, __protoPackage2, "Diagnostic.DiagnosticSeverity", [[0, "UNSPECIFIED"], [1, "ERROR"], [2, "WARNING"], [3, "INFORMATION"], [4, "HINT"]], 1);
    Diagnostic_RelatedInformation = class _Diagnostic_RelatedInformation extends __protoMessage32 {
      constructor(data) {
        super();
        this.message = "";
        proto3.util.initPartial(data, this);
    ...
    Lint = class _Lint extends __protoMessage32 {
      constructor(data) {
        super();
        this.message = "";
    ...
    BM25Chunk = class _BM25Chunk extends __protoMessage32 {
      constructor(data) {
        super();
        this.content = "";
        this.score = 0;
    ...
    CurrentFileInfo = class _CurrentFileInfo extends __protoMessage32 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.contents = "";
    ...
    AzureState = class _AzureState extends __protoMessage32 {
      constructor(data) {
        super();
        this.apiKey = "";
        this.baseUrl = "";
    ...
    BedrockState = class _BedrockState extends __protoMessage32 {
      constructor(data) {
        super();
        this.accessKey = "";
        this.secretKey = "";
    ...
    ModelDetails = class _ModelDetails extends __protoMessage32 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    CloudAgentModelSelection = class _CloudAgentModelSelection extends __protoMessage32 {
      constructor(data) {
        super();
        this.modelId = "";
        this.parameters = [];
    ...
    CloudAgentModelSelection_ParameterValue = class _CloudAgentModelSelection_ParameterValue extends __protoMessage32 {
      constructor(data) {
        super();
        this.id = "";
        this.value = "";
    ...
    ModelInfo = class _ModelInfo extends __protoMessage32 {
      constructor(data) {
        super();
        this.modelName = "";
        proto3.util.initPartial(data, this);
    ...
    DataframeInfo = class _DataframeInfo extends __protoMessage32 {
      constructor(data) {
        super();
        this.name = "";
        this.shape = "";
    ...
    DataframeInfo_Column = class _DataframeInfo_Column extends __protoMessage32 {
      constructor(data) {
        super();
        this.key = "";
        this.type = "";
    ...
    LinterError = class _LinterError extends __protoMessage32 {
      constructor(data) {
        super();
        this.message = "";
        this.relatedInformation = [];
    ...
    LinterErrors = class _LinterErrors extends __protoMessage32 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.errors = [];
    ...
    LinterErrorsWithoutFileContents = class _LinterErrorsWithoutFileContents extends __protoMessage32 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.errors = [];
    ...
    CursorRule = class _CursorRule extends __protoMessage32 {
      constructor(data) {
        super();
        this.name = "";
        this.description = "";
    ...
    ExplicitContext = class _ExplicitContext extends __protoMessage32 {
      constructor(data) {
        super();
        this.context = "";
        this.rules = [];
      ...
      static $() {
        return ["ExplicitContext|1 context 9|2 repo_context 9?|3 rules #0*|4 mode_specific_context 9?|5 mcp_instructions #1*", CursorRule, MCPInstructions];
      }
    };
    MCPInstructions = class _MCPInstructions extends __protoMessage32 {
      constructor(data) {
        super();
        this.serverName = "";
    ...
    DocumentSymbol = class _DocumentSymbol extends __protoMessage32 {
      constructor(data) {
        super();
        this.name = "";
        this.detail = "";
    ...
    DocumentSymbol_SymbolKind = /* @__PURE__ */ enumType(proto3, __protoPackage2, "DocumentSymbol.SymbolKind", [[0, "UNSPECIFIED"], [1, "FILE"], [2, "MODULE"], [3, "NAMESPACE"], [4, "PACKAGE"], [5, "CLASS"], [6, "METHOD"], [7, "PROPERTY"], [8, "FIELD"], [9, "CONSTRUCTOR"], [10, "ENUM"], [11, "INTERFACE"], [12, "FUNCTION"], [13, "VARIABLE"], [14, "CONSTANT"], [15, "STRING"], [16, "NUMBER"], [17, "BOOLEAN"], [18, "ARRAY"], [19, "OBJECT"], [20, "KEY"], [21, "NULL"], [22, "ENUM_MEMBER"], [23, "STRUCT"], [24, "EVENT"], [25, "OPERATOR"], [26, "TYPE_PARAMETER"]], 1);
    DocumentSymbol_Range = class _DocumentSymbol_Range extends __protoMessage32 {
      constructor(data) {
        super();
        this.startLineNumber = 0;
        this.startColumn = 0;
    ...
    HoverDetails = class _HoverDetails extends __protoMessage32 {
      constructor(data) {
        super();
        this.codeDetails = "";
        this.markdownBlocks = [];
    ...
    UriComponents = class _UriComponents extends __protoMessage32 {
      constructor(data) {
        super();
        this.scheme = "";
        proto3.util.initPartial(data, this);
    ...
    DocumentSymbolWithText = class _DocumentSymbolWithText extends __protoMessage32 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
    ...
    ErrorDetails = class _ErrorDetails extends __protoMessage32 {
      constructor(data) {
        super();
    ...
    ErrorAnalyticsMetadata = class _ErrorAnalyticsMetadata extends __protoMessage32 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    PlanChoice = class _PlanChoice extends __protoMessage32 {
      constructor(data) {
        super();
        this.label = "";
        this.value = "";
    ...
    ErrorButton = class _ErrorButton extends __protoMessage32 {
      constructor(data) {
        super();
        this.label = "";
    ...
    ClientAction = class _ClientAction extends __protoMessage32 {
      constructor(data) {
        super();
        this.commandId = "";
        this.args = {};
    ...
    ReloadWindowAction = class _ReloadWindowAction extends __protoMessage32 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    DashboardAction = class _DashboardAction extends __protoMessage32 {
      constructor(data) {
        super();
        this.action = "";
        this.args = {};
    ...
    UpgradeChoice = class _UpgradeChoice extends __protoMessage32 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    UpgradeAction = class _UpgradeAction extends __protoMessage32 {
      constructor(data) {
        super();
    ...
    SwitchModelAction = class _SwitchModelAction extends __protoMessage32 {
      constructor(data) {
        super();
        this.parameters = [];
        proto3.util.initPartial(data, this);
    ...
    SwitchModelAction_ModelParameterValue = class _SwitchModelAction_ModelParameterValue extends __protoMessage32 {
      constructor(data) {
        super();
        this.id = "";
        this.value = "";
    ...
    ConfigureSpendLimitAction = class _ConfigureSpendLimitAction extends __protoMessage32 {
      constructor(data) {
        super();
        this.confirmLabel = "";
        proto3.util.initPartial(data, this);
    ...
    UrlAction = class _UrlAction extends __protoMessage32 {
      constructor(data) {
        super();
        this.url = "";
        proto3.util.initPartial(data, this);
    ...
    ImageProto = class _ImageProto extends __protoMessage32 {
      constructor(data) {
        super();
    ...
    ImageProto_Dimension = class _ImageProto_Dimension extends __protoMessage32 {
      constructor(data) {
        super();
        this.width = 0;
        this.height = 0;
    ...
    ChatQuote = class _ChatQuote extends __protoMessage32 {
      constructor(data) {
        super();
        this.markdown = "";
        this.bubbleId = "";
    ...
    ChatExternalLink = class _ChatExternalLink extends __protoMessage32 {
      constructor(data) {
        super();
        this.url = "";
        this.uuid = "";
    ...
    ComposerExternalLink = class _ComposerExternalLink extends __protoMessage32 {
      constructor(data) {
        super();
        this.url = "";
        this.uuid = "";
    ...
    CmdKExternalLink = class _CmdKExternalLink extends __protoMessage32 {
      constructor(data) {
        super();
        this.url = "";
        this.uuid = "";
    ...
    CommitNote = class _CommitNote extends __protoMessage32 {
      constructor(data) {
        super();
        this.note = "";
        this.commitHash = "";
    ...
    CommitNoteWithEmbeddings = class _CommitNoteWithEmbeddings extends __protoMessage32 {
      constructor(data) {
        super();
        this.note = "";
        this.commitHash = "";
    ...
    CommitDiffString = class _CommitDiffString extends __protoMessage32 {
      constructor(data) {
        super();
        this.diff = "";
        proto3.util.initPartial(data, this);
    ...
    CodeChunk = class _CodeChunk extends __protoMessage32 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.startLineNumber = 0;
    ...
    CodeChunk_Intent = /* @__PURE__ */ enumType(proto3, __protoPackage2, "CodeChunk.Intent", [[0, "UNSPECIFIED"], [1, "COMPOSER_FILE"], [2, "COMPRESSED_COMPOSER_FILE"]], 1);
    CodeChunk_SummarizationStrategy = /* @__PURE__ */ enumType(proto3, __protoPackage2, "CodeChunk.SummarizationStrategy", [[0, "NONE_UNSPECIFIED"], [1, "SUMMARIZED"], [2, "EMBEDDED"]], 1);
    RCPCallFrame = class _RCPCallFrame extends __protoMessage32 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    RCPStackTrace = class _RCPStackTrace extends __protoMessage32 {
      constructor(data) {
        super();
        this.callFrames = [];
        proto3.util.initPartial(data, this);
    ...
    RCPLogEntry = class _RCPLogEntry extends __protoMessage32 {
      constructor(data) {
        super();
        this.message = "";
        this.timestamp = 0;
    ...
    RCPUIElementPicked = class _RCPUIElementPicked extends __protoMessage32 {
      constructor(data) {
        super();
        this.element = "";
        this.xpath = "";
