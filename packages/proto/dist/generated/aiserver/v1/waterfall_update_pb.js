...
var init_waterfall_update_pb = __esm({
  "../packages/proto/dist/generated/aiserver/v1/waterfall_update_pb.js"() {
    ...
    SetupWaterfallSentinel = class _SetupWaterfallSentinel extends __protoMessage3125 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SpanStart = class _SpanStart extends __protoMessage3125 {
      constructor(data) {
        super();
        this.spanId = "";
    ...
    SpanUpdate = class _SpanUpdate extends __protoMessage3125 {
      constructor(data) {
        super();
        this.spanId = "";
    ...
    SpanEnd = class _SpanEnd extends __protoMessage3125 {
      constructor(data) {
        super();
        this.spanId = "";
    ...
    SpanLog = class _SpanLog extends __protoMessage3125 {
      constructor(data) {
        super();
        this.spanId = "";
        this.message = "";
    ...
    SpanStatusUpdate = class _SpanStatusUpdate extends __protoMessage3125 {
      constructor(data) {
        super();
        this.spanId = "";
    ...
    CallToAction = class _CallToAction extends __protoMessage3125 {
      constructor(data) {
        super();
    ...
    OpenUrlCallToAction = class _OpenUrlCallToAction extends __protoMessage3125 {
      constructor(data) {
        super();
        this.url = "";
        this.buttonText = "";
    ...
    GitReposSetupSpanDetails = class _GitReposSetupSpanDetails extends __protoMessage3125 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    GitRepoSetupSpanDetails = class _GitRepoSetupSpanDetails extends __protoMessage3125 {
      constructor(data) {
        super();
    ...
    GenericLogSpanUpdate = class _GenericLogSpanUpdate extends __protoMessage3125 {
      constructor(data) {
        super();
        this.message = "";
        this.level = WaterfallLogLevel.UNSPECIFIED;
