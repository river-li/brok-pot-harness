...
var init_lsp_subgraph_pb = __esm({
  "../packages/proto/dist/generated/aiserver/v1/lsp_subgraph_pb.js"() {
    ...
    LspSubgraphRange = class _LspSubgraphRange extends __protoMessage3115 {
      constructor(data) {
        super();
        this.startLine = 0;
    ...
    LspSubgraphContextItem = class _LspSubgraphContextItem extends __protoMessage3115 {
      constructor(data) {
        super();
        this.type = "";
        this.content = "";
    ...
    LspSubgraphFullContext = class _LspSubgraphFullContext extends __protoMessage3115 {
      constructor(data) {
        super();
        this.uri = "";
        this.symbolName = "";
