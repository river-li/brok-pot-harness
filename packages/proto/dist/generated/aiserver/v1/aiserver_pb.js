var __protoPackage130, __protoMessage3124, TaskListItemState, AvailableModelsScope, CloudAgentEffortMode, TaskStatus, GetComposerAutocompleteRequest, GetComposerAutocompleteResponse, ComposerAutocompleteContext, CurrentFileContext, CachedFileContext, ChatSuggestionItem, RecentChat, RecentChatMessage, GetChatSuggestionsRequest, GetChatSuggestionsResponse, GetUserInstructionsRequest, GetUserInstructionsResponse, IsTerminalFinishedRequest, IsTerminalFinishedResponseV2, TestBidiRequest, TestBidiResponse, AutoContextFile, AutoContextRequest, AutoContextRankedFile, AutoContextResponse, CheckBugBotPriceRequest, CheckBugBotPriceResponse, AcknowledgeGracePeriodDisclaimerRequest, AcknowledgeGracePeriodDisclaimerResponse, CheckBugBotTelemetryHealthyRequest, CheckBugBotTelemetryHealthyResponse, RecordIdeBugReactionRequest, RecordIdeBugReactionResponse, GetSuggestedBugBotIterationsRequest, GetSuggestedBugBotIterationsResponse, GetEditorBugbotAutoRunStatusRequest, GetEditorBugbotAutoRunStatusResponse, BugBotStatus, BugBotStatus_Status, BugbotTrialNotification, StreamBugBotResponse, StreamBugBotAgenticClientMessage, StreamBugBotAgenticServerMessage, UiBestOfNJudgeCandidate, StreamUiBestOfNJudgeStartRequest, UiBestOfNJudgeFinalResult, StreamUiBestOfNJudgeClientMessage, StreamUiBestOfNJudgeServerMessage, ContextRerankingRequest, ContextRerankingResponse, NameTabRequest, NameTabResponse, TaskListItem, KeepTaskListRequest, TaskListChange, KeepTaskListResponse, TestModelStatusRequest, TestModelStatusResponse, LlmGatewayModelTestStage, LlmGatewayModelTestInspect, LlmGatewayModelTestUsage, LlmGatewayConnectionTesterRequest, LlmGatewayConnectionTesterResponse, EvaluatePromptHookRequest, EvaluatePromptHookResponse, TryParseTypeScriptTreeSitterRequest, TryParseTypeScriptTreeSitterResponse, DevOnlyGetPastRequestIdsRequest, DevOnlyPastRequest, DevOnlyGetPastRequestIdsResponse, GetCodebaseQuestionsResponse, AtSymbolOption, AtSymbolDependencyInformation, GetAtSymbolSuggestionsRequest, GetAtSymbolSuggestionsResponse, CurrentFolderFileOrFolder, GetTerminalCompletionRequest, GetTerminalCompletionResponse, HeuristicsSelection, HeuristicsSelection_HeuristicsSelectionType, CalculateAutoSelectionRequest, AutoSelectionInstructions, AutoSelectionResult, CalculateAutoSelectionResponse, BackgroundCmdKRequest, BackgroundCmdKRequest_Type, BackgroundCmdKRequest_Lint, BackgroundCmdKRequest_Lint_QuickFix, BackgroundCmdKRequest_Lint_QuickFix_Edit, BackgroundCmdKRequest_ProposedChange, BackgroundCmdKRequest_UsefulType, BackgroundCmdKRequest_RecentlyViewedFile, BackgroundCmdKRequest_RecentlyViewedFile_VisibleRange, BackgroundCmdKRequest_Diff, BackgroundCmdKResponse, BackgroundCmdKEvalRequest, BackgroundCmdKEvalRequest_Experiment, BackgroundCmdKEvalRequest_Lint, BackgroundCmdKEvalRequest_Lint_QuickFix, BackgroundCmdKEvalRequest_Lint_QuickFix_Edit, BackgroundCmdKEvalRequest_ProposedChange, BackgroundCmdKEvalResponse, GetThoughtAnnotationRequest, UpdateVscodeProfileRequest, UpdateVscodeProfileResponse, GetThoughtAnnotationResponse, AiThoughtAnnotation, BulkEmbedRequest, BulkEmbedResponse, EmbeddingResponse, TakeNotesOnCommitDiffRequest, TakeNotesOnCommitDiffResponse, IsCursorPredictionEnabledRequest, IsCursorPredictionEnabledResponse, StreamNextCursorPredictionRequest, StreamNextCursorPredictionRequest_VisibleRange, StreamNextCursorPredictionRequest_FileVisibleRange, StreamNextCursorPredictionResponse, StreamWebCmdKV1Request, StreamWebCmdKV1Response, ContextScoresRequest, ContextScoresResponse, ReportGenerationFeedbackRequest, ReportGenerationFeedbackRequest_FeedbackType, ReportGenerationFeedbackRequest_Source, ReportGenerationFeedbackResponse, ReportAgentFeedbackRequest, ReportAgentFeedbackRequest_Sentiment, ReportAgentFeedbackRequest_Source, ReportAgentFeedbackRequest_Variant, ReportAgentFeedbackResponse, ReportAgentMessageFeedbackRequest, ReportAgentMessageFeedbackResponse, ReportAutoRoutingResultFeedbackRequest, ReportAutoRoutingResultFeedbackResponse, ShowWelcomeScreenRequest, ShowWelcomeScreenResponse, AiProjectRequest, AiProjectResponse, ToCamelCaseRequest, ToCamelCaseResponse, StreamPriomptPromptRequest, StreamPriomptPromptResponse, CheckFeatureStatusRequest, CheckFeaturesStatusRequest, CheckFeaturesStatusResponse, CheckFeaturesStatusResponse_FeatureStatus, GetEffectiveTokenLimitRequest, GetEffectiveTokenLimitResponse, CheckFeatureStatusResponse, CheckNumberConfigRequest, CheckNumberConfigResponse, CheckNumberConfigsRequest, CheckNumberConfigsResponse, CheckNumberConfigsResponse_Config, IntentPredictionRequest, IntentPredictionResponse, IntentPredictionResponse_ChosenDocumentation, IntentPredictionResponse_ChosenFileContents, IntentPredictionResponse_ChosenLinterDiagnostics, ContextOptions, ContextOptions_AllDocumentation, ContextOptions_AllDocumentation_Documentation, ContextOptions_CurrentFileContents, ContextOptions_LinterDiagnostics, ContextOptions_LinterDiagnostics_Diagnostic, ContextOptions_GlobalContext, StreamCursorTutorRequest, StreamCursorTutorResponse, ModelQueryRequest, ModelQueryRequest_QueryType, ModelQueryResponse, ModelQueryResponse_Query, ModelQueryResponseV2, ModelQueryResponseV2_QueryItem, ApiDetails, FullFileSearchResult, CodeSearchResult, RerankerRequest, RerankerResponse, GenerateTldrRequest, GenerateTldrResponse, TaskStreamChatContextRequest, AdvancedCodebaseContextOptions, TaskStreamChatContextResponse, TaskStreamChatContextResponse_Output, TaskStreamChatContextResponse_GatheringFile, TaskStreamChatContextResponse_GatheringStep, TaskStreamChatContextResponse_RerankingStep, TaskStreamChatContextResponse_RerankingFile, TaskStreamChatContextResponse_ReasoningStep, TaskStreamChatContextResponse_ReasoningSubstep, TaskStreamChatContextResponseWrapped, StreamChatContextRequest, StreamChatContextRequest_CodeContext, StreamChatContextResponse, StreamChatContextResponse_UsedCode, StreamChatContextResponse_CodeLink, StreamChatContextResponse_ChunkIdentity, StreamChatDeepContextRequest, StreamChatDeepContextResponse, DocumentationInfo, AvailableDocsRequest, AvailableDocsResponse, RunWebSearchRequest, WebSearchDocument, RunWebSearchResponse, RunWebFetchRequest, RunWebFetchSuccess, RunWebFetchError, RunWebFetchResponse, GenerateImageReferenceImage, RunGenerateImageRequest, RunGenerateImageSuccess, RunGenerateImageError, RunGenerateImageResponse, RunDescribeImageRequest, RunDescribeImageResponse, DetectShellHangRequest, DetectShellHangResponse, ThrowErrorCheckRequest, ThrowErrorCheckResponse, AvailableModelsRequest, AvailableModelsResponse, AvailableModelsResponse_DegradationStatus, AvailableModelsResponse_ModelVendorId, AvailableModelsResponse_TooltipData, AvailableModelsResponse_ModelVendor, AvailableModelsResponse_ModelPickerBadge, AvailableModelsResponse_ModelPickerBadge_Variant, AvailableModelsResponse_AvailableModel, AvailableModelsResponse_ModelVariantConfig, AvailableModelsResponse_ConfirmationDialogue, AvailableModelsResponse_ConfirmationDialogue_Presentation, AvailableModelsResponse_FeatureModelConfig, AvailableModelsResponse_ModelPickerDisplayConfiguration, AvailableModelsResponse_ModelPickerDisplayConfiguration_RoutedModelViewConfig, AvailableModelsResponse_ModelPickerDisplayConfiguration_RoutedModelViewConfig_RoutedModelViewToNamedViewToggle, AvailableModelsResponse_ModelPickerDisplayConfiguration_RoutedModelViewConfig_RoutedModelViewToNamedViewButton, AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig, AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig_NamedViewToRoutedModelViewToggle, AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig_NamedViewToRoutedModelViewNoButton, AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig_NamedViewToRoutedModelViewButton, ModelParameterDefinition, ModelParameterDefinition_ModelParameterType, ModelParameterDefinition_BooleanParameterDefinition, ModelParameterDefinition_BooleanParameterDefinition_BooleanParameterValue, ModelParameterDefinition_EnumParameterDefinition, ModelParameterDefinition_EnumParameterDefinition_EnumParameterValue, ServerTimeRequest, ServerTimeResponse, HealthCheckRequest, HealthCheckResponse, HealthCheckResponse_Status, PrivacyCheckRequest, PrivacyCheckResponse, TimeLeftHealthCheckResponse, StreamGenerateRequest, ReviewRequest, ReviewChatMessage, ReviewChatMessage_ReviewChatMessageType, ReviewChatRequest, ReviewChatResponse, ReviewBug, ReviewResponse, SlashEditRequest, SlashEditRequest_FastApplyModelType, SlashEditResponse, SlashEditPreviousEdit, SlashEditFollowUpWithPreviousEditsRequest, StreamSlashEditFollowUpWithPreviousEditsResponse, StreamSlashEditFollowUpWithPreviousEditsResponse_Chat, StreamSlashEditFollowUpWithPreviousEditsResponse_EditsToUpdate, StreamFastEditRequest, StreamFastEditResponse, StreamEditRequest, PreloadEditRequest, PreloadEditResponse, StreamAiLintBugRequest, StreamAiLintBugRequest_CodeChunk, StreamAiLintBugRequest_CodeChunkList, StreamAiLintBugRequest_DiscriminatorOptions, StreamAiLintBugResponse, LogUserLintReplyRequest, LogUserLintReplyResponse, LogLinterExplicitUserFeedbackRequest, LogLinterExplicitUserFeedbackRequest_LinterUserFeedback, LogLinterExplicitUserFeedbackResponse, StreamNewRuleRequest, CursorHelpConversationMessage, StreamAiCursorHelpRequest, StreamAiCursorHelpResponse, StreamTerminalAutocompleteRequest, PseudocodeTarget, StreamPseudocodeGeneratorRequest, StreamPseudocodeGeneratorResponse, StreamPseudocodeMapperRequest, StreamPseudocodeMapperResponse, StreamTerminalAutocompleteResponse, DebugInfo, DebugInfo_Variable, DebugInfo_Scope, DebugInfo_CallStackFrame, DebugInfo_Breakpoint, GetChatRequest, PotentialLocsInitialQueriesRequest, PotentialLocsInitialQueriesResponse, PotentialLocsUnderneathRequest, PotentialLocsUnderneathResponse, PotentialLocsRequest, PotentialLocsResponse, GetComposerChatRequest, GetComposerChatRequest_RedDiff, GetComposerChatRequest_RecentEdits, GetComposerChatRequest_RecentEdits_CodeBlockInfo, GetComposerChatRequest_RecentEdits_FileInfo, CheckUsageBasedPriceRequest, CheckUsageBasedPriceResponse, CheckQueuePositionRequest, CheckQueuePositionResponse, CheckQueuePositionResponse_CustomLink, CheckQueuePositionResponse_ModelForSlowPoolNudgeData, IsolatedTreesitterRequest, IsolatedTreesitterResponse, IsolatedTreesitterResponse_TreeSitterPosition, IsolatedTreesitterResponse_TreesitterSymbolNameItem, GetSimplePromptRequest, GetSimplePromptResponse, SuggestQuickActionsRequest, QuickActionCandidate, SuggestQuickActionsResponse, SuggestedQuickAction, GetPassthroughPromptRequest, GetPassthroughPromptResponse, CheckLongFilesFitResponse, GetEvaluationPromptRequest, GetEvaluationPromptRequest_EvaluationPromptType, GetEvaluationPromptRequest_RerankingStrategy, GetEvaluationPromptResponse, GetChatTitleRequest, GetChatTitleResponse, ServerTimingInfo, StreamChatResponse, StreamChatResponse_UsedCode, StreamChatResponse_ChunkIdentity, WarmComposerCacheResponse, WarmChatCacheRequest, WarmChatCacheResponse, SurroundingLines, GetCompletionRequest, GetCompletionResponse, UniqueFileIdentifier, GetUserInfoRequest, UsageData, GetUserInfoResponse, DoThisForMeCheckRequest, DoThisForMeCheckResponse, DoThisForMeCheckResponse_SkipAction, DoThisForMeCheckResponse_EditAction, DoThisForMeCheckResponse_CreateAction, DoThisForMeCheckResponse_RunAction, DoThisForMeRequest, DoThisForMeResponse, DoThisForMeResponse_UpdateStatus, DoThisForMeResponseWrapped, StreamChatToolformerContinueRequest, StreamChatToolformerResponse, StreamChatToolformerResponse_Output, StreamChatToolformerResponse_Thought, StreamChatToolformerResponse_ToolAction, TaskInstruction, TaskInstruction_CodeChunk, TaskUserMessage, TaskUserMessage_CodeChunk, PushAiThoughtRequest, PushAiThoughtRequest_Metadata, PushAiThoughtRequest_Metadata_AcceptedHallucinatedFunctionEvent, PushAiThoughtResponse, CheckDoableAsTaskRequest, CheckDoableAsTaskResponse, InterfaceAgentInitRequest, InterfaceAgentInitResponse, StreamInterfaceAgentStatusRequest, StreamInterfaceAgentStatusResponse, TaskGetInterfaceAgentStatusRequest, TaskGetInterfaceAgentStatusResponse, TaskGetInterfaceAgentStatusResponseWrapped, TaskInitRequest, TaskInitResponse, TaskStreamLogRequest, TaskLogOutput, TaskLogToolAction, TaskLogThought, TaskLogToolResult, TaskLogItem, TaskInfoRequest, TaskPauseRequest, TaskPauseResponse, TaskInfoResponse, TaskStreamLogResponse, TaskStreamLogResponse_InfoUpdate, TaskProvideResultRequest, TaskProvideResultResponse, TaskSendMessageRequest, TaskSendMessageResponse, ReportFeedbackRequest, ReportFeedbackRequest_FeedbackType, ReportFeedbackResponse, LogFile, BugReportScreenshot, BugContext, ReportBugRequest, ReportBugRequest_BugType, ReportBugResponse, FixMarkersRequest, FixMarkersRequest_Marker, FixMarkersRequest_Marker_RelatedInformation, FixMarkersRequest_Marker_ContextRange, FixMarkersRequest_Marker_AncestorTypeDefinition, FixMarkersRequest_Marker_InsertedSymbolType, FixMarkersRequest_Marker_QuickFix, FixMarkersRequest_Marker_QuickFix_Edit, FixMarkersRequest_Marker_ClassInformation, FixMarkersRequest_Marker_ClassInformation_Constructor, FixMarkersRequest_Marker_FunctionSignature, FixMarkersRequest_Marker_FunctionSignature_FunctionParameter, FixMarkersResponse, FixMarkersResponse_Change, StreamLintRequest, ReportGroundTruthCandidateRequest, ReportGroundTruthCandidateResponse, ReportCmdKFateRequest, ReportCmdKFateRequest_Fate, ReportCmdKFateResponse, GetFilesForComposerRequest, GetFilesForComposerResponse, ComposerEnhancerClientMessage, ComposerEnhancerServerMessage, ComposerEnhancerRequest, ComposerEnhancerResponse, ComposerEnhancerToolCall, ComposerEnhancerToolResult, FindBugsRequest, FindBugsResponse, FindBugsResponse_Bug, WriteGitCommitMessageRequest, WriteGitCommitMessageResponse, WriteGitBranchNameRequest, WriteGitBranchNameResponse, KeepComposerCacheWarmRequest, KeepComposerCacheWarmResponse, GetDiffReviewRequest, GetDiffReviewRequest_SimpleFileDiff, GetDiffReviewRequest_SimpleFileDiff_Chunk, StreamDiffReviewResponse, SemanticDiffGroups, SemanticDiffGroup, SemanticDiffReference, StreamDiffReviewByFileResponse, SemanticFileGroups, SemanticFileGroup, CountTokensRequest, ContextItemTokenDetail, CountTokensResponse, GetModelLabelsRequest, GetModelLabelsResponse, GetModelLabelsResponse_ModelLabel, GetLastDefaultModelNudgeRequest, GetLastDefaultModelNudgeResponse, GetDefaultModelNudgeDataRequest, GetDefaultModelNudgeDataRequest_StartupOpportunity, GetDefaultModelNudgeDataResponse, GetDefaultModelNudgeDataResponse_InitialModel, GetDefaultModelNudgeDataResponse_ApplicationOpenModelSwitch, GetDefaultModelRequest, GetDefaultModelResponse, CloudSetupBlockerAction, CloudSetupBlocker, GetCloudSetupBlockersRequest, GetCloudSetupBlockersResponse, TestBedrockCredentialsRequest, TestBedrockCredentialsResponse, CommitLineRange, RangeGroup, FileRangeAnnotations, ReportCommitAiAnalyticsRequest, ReportCommitAiAnalyticsResponse, ReportAiCodeChangeMetricsRequest, AiCodeChange, ReportAiCodeChangeMetricsResponse, ReportProcessMetricsRequest, ProcessMetricsRowRequest, ReportProcessMetricsResponse, ReportProcessMetricsV2Request, ProcessMetricsV2RowRequest, ReportProcessMetricsV2Response, ReportSandProcessMetricsRequest, SandProcessMetricsRowRequest, ReportSandProcessMetricsResponse, ReportClientNumericMetricsRequest, ClientNumericMetric, ReportClientNumericMetricsResponse, PotentiallyGenerateMemoryRequest, PotentiallyGenerateMemoryResponse, KnowledgeBaseAddRequest, KnowledgeBaseAddResponse, KnowledgeBaseRemoveRequest, KnowledgeBaseRemoveResponse, KnowledgeBaseUpdateRequest, KnowledgeBaseUpdateResponse, KnowledgeBaseListRequest, KnowledgeBaseListResponse, KnowledgeBaseListResponse_Item, FetchRelevantKnowledgeForConversationRequest, FetchRelevantKnowledgeForConversationResponse, InferBackgroundComposerScriptsRequest, InferBackgroundComposerScriptsRequest_Command, InferBackgroundComposerScriptsResponse, InferBackgroundComposerScriptsResponse_Terminal, GetBackgroundComposerFeedbackLinkRequest, GetBackgroundComposerFeedbackLinkResponse, ScoredAiCodeMetadata, SttConfig, SttAudioChunk, SttControl, SttControl_Type, SttClientMessage, SttServerMessage, SttServerMessage_Kind, TranscribeAudioRequest, TranscribeAudioResponse, TextToSpeechRequest, TextToSpeechResponse, MintDesktopRealtimeVoiceSecretRequest, MintDesktopRealtimeVoiceSecretResponse;
var init_aiserver_pb = __esm({
  "../packages/proto/dist/generated/aiserver/v1/aiserver_pb.js"() {
    "use strict";
    init_esm();
    init_chat_pb();
    init_tools_pb();
    ...
    init_context_ast_pb();
    init_usage_pb();
    init_interface_agent_pb();
    init_context_pb();
    init_compact();
    __protoPackage130 = "aiserver.v1.";
    __protoMessage3124 = class extends CompactMessage {
      static get runtime() {
    ...
    TaskListItemState = /* @__PURE__ */ enumType(proto3, __protoPackage130, "TaskListItemState", [[0, "UNSPECIFIED"], [1, "ACTIVE"], [2, "PAUSED"], [3, "NEEDS_INPUT"], [4, "DONE"]], 1);
    AvailableModelsScope = /* @__PURE__ */ enumType(proto3, __protoPackage130, "AvailableModelsScope", [[0, "UNSPECIFIED"], [1, "USER_AVAILABLE"], [2, "AUTOMATIONS"], [3, "ADMIN_SETTINGS_ALL_APPLICATION_MODELS"]], 1);
    CloudAgentEffortMode = /* @__PURE__ */ enumType(proto3, __protoPackage130, "CloudAgentEffortMode", [[0, "UNSPECIFIED"], [1, "STANDARD"], [2, "GRIND"]], 1);
    TaskStatus = /* @__PURE__ */ enumType(proto3, __protoPackage130, "TaskStatus", [[0, "UNSPECIFIED"], [1, "RUNNING"], [2, "PAUSED"], [3, "DONE"], [4, "NOT_STARTED"]], 1);
    GetComposerAutocompleteRequest = class _GetComposerAutocompleteRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.inputText = "";
    ...
    GetComposerAutocompleteResponse = class _GetComposerAutocompleteResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.suggestion = "";
        proto3.util.initPartial(data, this);
    ...
    ComposerAutocompleteContext = class _ComposerAutocompleteContext extends __protoMessage3124 {
      constructor(data) {
        super();
        this.cachedFiles = [];
    ...
    CurrentFileContext = class _CurrentFileContext extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativePath = "";
        this.language = "";
    ...
    CachedFileContext = class _CachedFileContext extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativePath = "";
        this.language = "";
    ...
    ChatSuggestionItem = class _ChatSuggestionItem extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        this.reason = "";
    ...
    RecentChat = class _RecentChat extends __protoMessage3124 {
      constructor(data) {
        super();
        this.title = "";
        this.messages = [];
    ...
    RecentChatMessage = class _RecentChatMessage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.role = "";
        this.text = "";
    ...
    GetChatSuggestionsRequest = class _GetChatSuggestionsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.recentChats = [];
        proto3.util.initPartial(data, this);
    ...
    GetChatSuggestionsResponse = class _GetChatSuggestionsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.suggestions = [];
        proto3.util.initPartial(data, this);
    ...
    GetUserInstructionsRequest = class _GetUserInstructionsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.chats = [];
        proto3.util.initPartial(data, this);
    ...
    GetUserInstructionsResponse = class _GetUserInstructionsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    IsTerminalFinishedRequest = class _IsTerminalFinishedRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    IsTerminalFinishedResponseV2 = class _IsTerminalFinishedResponseV2 extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    TestBidiRequest = class _TestBidiRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = "";
        proto3.util.initPartial(data, this);
    ...
    TestBidiResponse = class _TestBidiResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = "";
        proto3.util.initPartial(data, this);
    ...
    AutoContextFile = class _AutoContextFile extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    AutoContextRequest = class _AutoContextRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        this.candidateFiles = [];
    ...
    AutoContextRankedFile = class _AutoContextRankedFile extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
    ...
    AutoContextResponse = class _AutoContextResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.rankedFiles = [];
        proto3.util.initPartial(data, this);
    ...
    CheckBugBotPriceRequest = class _CheckBugBotPriceRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.diffCharLen = 0;
        this.iterations = 0;
    ...
    CheckBugBotPriceResponse = class _CheckBugBotPriceResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.cost = 0;
        this.priceId = "";
    ...
    AcknowledgeGracePeriodDisclaimerRequest = class _AcknowledgeGracePeriodDisclaimerRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    AcknowledgeGracePeriodDisclaimerResponse = class _AcknowledgeGracePeriodDisclaimerResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    CheckBugBotTelemetryHealthyRequest = class _CheckBugBotTelemetryHealthyRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.sessionId = "";
        proto3.util.initPartial(data, this);
    ...
    CheckBugBotTelemetryHealthyResponse = class _CheckBugBotTelemetryHealthyResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    RecordIdeBugReactionRequest = class _RecordIdeBugReactionRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.bugId = "";
        this.reaction = "";
    ...
    RecordIdeBugReactionResponse = class _RecordIdeBugReactionResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.success = false;
        proto3.util.initPartial(data, this);
    ...
    GetSuggestedBugBotIterationsRequest = class _GetSuggestedBugBotIterationsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.diffCharLen = 0;
        proto3.util.initPartial(data, this);
    ...
    GetSuggestedBugBotIterationsResponse = class _GetSuggestedBugBotIterationsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.iterations = 0;
        proto3.util.initPartial(data, this);
    ...
    GetEditorBugbotAutoRunStatusRequest = class _GetEditorBugbotAutoRunStatusRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    GetEditorBugbotAutoRunStatusResponse = class _GetEditorBugbotAutoRunStatusResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    BugBotStatus = class _BugBotStatus extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    BugBotStatus_Status = /* @__PURE__ */ enumType(proto3, __protoPackage130, "BugBotStatus.Status", [[0, "UNSPECIFIED"], [1, "IN_PROGRESS"], [2, "IN_PROGRESS_ITERATIONS"], [3, "DONE"], [4, "ERROR"]], 1);
    BugbotTrialNotification = class _BugbotTrialNotification extends __protoMessage3124 {
      constructor(data) {
        super();
        this.show = false;
        proto3.util.initPartial(data, this);
    ...
    StreamBugBotResponse = class _StreamBugBotResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    StreamBugBotAgenticClientMessage = class _StreamBugBotAgenticClientMessage extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    StreamBugBotAgenticServerMessage = class _StreamBugBotAgenticServerMessage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    UiBestOfNJudgeCandidate = class _UiBestOfNJudgeCandidate extends __protoMessage3124 {
      constructor(data) {
        super();
        this.composerId = "";
        proto3.util.initPartial(data, this);
    ...
    StreamUiBestOfNJudgeStartRequest = class _StreamUiBestOfNJudgeStartRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.task = "";
        this.candidates = [];
    ...
    UiBestOfNJudgeFinalResult = class _UiBestOfNJudgeFinalResult extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    StreamUiBestOfNJudgeClientMessage = class _StreamUiBestOfNJudgeClientMessage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    StreamUiBestOfNJudgeServerMessage = class _StreamUiBestOfNJudgeServerMessage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    ContextRerankingRequest = class _ContextRerankingRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    ContextRerankingResponse = class _ContextRerankingResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    NameTabRequest = class _NameTabRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.messages = [];
    ...
    NameTabResponse = class _NameTabResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
        this.reason = "";
    ...
    TaskListItem = class _TaskListItem extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        this.title = "";
    ...
    KeepTaskListRequest = class _KeepTaskListRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.items = [];
        this.messages = [];
    ...
    TaskListChange = class _TaskListChange extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        this.title = "";
    ...
    KeepTaskListResponse = class _KeepTaskListResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.changes = [];
        proto3.util.initPartial(data, this);
    ...
    TestModelStatusRequest = class _TestModelStatusRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.modelName = "";
        proto3.util.initPartial(data, this);
    ...
    TestModelStatusResponse = class _TestModelStatusResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        this.latency = 0;
    ...
    LlmGatewayModelTestStage = class _LlmGatewayModelTestStage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
        proto3.util.initPartial(data, this);
    ...
    LlmGatewayModelTestInspect = class _LlmGatewayModelTestInspect extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    LlmGatewayModelTestUsage = class _LlmGatewayModelTestUsage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.billed = false;
        proto3.util.initPartial(data, this);
    ...
    LlmGatewayConnectionTesterRequest = class _LlmGatewayConnectionTesterRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.teamId = 0;
        this.modelId = "";
    ...
    LlmGatewayConnectionTesterResponse = class _LlmGatewayConnectionTesterResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.stages = [];
        proto3.util.initPartial(data, this);
    ...
    EvaluatePromptHookRequest = class _EvaluatePromptHookRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.prompt = "";
        proto3.util.initPartial(data, this);
    ...
    EvaluatePromptHookResponse = class _EvaluatePromptHookResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.ok = false;
        proto3.util.initPartial(data, this);
    ...
    TryParseTypeScriptTreeSitterRequest = class _TryParseTypeScriptTreeSitterRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    TryParseTypeScriptTreeSitterResponse = class _TryParseTypeScriptTreeSitterResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    DevOnlyGetPastRequestIdsRequest = class _DevOnlyGetPastRequestIdsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    DevOnlyPastRequest = class _DevOnlyPastRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
        this.dateTime = "";
    ...
    DevOnlyGetPastRequestIdsResponse = class _DevOnlyGetPastRequestIdsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.pastRequests = [];
        this.totalCount = 0;
    ...
    GetCodebaseQuestionsResponse = class _GetCodebaseQuestionsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.questions = [];
        proto3.util.initPartial(data, this);
    ...
    AtSymbolOption = class _AtSymbolOption extends __protoMessage3124 {
      constructor(data) {
        super();
        this.index = 0;
        this.text = "";
    ...
    AtSymbolDependencyInformation = class _AtSymbolDependencyInformation extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
        this.fromFile = "";
    ...
    GetAtSymbolSuggestionsRequest = class _GetAtSymbolSuggestionsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    GetAtSymbolSuggestionsResponse = class _GetAtSymbolSuggestionsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.indices = [];
        this.explanation = "";
    ...
    CurrentFolderFileOrFolder = class _CurrentFolderFileOrFolder extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
        this.isFolder = false;
    ...
    GetTerminalCompletionRequest = class _GetTerminalCompletionRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.currentCommand = "";
        this.commandHistory = [];
    ...
    GetTerminalCompletionResponse = class _GetTerminalCompletionResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.command = "";
        proto3.util.initPartial(data, this);
    ...
    HeuristicsSelection = class _HeuristicsSelection extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    HeuristicsSelection_HeuristicsSelectionType = /* @__PURE__ */ enumType(proto3, __protoPackage130, "HeuristicsSelection.HeuristicsSelectionType", [[0, "UNSPECIFIED"], [1, "GROUP"], [2, "LINE"], [3, "FOLDING"]], 1);
    CalculateAutoSelectionRequest = class _CalculateAutoSelectionRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    AutoSelectionInstructions = class _AutoSelectionInstructions extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        this.startLine = 0;
    ...
    AutoSelectionResult = class _AutoSelectionResult extends __protoMessage3124 {
      constructor(data) {
        super();
        this.startLine = 0;
        this.endLine = 0;
    ...
    CalculateAutoSelectionResponse = class _CalculateAutoSelectionResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.results = [];
        proto3.util.initPartial(data, this);
    ...
    BackgroundCmdKRequest = class _BackgroundCmdKRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.instruction = "";
    ...
    BackgroundCmdKRequest_Type = /* @__PURE__ */ enumType(proto3, __protoPackage130, "BackgroundCmdKRequest.Type", [[0, "UNSPECIFIED"], [1, "REFLECT"], [2, "LOOP_ON_LINTS"], [3, "CHAT_AND_APPLY"], [4, "COALESCE_GENERATIONS"], [5, "CODEBASE_CHUNKS"], [6, "SPEC_AND_APPLY"], [7, "ASK_CODEBASE"], [8, "FINETUNED_INSTRUCTIONS"], [9, "USEFUL_TYPES"], [10, "CHAT_AND_APPLY_UNDERSPECIFIED"]], 1);
    BackgroundCmdKRequest_Lint = class _BackgroundCmdKRequest_Lint extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = "";
        this.severity = "";
    ...
    BackgroundCmdKRequest_Lint_QuickFix = class _BackgroundCmdKRequest_Lint_QuickFix extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = "";
        this.kind = "";
    ...
    BackgroundCmdKRequest_Lint_QuickFix_Edit = class _BackgroundCmdKRequest_Lint_QuickFix_Edit extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.text = "";
    ...
    BackgroundCmdKRequest_ProposedChange = class _BackgroundCmdKRequest_ProposedChange extends __protoMessage3124 {
      constructor(data) {
        super();
        this.change = "";
        this.linterErrors = [];
    ...
    BackgroundCmdKRequest_UsefulType = class _BackgroundCmdKRequest_UsefulType extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.startLine = 0;
    ...
    BackgroundCmdKRequest_RecentlyViewedFile = class _BackgroundCmdKRequest_RecentlyViewedFile extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.contents = "";
    ...
    BackgroundCmdKRequest_RecentlyViewedFile_VisibleRange = class _BackgroundCmdKRequest_RecentlyViewedFile_VisibleRange extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    BackgroundCmdKRequest_Diff = class _BackgroundCmdKRequest_Diff extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.diff = "";
    ...
    BackgroundCmdKResponse = class _BackgroundCmdKResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.proposedChange = "";
        proto3.util.initPartial(data, this);
    ...
    BackgroundCmdKEvalRequest = class _BackgroundCmdKEvalRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.instruction = "";
        this.groundTruth = "";
    ...
    BackgroundCmdKEvalRequest_Experiment = /* @__PURE__ */ enumType(proto3, __protoPackage130, "BackgroundCmdKEvalRequest.Experiment", [[0, "UNSPECIFIED"], [1, "REFLECT"], [2, "CMD_K_ORIGINAL_RADIUS"], [3, "LOOP_ON_LINTS"], [4, "CHAT_AND_APPLY"], [5, "COMMIT_NOTES"], [6, "COALESCE_GENERATIONS"], [7, "REWORD_INSTRUCTIONS"], [8, "CODEBASE_CHUNKS"], [9, "SPEC_AND_APPLY"], [10, "ASK_CODEBASE"]], 1);
    BackgroundCmdKEvalRequest_Lint = class _BackgroundCmdKEvalRequest_Lint extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = "";
        this.severity = "";
    ...
    BackgroundCmdKEvalRequest_Lint_QuickFix = class _BackgroundCmdKEvalRequest_Lint_QuickFix extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = "";
        this.kind = "";
    ...
    BackgroundCmdKEvalRequest_Lint_QuickFix_Edit = class _BackgroundCmdKEvalRequest_Lint_QuickFix_Edit extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.text = "";
    ...
    BackgroundCmdKEvalRequest_ProposedChange = class _BackgroundCmdKEvalRequest_ProposedChange extends __protoMessage3124 {
      constructor(data) {
        super();
        this.change = "";
        this.linterErrors = [];
    ...
    BackgroundCmdKEvalResponse = class _BackgroundCmdKEvalResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.proposedChange = "";
        proto3.util.initPartial(data, this);
    ...
    GetThoughtAnnotationRequest = class _GetThoughtAnnotationRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
        proto3.util.initPartial(data, this);
    ...
    UpdateVscodeProfileRequest = class _UpdateVscodeProfileRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.machineId = "";
    ...
    UpdateVscodeProfileResponse = class _UpdateVscodeProfileResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    GetThoughtAnnotationResponse = class _GetThoughtAnnotationResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    AiThoughtAnnotation = class _AiThoughtAnnotation extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
        this.authId = "";
    ...
    BulkEmbedRequest = class _BulkEmbedRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.texts = [];
        proto3.util.initPartial(data, this);
    ...
    BulkEmbedResponse = class _BulkEmbedResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.embeddings = [];
        proto3.util.initPartial(data, this);
    ...
    EmbeddingResponse = class _EmbeddingResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.embedding = [];
        proto3.util.initPartial(data, this);
    ...
    TakeNotesOnCommitDiffRequest = class _TakeNotesOnCommitDiffRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.commitHash = "";
        proto3.util.initPartial(data, this);
    ...
    TakeNotesOnCommitDiffResponse = class _TakeNotesOnCommitDiffResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.notes = [];
        proto3.util.initPartial(data, this);
    ...
    IsCursorPredictionEnabledRequest = class _IsCursorPredictionEnabledRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    IsCursorPredictionEnabledResponse = class _IsCursorPredictionEnabledResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.enabled = false;
        proto3.util.initPartial(data, this);
    ...
    StreamNextCursorPredictionRequest = class _StreamNextCursorPredictionRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.diffHistory = [];
        this.contextItems = [];
    ...
    StreamNextCursorPredictionRequest_VisibleRange = class _StreamNextCursorPredictionRequest_VisibleRange extends __protoMessage3124 {
      constructor(data) {
        super();
        this.startLineNumberInclusive = 0;
        this.endLineNumberExclusive = 0;
    ...
    StreamNextCursorPredictionRequest_FileVisibleRange = class _StreamNextCursorPredictionRequest_FileVisibleRange extends __protoMessage3124 {
      constructor(data) {
        super();
        this.filename = "";
        this.visibleRanges = [];
    ...
    StreamNextCursorPredictionResponse = class _StreamNextCursorPredictionResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    StreamWebCmdKV1Request = class _StreamWebCmdKV1Request extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.fileContents = "";
    ...
    StreamWebCmdKV1Response = class _StreamWebCmdKV1Response extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ContextScoresRequest = class _ContextScoresRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.sourceRange = "";
    ...
    ContextScoresResponse = class _ContextScoresResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.scores = [];
        proto3.util.initPartial(data, this);
    ...
    ReportGenerationFeedbackRequest = class _ReportGenerationFeedbackRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    ReportGenerationFeedbackRequest_FeedbackType = /* @__PURE__ */ enumType(proto3, __protoPackage130, "ReportGenerationFeedbackRequest.FeedbackType", [[0, "UNSPECIFIED"], [1, "THUMBS_UP"], [2, "THUMBS_DOWN"], [3, "NEUTRAL"], [4, "STARS"]], 1);
    ReportGenerationFeedbackRequest_Source = /* @__PURE__ */ enumType(proto3, __protoPackage130, "ReportGenerationFeedbackRequest.Source", [[0, "UNSPECIFIED"], [1, "INLINE"], [2, "VIBEOMETER"]], 1);
    ReportGenerationFeedbackResponse = class _ReportGenerationFeedbackResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ReportAgentFeedbackRequest = class _ReportAgentFeedbackRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
    ...
    ReportAgentFeedbackRequest_Sentiment = /* @__PURE__ */ enumType(proto3, __protoPackage130, "ReportAgentFeedbackRequest.Sentiment", [[0, "UNSPECIFIED"], [1, "UP"], [2, "DOWN"], [3, "RETRACTED"]], 1);
    ReportAgentFeedbackRequest_Source = /* @__PURE__ */ enumType(proto3, __protoPackage130, "ReportAgentFeedbackRequest.Source", [[0, "UNSPECIFIED"], [1, "IDE"], [2, "GLASS"], [3, "SAND"]], 1);
    ReportAgentFeedbackRequest_Variant = /* @__PURE__ */ enumType(proto3, __protoPackage130, "ReportAgentFeedbackRequest.Variant", [[0, "UNSPECIFIED"], [1, "PROMINENT"], [2, "INLINE"]], 1);
    ReportAgentFeedbackResponse = class _ReportAgentFeedbackResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ReportAgentMessageFeedbackRequest = class _ReportAgentMessageFeedbackRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
        this.bubbleId = "";
    ...
    ReportAgentMessageFeedbackResponse = class _ReportAgentMessageFeedbackResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.s3Uri = "";
        proto3.util.initPartial(data, this);
    ...
    ReportAutoRoutingResultFeedbackRequest = class _ReportAutoRoutingResultFeedbackRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
        this.rating = "";
    ...
    ReportAutoRoutingResultFeedbackResponse = class _ReportAutoRoutingResultFeedbackResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ShowWelcomeScreenRequest = class _ShowWelcomeScreenRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ShowWelcomeScreenResponse = class _ShowWelcomeScreenResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.enableCards = [];
        proto3.util.initPartial(data, this);
    ...
    AiProjectRequest = class _AiProjectRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.description = "";
        proto3.util.initPartial(data, this);
    ...
    AiProjectResponse = class _AiProjectResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    ToCamelCaseRequest = class _ToCamelCaseRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    ToCamelCaseResponse = class _ToCamelCaseResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    StreamPriomptPromptRequest = class _StreamPriomptPromptRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.promptProps = "";
    ...
    StreamPriomptPromptResponse = class _StreamPriomptPromptResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    CheckFeatureStatusRequest = class _CheckFeatureStatusRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.featureName = "";
        proto3.util.initPartial(data, this);
    ...
    CheckFeaturesStatusRequest = class _CheckFeaturesStatusRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.featureNames = [];
        proto3.util.initPartial(data, this);
    ...
    CheckFeaturesStatusResponse = class _CheckFeaturesStatusResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    CheckFeaturesStatusResponse_FeatureStatus = class _CheckFeaturesStatusResponse_FeatureStatus extends __protoMessage3124 {
      constructor(data) {
        super();
        this.featureName = "";
        this.enabled = false;
    ...
    GetEffectiveTokenLimitRequest = class _GetEffectiveTokenLimitRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    GetEffectiveTokenLimitResponse = class _GetEffectiveTokenLimitResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.tokenLimit = 0;
        proto3.util.initPartial(data, this);
    ...
    CheckFeatureStatusResponse = class _CheckFeatureStatusResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.enabled = false;
        proto3.util.initPartial(data, this);
    ...
    CheckNumberConfigRequest = class _CheckNumberConfigRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.key = "";
        proto3.util.initPartial(data, this);
    ...
    CheckNumberConfigResponse = class _CheckNumberConfigResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.value = 0;
        proto3.util.initPartial(data, this);
    ...
    CheckNumberConfigsRequest = class _CheckNumberConfigsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.configNames = [];
        proto3.util.initPartial(data, this);
    ...
    CheckNumberConfigsResponse = class _CheckNumberConfigsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.configs = [];
        proto3.util.initPartial(data, this);
    ...
    CheckNumberConfigsResponse_Config = class _CheckNumberConfigsResponse_Config extends __protoMessage3124 {
      constructor(data) {
        super();
        this.configName = "";
        this.value = 0;
    ...
    IntentPredictionRequest = class _IntentPredictionRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.messages = [];
        proto3.util.initPartial(data, this);
    ...
    IntentPredictionResponse = class _IntentPredictionResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    IntentPredictionResponse_ChosenDocumentation = class _IntentPredictionResponse_ChosenDocumentation extends __protoMessage3124 {
      constructor(data) {
        super();
        this.docIndices = [];
        this.docIdentifiers = [];
    ...
    IntentPredictionResponse_ChosenFileContents = class _IntentPredictionResponse_ChosenFileContents extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    IntentPredictionResponse_ChosenLinterDiagnostics = class _IntentPredictionResponse_ChosenLinterDiagnostics extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    ContextOptions = class _ContextOptions extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ContextOptions_AllDocumentation = class _ContextOptions_AllDocumentation extends __protoMessage3124 {
      constructor(data) {
        super();
        this.availableDocs = [];
        proto3.util.initPartial(data, this);
    ...
    ContextOptions_AllDocumentation_Documentation = class _ContextOptions_AllDocumentation_Documentation extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
        this.url = "";
    ...
    ContextOptions_CurrentFileContents = class _ContextOptions_CurrentFileContents extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.contents = "";
    ...
    ContextOptions_LinterDiagnostics = class _ContextOptions_LinterDiagnostics extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.contents = "";
    ...
    ContextOptions_LinterDiagnostics_Diagnostic = class _ContextOptions_LinterDiagnostics_Diagnostic extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = "";
        this.source = "";
    ...
    ContextOptions_GlobalContext = class _ContextOptions_GlobalContext extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    StreamCursorTutorRequest = class _StreamCursorTutorRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        proto3.util.initPartial(data, this);
    ...
    StreamCursorTutorResponse = class _StreamCursorTutorResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    ModelQueryRequest = class _ModelQueryRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.repositories = [];
    ...
    ModelQueryRequest_QueryType = /* @__PURE__ */ enumType(proto3, __protoPackage130, "ModelQueryRequest.QueryType", [[0, "UNSPECIFIED"], [1, "KEYWORDS"], [2, "EMBEDDINGS"]], 1);
    ModelQueryResponse = class _ModelQueryResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.queries = [];
        proto3.util.initPartial(data, this);
    ...
    ModelQueryResponse_Query = class _ModelQueryResponse_Query extends __protoMessage3124 {
      constructor(data) {
        super();
        this.query = "";
    ...
    ModelQueryResponseV2 = class _ModelQueryResponseV2 extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    ModelQueryResponseV2_QueryItem = class _ModelQueryResponseV2_QueryItem extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    ApiDetails = class _ApiDetails extends __protoMessage3124 {
      constructor(data) {
        super();
        this.apiKey = "";
        proto3.util.initPartial(data, this);
    ...
    FullFileSearchResult = class _FullFileSearchResult extends __protoMessage3124 {
      constructor(data) {
        super();
        this.results = [];
        proto3.util.initPartial(data, this);
    ...
    CodeSearchResult = class _CodeSearchResult extends __protoMessage3124 {
      constructor(data) {
        super();
        this.results = [];
        this.allFiles = [];
    ...
    RerankerRequest = class _RerankerRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.codeResults = [];
        this.query = "";
    ...
    RerankerResponse = class _RerankerResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.results = [];
        proto3.util.initPartial(data, this);
    ...
    GenerateTldrRequest = class _GenerateTldrRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    GenerateTldrResponse = class _GenerateTldrResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.summary = "";
        this.all = "";
    ...
    TaskStreamChatContextRequest = class _TaskStreamChatContextRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.repositories = [];
    ...
    AdvancedCodebaseContextOptions = class _AdvancedCodebaseContextOptions extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    TaskStreamChatContextResponse = class _TaskStreamChatContextResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.response = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    TaskStreamChatContextResponse_Output = class _TaskStreamChatContextResponse_Output extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    TaskStreamChatContextResponse_GatheringFile = class _TaskStreamChatContextResponse_GatheringFile extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.stepIndex = 0;
    ...
    TaskStreamChatContextResponse_GatheringStep = class _TaskStreamChatContextResponse_GatheringStep extends __protoMessage3124 {
      constructor(data) {
        super();
        this.title = "";
        this.index = 0;
    ...
    TaskStreamChatContextResponse_RerankingStep = class _TaskStreamChatContextResponse_RerankingStep extends __protoMessage3124 {
      constructor(data) {
        super();
        this.title = "";
        this.index = 0;
    ...
    TaskStreamChatContextResponse_RerankingFile = class _TaskStreamChatContextResponse_RerankingFile extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.reason = "";
    ...
    TaskStreamChatContextResponse_ReasoningStep = class _TaskStreamChatContextResponse_ReasoningStep extends __protoMessage3124 {
      constructor(data) {
        super();
        this.title = "";
        this.index = 0;
    ...
    TaskStreamChatContextResponse_ReasoningSubstep = class _TaskStreamChatContextResponse_ReasoningSubstep extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    TaskStreamChatContextResponseWrapped = class _TaskStreamChatContextResponseWrapped extends __protoMessage3124 {
      constructor(data) {
        super();
        this.response = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    StreamChatContextRequest = class _StreamChatContextRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.repositories = [];
    ...
    StreamChatContextRequest_CodeContext = class _StreamChatContextRequest_CodeContext extends __protoMessage3124 {
      constructor(data) {
        super();
        this.chunks = [];
        this.scoredChunks = [];
    ...
    StreamChatContextResponse = class _StreamChatContextResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    StreamChatContextResponse_UsedCode = class _StreamChatContextResponse_UsedCode extends __protoMessage3124 {
      constructor(data) {
        super();
        this.codeResults = [];
        proto3.util.initPartial(data, this);
    ...
    StreamChatContextResponse_CodeLink = class _StreamChatContextResponse_CodeLink extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
    ...
    StreamChatContextResponse_ChunkIdentity = class _StreamChatContextResponse_ChunkIdentity extends __protoMessage3124 {
      constructor(data) {
        super();
        this.fileName = "";
        this.startLine = 0;
    ...
    StreamChatDeepContextRequest = class _StreamChatDeepContextRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.rerankResults = false;
    ...
    StreamChatDeepContextResponse = class _StreamChatDeepContextResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    DocumentationInfo = class _DocumentationInfo extends __protoMessage3124 {
      constructor(data) {
        super();
        this.docIdentifier = "";
        proto3.util.initPartial(data, this);
    ...
    AvailableDocsRequest = class _AvailableDocsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    AvailableDocsResponse = class _AvailableDocsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.docs = [];
        proto3.util.initPartial(data, this);
    ...
    RunWebSearchRequest = class _RunWebSearchRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.searchTerm = "";
        this.modelId = "";
    ...
    WebSearchDocument = class _WebSearchDocument extends __protoMessage3124 {
      constructor(data) {
        super();
        this.url = "";
        this.title = "";
    ...
    RunWebSearchResponse = class _RunWebSearchResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.documents = [];
        proto3.util.initPartial(data, this);
    ...
    RunWebFetchRequest = class _RunWebFetchRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.url = "";
        proto3.util.initPartial(data, this);
    ...
    RunWebFetchSuccess = class _RunWebFetchSuccess extends __protoMessage3124 {
      constructor(data) {
        super();
        this.content = "";
        proto3.util.initPartial(data, this);
    ...
    RunWebFetchError = class _RunWebFetchError extends __protoMessage3124 {
      constructor(data) {
        super();
        this.error = "";
    ...
    RunWebFetchResponse = class _RunWebFetchResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    GenerateImageReferenceImage = class _GenerateImageReferenceImage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.data = "";
        this.mimeType = "";
    ...
    RunGenerateImageRequest = class _RunGenerateImageRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.description = "";
    ...
    RunGenerateImageSuccess = class _RunGenerateImageSuccess extends __protoMessage3124 {
      constructor(data) {
        super();
        this.imageData = "";
        this.mimeType = "";
    ...
    RunGenerateImageError = class _RunGenerateImageError extends __protoMessage3124 {
      constructor(data) {
        super();
        this.error = "";
    ...
    RunGenerateImageResponse = class _RunGenerateImageResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.result = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    RunDescribeImageRequest = class _RunDescribeImageRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.imageData = "";
        this.mimeType = "";
    ...
    RunDescribeImageResponse = class _RunDescribeImageResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    DetectShellHangRequest = class _DetectShellHangRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.command = "";
        this.output = "";
    ...
    DetectShellHangResponse = class _DetectShellHangResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.hanging = false;
        proto3.util.initPartial(data, this);
    ...
    ThrowErrorCheckRequest = class _ThrowErrorCheckRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    ThrowErrorCheckResponse = class _ThrowErrorCheckResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    AvailableModelsRequest = class _AvailableModelsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    AvailableModelsResponse = class _AvailableModelsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.models = [];
        this.modelNames = [];
    ...
    AvailableModelsResponse_DegradationStatus = /* @__PURE__ */ enumType(proto3, __protoPackage130, "AvailableModelsResponse.DegradationStatus", [[0, "UNSPECIFIED"], [1, "DEGRADED"], [2, "DISABLED"]], 1);
    AvailableModelsResponse_ModelVendorId = /* @__PURE__ */ enumType(proto3, __protoPackage130, "AvailableModelsResponse.ModelVendorId", [[0, "UNSPECIFIED"], [1, "ANTHROPIC"], [2, "OPENAI"], [3, "GOOGLE"], [4, "XAI"], [5, "MOONSHOT"], [6, "CURSOR"], [7, "NVIDIA"], [8, "ZAI"], [9, "META"], [10, "DEEPSEEK"]], 1);
    AvailableModelsResponse_TooltipData = class _AvailableModelsResponse_TooltipData extends __protoMessage3124 {
      constructor(data) {
        super();
        this.primaryText = "";
        this.secondaryText = "";
    ...
    AvailableModelsResponse_ModelVendor = class _AvailableModelsResponse_ModelVendor extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    AvailableModelsResponse_ModelPickerBadge = class _AvailableModelsResponse_ModelPickerBadge extends __protoMessage3124 {
      constructor(data) {
        super();
        this.label = "";
    ...
    AvailableModelsResponse_ModelPickerBadge_Variant = /* @__PURE__ */ enumType(proto3, __protoPackage130, "AvailableModelsResponse.ModelPickerBadge.Variant", [[0, "UNSPECIFIED"], [1, "ACCENT"], [2, "NEUTRAL"], [3, "SUCCESS"], [4, "WARN"], [5, "DANGER"]], 1);
    AvailableModelsResponse_AvailableModel = class _AvailableModelsResponse_AvailableModel extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
    ...
    AvailableModelsResponse_ModelVariantConfig = class _AvailableModelsResponse_ModelVariantConfig extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    AvailableModelsResponse_ConfirmationDialogue = class _AvailableModelsResponse_ConfirmationDialogue extends __protoMessage3124 {
      constructor(data) {
        super();
        this.title = "";
        this.body = "";
    ...
    AvailableModelsResponse_ConfirmationDialogue_Presentation = /* @__PURE__ */ enumType(proto3, __protoPackage130, "AvailableModelsResponse.ConfirmationDialogue.Presentation", [[0, "UNSPECIFIED"], [1, "POST_PICKER_WARNING"]], 1);
    AvailableModelsResponse_FeatureModelConfig = class _AvailableModelsResponse_FeatureModelConfig extends __protoMessage3124 {
      constructor(data) {
        super();
        this.defaultModel = "";
        this.fallbackModels = [];
    ...
    AvailableModelsResponse_ModelPickerDisplayConfiguration = class _AvailableModelsResponse_ModelPickerDisplayConfiguration extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    AvailableModelsResponse_ModelPickerDisplayConfiguration_RoutedModelViewConfig = class _AvailableModelsResponse_ModelPickerDisplayConfiguration_RoutedModelViewConfig extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    AvailableModelsResponse_ModelPickerDisplayConfiguration_RoutedModelViewConfig_RoutedModelViewToNamedViewToggle = class _AvailableModelsResponse_ModelPickerDisplayConfiguration_RoutedModelViewConfig_RoutedModelViewToNamedViewToggle extends __protoMessage3124 {
      constructor(data) {
        super();
        this.titleMarkdown = "";
        proto3.util.initPartial(data, this);
    ...
    AvailableModelsResponse_ModelPickerDisplayConfiguration_RoutedModelViewConfig_RoutedModelViewToNamedViewButton = class _AvailableModelsResponse_ModelPickerDisplayConfiguration_RoutedModelViewConfig_RoutedModelViewToNamedViewButton extends __protoMessage3124 {
      constructor(data) {
        super();
        this.markdown = "";
        proto3.util.initPartial(data, this);
    ...
    AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig = class _AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig_NamedViewToRoutedModelViewToggle = class _AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig_NamedViewToRoutedModelViewToggle extends __protoMessage3124 {
      constructor(data) {
        super();
        this.markdown = "";
        proto3.util.initPartial(data, this);
    ...
    AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig_NamedViewToRoutedModelViewNoButton = class _AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig_NamedViewToRoutedModelViewNoButton extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig_NamedViewToRoutedModelViewButton = class _AvailableModelsResponse_ModelPickerDisplayConfiguration_NamedModelsViewConfig_NamedViewToRoutedModelViewButton extends __protoMessage3124 {
      constructor(data) {
        super();
        this.markdown = "";
        proto3.util.initPartial(data, this);
    ...
    ModelParameterDefinition = class _ModelParameterDefinition extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        this.name = "";
    ...
    ModelParameterDefinition_ModelParameterType = class _ModelParameterDefinition_ModelParameterType extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ModelParameterDefinition_BooleanParameterDefinition = class _ModelParameterDefinition_BooleanParameterDefinition extends __protoMessage3124 {
      constructor(data) {
        super();
        this.values = [];
        proto3.util.initPartial(data, this);
    ...
    ModelParameterDefinition_BooleanParameterDefinition_BooleanParameterValue = class _ModelParameterDefinition_BooleanParameterDefinition_BooleanParameterValue extends __protoMessage3124 {
      constructor(data) {
        super();
        this.value = "";
        proto3.util.initPartial(data, this);
    ...
    ModelParameterDefinition_EnumParameterDefinition = class _ModelParameterDefinition_EnumParameterDefinition extends __protoMessage3124 {
      constructor(data) {
        super();
        this.values = [];
        proto3.util.initPartial(data, this);
    ...
    ModelParameterDefinition_EnumParameterDefinition_EnumParameterValue = class _ModelParameterDefinition_EnumParameterDefinition_EnumParameterValue extends __protoMessage3124 {
      constructor(data) {
        super();
        this.value = "";
        this.modelPickerBadges = [];
    ...
    ServerTimeRequest = class _ServerTimeRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ServerTimeResponse = class _ServerTimeResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    HealthCheckRequest = class _HealthCheckRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    HealthCheckResponse = class _HealthCheckResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    HealthCheckResponse_Status = /* @__PURE__ */ enumType(proto3, __protoPackage130, "HealthCheckResponse.Status", [[0, "UNSPECIFIED"], [1, "HEALTHY"]], 1);
    PrivacyCheckRequest = class _PrivacyCheckRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    PrivacyCheckResponse = class _PrivacyCheckResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    TimeLeftHealthCheckResponse = class _TimeLeftHealthCheckResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.timeLeft = "";
        proto3.util.initPartial(data, this);
    ...
    StreamGenerateRequest = class _StreamGenerateRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.repositories = [];
    ...
    ReviewRequest = class _ReviewRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.chunk = "";
        this.fileContext = "";
    ...
    ReviewChatMessage = class _ReviewChatMessage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
    ...
    ReviewChatMessage_ReviewChatMessageType = /* @__PURE__ */ enumType(proto3, __protoPackage130, "ReviewChatMessage.ReviewChatMessageType", [[0, "UNSPECIFIED"], [1, "HUMAN"], [2, "AI"]], 1);
    ReviewChatRequest = class _ReviewChatRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.chunk = "";
        this.fileContext = "";
    ...
    ReviewChatResponse = class _ReviewChatResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    ReviewBug = class _ReviewBug extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        proto3.util.initPartial(data, this);
    ...
    ReviewResponse = class _ReviewResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        this.bugs = [];
    ...
    SlashEditRequest = class _SlashEditRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.isCmdI = false;
    ...
    SlashEditPreviousEdit = class _SlashEditPreviousEdit extends __protoMessage3124 {
      constructor(data) {
        super();
        this.originalLines = [];
        this.newLines = [];
    ...
    SlashEditFollowUpWithPreviousEditsRequest = class _SlashEditFollowUpWithPreviousEditsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.previousEdits = [];
    ...
    StreamSlashEditFollowUpWithPreviousEditsResponse = class _StreamSlashEditFollowUpWithPreviousEditsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.response = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    StreamSlashEditFollowUpWithPreviousEditsResponse_Chat = class _StreamSlashEditFollowUpWithPreviousEditsResponse_Chat extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    StreamSlashEditFollowUpWithPreviousEditsResponse_EditsToUpdate = class _StreamSlashEditFollowUpWithPreviousEditsResponse_EditsToUpdate extends __protoMessage3124 {
      constructor(data) {
        super();
        this.previousEdits = [];
        proto3.util.initPartial(data, this);
    ...
    StreamFastEditRequest = class _StreamFastEditRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.repositories = [];
        this.query = "";
    ...
    StreamFastEditResponse = class _StreamFastEditResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.lineNumber = 0;
    ...
    StreamEditRequest = class _StreamEditRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.repositories = [];
    ...
    PreloadEditResponse = class _PreloadEditResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    StreamAiLintBugRequest = class _StreamAiLintBugRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    StreamAiLintBugRequest_CodeChunk = class _StreamAiLintBugRequest_CodeChunk extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.startLineNumber = 0;
    ...
    StreamAiLintBugRequest_CodeChunkList = class _StreamAiLintBugRequest_CodeChunkList extends __protoMessage3124 {
      constructor(data) {
        super();
        this.chunks = [];
    ...
    StreamAiLintBugRequest_DiscriminatorOptions = class _StreamAiLintBugRequest_DiscriminatorOptions extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    StreamAiLintBugResponse = class _StreamAiLintBugResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.response = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    LogUserLintReplyRequest = class _LogUserLintReplyRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.uuid = "";
        this.userAction = "";
    ...
    LogUserLintReplyResponse = class _LogUserLintReplyResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    LogLinterExplicitUserFeedbackRequest = class _LogLinterExplicitUserFeedbackRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    LogLinterExplicitUserFeedbackRequest_LinterUserFeedback = /* @__PURE__ */ enumType(proto3, __protoPackage130, "LogLinterExplicitUserFeedbackRequest.LinterUserFeedback", [[0, "UNSPECIFIED"], [1, "CORRECT"], [2, "INCORRECT"], [3, "OTHER"]], 1);
    LogLinterExplicitUserFeedbackResponse = class _LogLinterExplicitUserFeedbackResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    StreamNewRuleRequest = class _StreamNewRuleRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.currentRules = "";
        this.dismissedBug = "";
    ...
    CursorHelpConversationMessage = class _CursorHelpConversationMessage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        this.role = "";
    ...
    StreamAiCursorHelpRequest = class _StreamAiCursorHelpRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.messages = [];
        this.userOs = "";
    ...
    StreamAiCursorHelpResponse = class _StreamAiCursorHelpResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        this.actions = [];
    ...
    StreamTerminalAutocompleteRequest = class _StreamTerminalAutocompleteRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.currentCommand = "";
        this.commandHistory = [];
    ...
    PseudocodeTarget = class _PseudocodeTarget extends __protoMessage3124 {
      constructor(data) {
        super();
        this.content = "";
        proto3.util.initPartial(data, this);
    ...
    StreamPseudocodeGeneratorRequest = class _StreamPseudocodeGeneratorRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    StreamPseudocodeGeneratorResponse = class _StreamPseudocodeGeneratorResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    StreamPseudocodeMapperRequest = class _StreamPseudocodeMapperRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.pseudocode = "";
        proto3.util.initPartial(data, this);
    ...
    StreamPseudocodeMapperResponse = class _StreamPseudocodeMapperResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    StreamTerminalAutocompleteResponse = class _StreamTerminalAutocompleteResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    DebugInfo = class _DebugInfo extends __protoMessage3124 {
      constructor(data) {
        super();
        this.callStack = [];
        this.history = [];
    ...
    DebugInfo_Variable = class _DebugInfo_Variable extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
        this.value = "";
    ...
    DebugInfo_Scope = class _DebugInfo_Scope extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
        this.variables = [];
    ...
    DebugInfo_CallStackFrame = class _DebugInfo_CallStackFrame extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.lineNumber = 0;
    ...
    DebugInfo_Breakpoint = class _DebugInfo_Breakpoint extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.lineNumber = 0;
    ...
    GetChatRequest = class _GetChatRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.repositories = [];
    ...
    PotentialLocsInitialQueriesRequest = class _PotentialLocsInitialQueriesRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.query = "";
        proto3.util.initPartial(data, this);
    ...
    PotentialLocsInitialQueriesResponse = class _PotentialLocsInitialQueriesResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.hydeQuery = "";
        proto3.util.initPartial(data, this);
    ...
    PotentialLocsUnderneathRequest = class _PotentialLocsUnderneathRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.file = "";
        this.ranges = [];
    ...
    PotentialLocsUnderneathResponse = class _PotentialLocsUnderneathResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    PotentialLocsRequest = class _PotentialLocsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    PotentialLocsResponse = class _PotentialLocsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.potentialLoc = "";
        proto3.util.initPartial(data, this);
    ...
    GetComposerChatRequest = class _GetComposerChatRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.documentationIdentifiers = [];
    ...
    GetComposerChatRequest_RedDiff = class _GetComposerChatRequest_RedDiff extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.redRanges = [];
    ...
    GetComposerChatRequest_RecentEdits = class _GetComposerChatRequest_RecentEdits extends __protoMessage3124 {
      constructor(data) {
        super();
        this.codeBlockInfo = [];
    ...
    GetComposerChatRequest_RecentEdits_CodeBlockInfo = class _GetComposerChatRequest_RecentEdits_CodeBlockInfo extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        proto3.util.initPartial(data, this);
    ...
    GetComposerChatRequest_RecentEdits_FileInfo = class _GetComposerChatRequest_RecentEdits_FileInfo extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.content = "";
    ...
    CheckUsageBasedPriceRequest = class _CheckUsageBasedPriceRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    CheckUsageBasedPriceResponse = class _CheckUsageBasedPriceResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    CheckQueuePositionRequest = class _CheckQueuePositionRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.origRequestId = "";
        this.usageUuid = "";
    ...
    CheckQueuePositionResponse = class _CheckQueuePositionResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.position = 0;
    ...
    CheckQueuePositionResponse_CustomLink = class _CheckQueuePositionResponse_CustomLink extends __protoMessage3124 {
      constructor(data) {
        super();
        this.address = "";
        this.message = "";
    ...
    CheckQueuePositionResponse_ModelForSlowPoolNudgeData = class _CheckQueuePositionResponse_ModelForSlowPoolNudgeData extends __protoMessage3124 {
      constructor(data) {
        super();
        this.model = "";
        this.message = "";
    ...
    IsolatedTreesitterRequest = class _IsolatedTreesitterRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.fileContent = "";
        this.languageId = "";
    ...
    IsolatedTreesitterResponse = class _IsolatedTreesitterResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.items = [];
        proto3.util.initPartial(data, this);
    ...
    IsolatedTreesitterResponse_TreeSitterPosition = class _IsolatedTreesitterResponse_TreeSitterPosition extends __protoMessage3124 {
      constructor(data) {
        super();
        this.row = 0;
        this.column = 0;
    ...
    IsolatedTreesitterResponse_TreesitterSymbolNameItem = class _IsolatedTreesitterResponse_TreesitterSymbolNameItem extends __protoMessage3124 {
      constructor(data) {
        super();
        this.symbolName = "";
        proto3.util.initPartial(data, this);
    ...
    GetSimplePromptRequest = class _GetSimplePromptRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.query = "";
    ...
    GetSimplePromptResponse = class _GetSimplePromptResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.result = "";
        proto3.util.initPartial(data, this);
    ...
    SuggestQuickActionsRequest = class _SuggestQuickActionsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.candidates = [];
    ...
    QuickActionCandidate = class _QuickActionCandidate extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        this.description = "";
    ...
    SuggestQuickActionsResponse = class _SuggestQuickActionsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.suggestions = [];
        proto3.util.initPartial(data, this);
    ...
    SuggestedQuickAction = class _SuggestedQuickAction extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        this.label = "";
    ...
    GetPassthroughPromptRequest = class _GetPassthroughPromptRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.query = "";
        this.modelName = "";
    ...
    GetPassthroughPromptResponse = class _GetPassthroughPromptResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.result = "";
        proto3.util.initPartial(data, this);
    ...
    CheckLongFilesFitResponse = class _CheckLongFilesFitResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.didFit = false;
        proto3.util.initPartial(data, this);
    ...
    GetEvaluationPromptRequest = class _GetEvaluationPromptRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    GetEvaluationPromptRequest_EvaluationPromptType = /* @__PURE__ */ enumType(proto3, __protoPackage130, "GetEvaluationPromptRequest.EvaluationPromptType", [[0, "UNSPECIFIED"], [1, "GENERATE"], [2, "CHAT"]], 1);
    GetEvaluationPromptRequest_RerankingStrategy = /* @__PURE__ */ enumType(proto3, __protoPackage130, "GetEvaluationPromptRequest.RerankingStrategy", [[0, "UNSPECIFIED"], [1, "DISTANCE_ONLY"], [2, "GPT4_RELEVANCE"]], 1);
    GetEvaluationPromptResponse = class _GetEvaluationPromptResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.prompt = "";
        this.tokenCount = 0;
    ...
    GetChatTitleRequest = class _GetChatTitleRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        proto3.util.initPartial(data, this);
    ...
    GetChatTitleResponse = class _GetChatTitleResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.title = "";
        proto3.util.initPartial(data, this);
    ...
    ServerTimingInfo = class _ServerTimingInfo extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    StreamChatResponse = class _StreamChatResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    StreamChatResponse_UsedCode = class _StreamChatResponse_UsedCode extends __protoMessage3124 {
      constructor(data) {
        super();
        this.codeResults = [];
        proto3.util.initPartial(data, this);
    ...
    StreamChatResponse_ChunkIdentity = class _StreamChatResponse_ChunkIdentity extends __protoMessage3124 {
      constructor(data) {
        super();
        this.fileName = "";
        this.startLine = 0;
    ...
    WarmComposerCacheResponse = class _WarmComposerCacheResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    WarmChatCacheRequest = class _WarmChatCacheRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    WarmChatCacheResponse = class _WarmChatCacheResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.didWarmCache = false;
        proto3.util.initPartial(data, this);
    ...
    SurroundingLines = class _SurroundingLines extends __protoMessage3124 {
      constructor(data) {
        super();
        this.startLine = 0;
        this.lines = [];
    ...
    GetCompletionRequest = class _GetCompletionRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    GetCompletionResponse = class _GetCompletionResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.completion = "";
        this.score = 0;
    ...
    UniqueFileIdentifier = class _UniqueFileIdentifier extends __protoMessage3124 {
      constructor(data) {
        super();
        this.projectUuid = "";
        this.relativePath = "";
    ...
    GetUserInfoRequest = class _GetUserInfoRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    UsageData = class _UsageData extends __protoMessage3124 {
      constructor(data) {
        super();
        this.gpt4Requests = 0;
    ...
    GetUserInfoResponse = class _GetUserInfoResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.userId = "";
        this.jupyterToken = "";
    ...
    DoThisForMeCheckRequest = class _DoThisForMeCheckRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.generationUuid = "";
        this.completion = "";
    ...
    DoThisForMeCheckResponse = class _DoThisForMeCheckResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    DoThisForMeCheckResponse_SkipAction = class _DoThisForMeCheckResponse_SkipAction extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    DoThisForMeCheckResponse_EditAction = class _DoThisForMeCheckResponse_EditAction extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        proto3.util.initPartial(data, this);
    ...
    DoThisForMeCheckResponse_CreateAction = class _DoThisForMeCheckResponse_CreateAction extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        proto3.util.initPartial(data, this);
    ...
    DoThisForMeCheckResponse_RunAction = class _DoThisForMeCheckResponse_RunAction extends __protoMessage3124 {
      constructor(data) {
        super();
        this.command = "";
        proto3.util.initPartial(data, this);
    ...
    DoThisForMeRequest = class _DoThisForMeRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.generationUuid = "";
        this.completion = "";
    ...
    DoThisForMeResponse = class _DoThisForMeResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    DoThisForMeResponse_UpdateStatus = class _DoThisForMeResponse_UpdateStatus extends __protoMessage3124 {
      constructor(data) {
        super();
        this.status = "";
        proto3.util.initPartial(data, this);
    ...
    DoThisForMeResponseWrapped = class _DoThisForMeResponseWrapped extends __protoMessage3124 {
      constructor(data) {
        super();
        this.response = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    StreamChatToolformerContinueRequest = class _StreamChatToolformerContinueRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    StreamChatToolformerResponse = class _StreamChatToolformerResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    StreamChatToolformerResponse_Output = class _StreamChatToolformerResponse_Output extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    StreamChatToolformerResponse_Thought = class _StreamChatToolformerResponse_Thought extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    StreamChatToolformerResponse_ToolAction = class _StreamChatToolformerResponse_ToolAction extends __protoMessage3124 {
      constructor(data) {
        super();
        this.userFacingText = "";
        this.rawModelOutput = "";
    ...
    TaskInstruction = class _TaskInstruction extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
    ...
    TaskInstruction_CodeChunk = class _TaskInstruction_CodeChunk extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.startLineNumber = 0;
    ...
    TaskUserMessage = class _TaskUserMessage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        this.attachedCodeChunks = [];
    ...
    TaskUserMessage_CodeChunk = class _TaskUserMessage_CodeChunk extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.startLineNumber = 0;
    ...
    PushAiThoughtRequest = class _PushAiThoughtRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.thought = "";
    ...
    PushAiThoughtRequest_Metadata = class _PushAiThoughtRequest_Metadata extends __protoMessage3124 {
      constructor(data) {
        super();
        this.event = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    PushAiThoughtRequest_Metadata_AcceptedHallucinatedFunctionEvent = class _PushAiThoughtRequest_Metadata_AcceptedHallucinatedFunctionEvent extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    PushAiThoughtResponse = class _PushAiThoughtResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    CheckDoableAsTaskRequest = class _CheckDoableAsTaskRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.modelOutput = "";
        proto3.util.initPartial(data, this);
    ...
    CheckDoableAsTaskResponse = class _CheckDoableAsTaskResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    InterfaceAgentInitRequest = class _InterfaceAgentInitRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    InterfaceAgentInitResponse = class _InterfaceAgentInitResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.taskUuid = "";
    ...
    StreamInterfaceAgentStatusRequest = class _StreamInterfaceAgentStatusRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.taskUuid = "";
        proto3.util.initPartial(data, this);
    ...
    StreamInterfaceAgentStatusResponse = class _StreamInterfaceAgentStatusResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    TaskGetInterfaceAgentStatusRequest = class _TaskGetInterfaceAgentStatusRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    TaskGetInterfaceAgentStatusResponse = class _TaskGetInterfaceAgentStatusResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    TaskGetInterfaceAgentStatusResponseWrapped = class _TaskGetInterfaceAgentStatusResponseWrapped extends __protoMessage3124 {
      constructor(data) {
        super();
        this.response = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    TaskInitRequest = class _TaskInitRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.debuggingOnlyLiveMode = false;
        proto3.util.initPartial(data, this);
    ...
    TaskInitResponse = class _TaskInitResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.taskUuid = "";
        this.humanReadableTitle = "";
    ...
    TaskStreamLogRequest = class _TaskStreamLogRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.taskUuid = "";
    ...
    TaskLogOutput = class _TaskLogOutput extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    TaskLogToolAction = class _TaskLogToolAction extends __protoMessage3124 {
      constructor(data) {
        super();
        this.userFacingText = "";
        this.rawModelOutput = "";
    ...
    TaskLogThought = class _TaskLogThought extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    TaskLogToolResult = class _TaskLogToolResult extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    TaskLogItem = class _TaskLogItem extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    TaskInfoRequest = class _TaskInfoRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.taskUuid = "";
        proto3.util.initPartial(data, this);
    ...
    TaskPauseRequest = class _TaskPauseRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.taskUuid = "";
        proto3.util.initPartial(data, this);
    ...
    TaskPauseResponse = class _TaskPauseResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    TaskInfoResponse = class _TaskInfoResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.humanReadableTitle = "";
    ...
    TaskStreamLogResponse = class _TaskStreamLogResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.response = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    TaskStreamLogResponse_InfoUpdate = class _TaskStreamLogResponse_InfoUpdate extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    TaskProvideResultRequest = class _TaskProvideResultRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.taskUuid = "";
        this.actionSequenceNumber = 0;
    ...
    TaskProvideResultResponse = class _TaskProvideResultResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    TaskSendMessageRequest = class _TaskSendMessageRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.taskUuid = "";
    ...
    TaskSendMessageResponse = class _TaskSendMessageResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ReportFeedbackRequest = class _ReportFeedbackRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.feedback = "";
    ...
    ReportFeedbackRequest_FeedbackType = /* @__PURE__ */ enumType(proto3, __protoPackage130, "ReportFeedbackRequest.FeedbackType", [[0, "UNSPECIFIED"], [1, "LOW_PRIORITY"], [2, "HIGH_PRIORITY"]], 1);
    ReportFeedbackResponse = class _ReportFeedbackResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    LogFile = class _LogFile extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    BugReportScreenshot = class _BugReportScreenshot extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    BugContext = class _BugContext extends __protoMessage3124 {
      constructor(data) {
        super();
        this.screenshots = [];
        this.conversation = [];
    ...
    ReportBugRequest = class _ReportBugRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.bug = "";
    ...
    ReportBugRequest_BugType = /* @__PURE__ */ enumType(proto3, __protoPackage130, "ReportBugRequest.BugType", [[0, "UNSPECIFIED"], [1, "LOW"], [2, "MEDIUM"], [3, "URGENT"], [4, "CRASH"], [5, "CONNECTION_ERROR"], [6, "IDEA"], [7, "MISC_AUTOMATIC_ERROR"]], 1);
    ReportBugResponse = class _ReportBugResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    FixMarkersRequest = class _FixMarkersRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.markers = [];
    ...
    FixMarkersRequest_Marker = class _FixMarkersRequest_Marker extends __protoMessage3124 {
      constructor(data) {
        super();
        this.lines = [];
        this.startLine = 0;
    ...
    FixMarkersRequest_Marker_RelatedInformation = class _FixMarkersRequest_Marker_RelatedInformation extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = "";
        this.relativeWorkspacePath = "";
    ...
    FixMarkersRequest_Marker_ContextRange = class _FixMarkersRequest_Marker_ContextRange extends __protoMessage3124 {
      constructor(data) {
        super();
        this.startLine = 0;
        this.endLineInclusive = 0;
    ...
    FixMarkersRequest_Marker_AncestorTypeDefinition = class _FixMarkersRequest_Marker_AncestorTypeDefinition extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
        this.relativeWorkspacePath = "";
    ...
    FixMarkersRequest_Marker_InsertedSymbolType = class _FixMarkersRequest_Marker_InsertedSymbolType extends __protoMessage3124 {
      constructor(data) {
        super();
        this.symbolName = "";
        this.symbolType = "";
    ...
    FixMarkersRequest_Marker_QuickFix = class _FixMarkersRequest_Marker_QuickFix extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = "";
        this.kind = "";
    ...
    FixMarkersRequest_Marker_QuickFix_Edit = class _FixMarkersRequest_Marker_QuickFix_Edit extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.startLine = 0;
    ...
    FixMarkersRequest_Marker_ClassInformation = class _FixMarkersRequest_Marker_ClassInformation extends __protoMessage3124 {
      constructor(data) {
        super();
        this.className = "";
        this.startLine = 0;
    ...
    FixMarkersRequest_Marker_ClassInformation_Constructor = class _FixMarkersRequest_Marker_ClassInformation_Constructor extends __protoMessage3124 {
      constructor(data) {
        super();
        this.startLine = 0;
        this.endLineInclusive = 0;
    ...
    FixMarkersRequest_Marker_FunctionSignature = class _FixMarkersRequest_Marker_FunctionSignature extends __protoMessage3124 {
      constructor(data) {
        super();
        this.label = "";
        this.documentation = "";
    ...
    FixMarkersRequest_Marker_FunctionSignature_FunctionParameter = class _FixMarkersRequest_Marker_FunctionSignature_FunctionParameter extends __protoMessage3124 {
      constructor(data) {
        super();
        this.label = "";
        this.documentation = "";
    ...
    FixMarkersResponse = class _FixMarkersResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.changes = [];
    ...
    FixMarkersResponse_Change = class _FixMarkersResponse_Change extends __protoMessage3124 {
      constructor(data) {
        super();
        this.startLine = 0;
    ...
    StreamLintRequest = class _StreamLintRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.repositories = [];
    ...
    ReportGroundTruthCandidateRequest = class _ReportGroundTruthCandidateRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
    ...
    ReportGroundTruthCandidateResponse = class _ReportGroundTruthCandidateResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ReportCmdKFateRequest = class _ReportCmdKFateRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
    ...
    ReportCmdKFateRequest_Fate = /* @__PURE__ */ enumType(proto3, __protoPackage130, "ReportCmdKFateRequest.Fate", [[0, "UNSPECIFIED"], [1, "CANCELLED"], [2, "ACCEPTED"], [3, "REJECTED"], [4, "FOLLOWED_UP"], [5, "REPROMPTED"]], 1);
    ReportCmdKFateResponse = class _ReportCmdKFateResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    GetFilesForComposerRequest = class _GetFilesForComposerRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.conversation = [];
        this.files = [];
    ...
    GetFilesForComposerResponse = class _GetFilesForComposerResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    ComposerEnhancerClientMessage = class _ComposerEnhancerClientMessage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    ComposerEnhancerServerMessage = class _ComposerEnhancerServerMessage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.message = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    ComposerEnhancerRequest = class _ComposerEnhancerRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.inputText = "";
        proto3.util.initPartial(data, this);
    ...
    ComposerEnhancerResponse = class _ComposerEnhancerResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.improvedText = "";
        this.isFinal = false;
    ...
    ComposerEnhancerToolCall = class _ComposerEnhancerToolCall extends __protoMessage3124 {
      constructor(data) {
        super();
        this.toolCallId = "";
        this.toolName = "";
    ...
    ComposerEnhancerToolResult = class _ComposerEnhancerToolResult extends __protoMessage3124 {
      constructor(data) {
        super();
        this.toolCallId = "";
        this.result = "";
    ...
    FindBugsRequest = class _FindBugsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    FindBugsResponse = class _FindBugsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    FindBugsResponse_Bug = class _FindBugsResponse_Bug extends __protoMessage3124 {
      constructor(data) {
        super();
        this.description = "";
        this.lineNumber = 0;
    ...
    WriteGitCommitMessageRequest = class _WriteGitCommitMessageRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.diffs = [];
    ...
    WriteGitCommitMessageResponse = class _WriteGitCommitMessageResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.commitMessage = "";
        proto3.util.initPartial(data, this);
    ...
    WriteGitBranchNameRequest = class _WriteGitBranchNameRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.diffs = "";
        this.credentials = { case: void 0 };
    ...
    WriteGitBranchNameResponse = class _WriteGitBranchNameResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.branchName = "";
        proto3.util.initPartial(data, this);
    ...
    KeepComposerCacheWarmRequest = class _KeepComposerCacheWarmRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
    ...
    KeepComposerCacheWarmResponse = class _KeepComposerCacheWarmResponse extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    GetDiffReviewRequest = class _GetDiffReviewRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.diffs = [];
        proto3.util.initPartial(data, this);
    ...
    GetDiffReviewRequest_SimpleFileDiff = class _GetDiffReviewRequest_SimpleFileDiff extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.chunks = [];
    ...
    GetDiffReviewRequest_SimpleFileDiff_Chunk = class _GetDiffReviewRequest_SimpleFileDiff_Chunk extends __protoMessage3124 {
      constructor(data) {
        super();
        this.oldLines = [];
        this.newLines = [];
    ...
    StreamDiffReviewResponse = class _StreamDiffReviewResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.response = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    SemanticDiffGroups = class _SemanticDiffGroups extends __protoMessage3124 {
      constructor(data) {
        super();
        this.groups = [];
        proto3.util.initPartial(data, this);
    ...
    SemanticDiffGroup = class _SemanticDiffGroup extends __protoMessage3124 {
      constructor(data) {
        super();
        this.description = "";
        this.diffs = [];
    ...
    SemanticDiffReference = class _SemanticDiffReference extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.chunkIndex = 0;
    ...
    StreamDiffReviewByFileResponse = class _StreamDiffReviewByFileResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.response = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    SemanticFileGroups = class _SemanticFileGroups extends __protoMessage3124 {
      constructor(data) {
        super();
        this.groups = [];
        proto3.util.initPartial(data, this);
    ...
    SemanticFileGroup = class _SemanticFileGroup extends __protoMessage3124 {
      constructor(data) {
        super();
        this.title = "";
        this.description = "";
    ...
    CountTokensRequest = class _CountTokensRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.contextItems = [];
        this.modelName = "";
    ...
    ContextItemTokenDetail = class _ContextItemTokenDetail extends __protoMessage3124 {
      constructor(data) {
        super();
        this.relativeWorkspacePath = "";
        this.count = 0;
    ...
    CountTokensResponse = class _CountTokensResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.count = 0;
        this.tokenDetails = [];
    ...
    GetModelLabelsRequest = class _GetModelLabelsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    GetModelLabelsResponse = class _GetModelLabelsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.modelLabels = [];
        proto3.util.initPartial(data, this);
    ...
    GetModelLabelsResponse_ModelLabel = class _GetModelLabelsResponse_ModelLabel extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
        this.label = "";
    ...
    GetLastDefaultModelNudgeRequest = class _GetLastDefaultModelNudgeRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    GetLastDefaultModelNudgeResponse = class _GetLastDefaultModelNudgeResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.nudgeDate = "";
        proto3.util.initPartial(data, this);
    ...
    GetDefaultModelNudgeDataRequest = class _GetDefaultModelNudgeDataRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    GetDefaultModelNudgeDataRequest_StartupOpportunity = /* @__PURE__ */ enumType(proto3, __protoPackage130, "GetDefaultModelNudgeDataRequest.StartupOpportunity", [[0, "UNSPECIFIED"], [1, "FIRST_OPEN"], [2, "REOPEN"]], 1);
    GetDefaultModelNudgeDataResponse = class _GetDefaultModelNudgeDataResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.nudgeDate = "";
    ...
    GetDefaultModelNudgeDataResponse_InitialModel = class _GetDefaultModelNudgeDataResponse_InitialModel extends __protoMessage3124 {
      constructor(data) {
        super();
        this.modelId = "";
        this.parameters = [];
    ...
    GetDefaultModelNudgeDataResponse_ApplicationOpenModelSwitch = class _GetDefaultModelNudgeDataResponse_ApplicationOpenModelSwitch extends __protoMessage3124 {
      constructor(data) {
        super();
        this.nudgeId = "";
        this.experimentName = "";
    ...
    GetDefaultModelRequest = class _GetDefaultModelRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    GetDefaultModelResponse = class _GetDefaultModelResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.model = "";
        this.thinkingModel = "";
    ...
    CloudSetupBlockerAction = class _CloudSetupBlockerAction extends __protoMessage3124 {
      constructor(data) {
        super();
        this.action = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    CloudSetupBlocker = class _CloudSetupBlocker extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        this.icon = "";
    ...
    GetCloudSetupBlockersRequest = class _GetCloudSetupBlockersRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    GetCloudSetupBlockersResponse = class _GetCloudSetupBlockersResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.pending = [];
        this.completed = [];
    ...
    TestBedrockCredentialsRequest = class _TestBedrockCredentialsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.accessKey = "";
        this.secretKey = "";
    ...
    TestBedrockCredentialsResponse = class _TestBedrockCredentialsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.success = false;
        proto3.util.initPartial(data, this);
    ...
    CommitLineRange = class _CommitLineRange extends __protoMessage3124 {
      constructor(data) {
        super();
        this.start = 0;
        this.end = 0;
    ...
    RangeGroup = class _RangeGroup extends __protoMessage3124 {
      constructor(data) {
        super();
        this.operationType = "";
        this.ranges = [];
    ...
    FileRangeAnnotations = class _FileRangeAnnotations extends __protoMessage3124 {
      constructor(data) {
        super();
        this.filePath = "";
        this.groups = [];
    ...
    ReportCommitAiAnalyticsRequest = class _ReportCommitAiAnalyticsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.commitHash = "";
    ...
    ReportCommitAiAnalyticsResponse = class _ReportCommitAiAnalyticsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ReportAiCodeChangeMetricsRequest = class _ReportAiCodeChangeMetricsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.changes = [];
        proto3.util.initPartial(data, this);
    ...
    AiCodeChange = class _AiCodeChange extends __protoMessage3124 {
      constructor(data) {
        super();
        this.changeId = "";
        this.source = "";
    ...
    ReportAiCodeChangeMetricsResponse = class _ReportAiCodeChangeMetricsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ReportProcessMetricsRequest = class _ReportProcessMetricsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    ProcessMetricsRowRequest = class _ProcessMetricsRowRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.pid = 0;
        this.ppid = 0;
    ...
    ReportProcessMetricsResponse = class _ReportProcessMetricsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ReportProcessMetricsV2Request = class _ReportProcessMetricsV2Request extends __protoMessage3124 {
      constructor(data) {
        super();
        this.sampleStart = protoInt64.zero;
        this.sampleEnd = protoInt64.zero;
    ...
    ProcessMetricsV2RowRequest = class _ProcessMetricsV2RowRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.pid = 0;
        this.ppid = 0;
    ...
    ReportProcessMetricsV2Response = class _ReportProcessMetricsV2Response extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ReportSandProcessMetricsRequest = class _ReportSandProcessMetricsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.sampleStart = protoInt64.zero;
        this.sampleEnd = protoInt64.zero;
    ...
    SandProcessMetricsRowRequest = class _SandProcessMetricsRowRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.pid = 0;
        this.ppid = 0;
    ...
    ReportSandProcessMetricsResponse = class _ReportSandProcessMetricsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ReportClientNumericMetricsRequest = class _ReportClientNumericMetricsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.metrics = [];
        proto3.util.initPartial(data, this);
    ...
    ClientNumericMetric = class _ClientNumericMetric extends __protoMessage3124 {
      constructor(data) {
        super();
        this.metric = "";
        this.value = 0;
    ...
    ReportClientNumericMetricsResponse = class _ReportClientNumericMetricsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    PotentiallyGenerateMemoryRequest = class _PotentiallyGenerateMemoryRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
        this.conversation = [];
    ...
    PotentiallyGenerateMemoryResponse = class _PotentiallyGenerateMemoryResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    KnowledgeBaseAddRequest = class _KnowledgeBaseAddRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.knowledge = "";
        this.title = "";
    ...
    KnowledgeBaseAddResponse = class _KnowledgeBaseAddResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.success = false;
        this.id = "";
    ...
    KnowledgeBaseRemoveRequest = class _KnowledgeBaseRemoveRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        proto3.util.initPartial(data, this);
    ...
    KnowledgeBaseRemoveResponse = class _KnowledgeBaseRemoveResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.success = false;
        proto3.util.initPartial(data, this);
    ...
    KnowledgeBaseUpdateRequest = class _KnowledgeBaseUpdateRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        this.knowledge = "";
    ...
    KnowledgeBaseUpdateResponse = class _KnowledgeBaseUpdateResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.success = false;
        proto3.util.initPartial(data, this);
    ...
    KnowledgeBaseListRequest = class _KnowledgeBaseListRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    KnowledgeBaseListResponse = class _KnowledgeBaseListResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.success = false;
        this.allResults = [];
    ...
    KnowledgeBaseListResponse_Item = class _KnowledgeBaseListResponse_Item extends __protoMessage3124 {
      constructor(data) {
        super();
        this.id = "";
        this.knowledge = "";
    ...
    FetchRelevantKnowledgeForConversationRequest = class _FetchRelevantKnowledgeForConversationRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.requestId = "";
        this.conversation = [];
    ...
    FetchRelevantKnowledgeForConversationResponse = class _FetchRelevantKnowledgeForConversationResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.knowledgeItems = [];
        proto3.util.initPartial(data, this);
    ...
    InferBackgroundComposerScriptsRequest = class _InferBackgroundComposerScriptsRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.commands = [];
        proto3.util.initPartial(data, this);
    ...
    InferBackgroundComposerScriptsRequest_Command = class _InferBackgroundComposerScriptsRequest_Command extends __protoMessage3124 {
      constructor(data) {
        super();
        this.command = "";
        this.timestamp = 0;
    ...
    InferBackgroundComposerScriptsResponse = class _InferBackgroundComposerScriptsResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.installScript = "";
        this.startScript = "";
    ...
    InferBackgroundComposerScriptsResponse_Terminal = class _InferBackgroundComposerScriptsResponse_Terminal extends __protoMessage3124 {
      constructor(data) {
        super();
        this.name = "";
        this.command = "";
    ...
    GetBackgroundComposerFeedbackLinkRequest = class _GetBackgroundComposerFeedbackLinkRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    GetBackgroundComposerFeedbackLinkResponse = class _GetBackgroundComposerFeedbackLinkResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.url = "";
        proto3.util.initPartial(data, this);
    ...
    ScoredAiCodeMetadata = class _ScoredAiCodeMetadata extends __protoMessage3124 {
      constructor(data) {
        super();
        this.fileExtension = "";
        this.linesAdded = 0;
    ...
    SttConfig = class _SttConfig extends __protoMessage3124 {
      constructor(data) {
        super();
        this.keyterms = [];
        proto3.util.initPartial(data, this);
    ...
    SttAudioChunk = class _SttAudioChunk extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    SttControl = class _SttControl extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    SttControl_Type = /* @__PURE__ */ enumType(proto3, __protoPackage130, "SttControl.Type", [[0, "UNSPECIFIED"], [1, "STOP"], [2, "CANCEL"]], 1);
    SttClientMessage = class _SttClientMessage extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    SttServerMessage = class _SttServerMessage extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        this.isFinal = false;
    ...
    SttServerMessage_Kind = /* @__PURE__ */ enumType(proto3, __protoPackage130, "SttServerMessage.Kind", [[0, "UNSPECIFIED"], [1, "PARTIAL"], [2, "SEGMENT"], [3, "FINAL"]], 1);
    TranscribeAudioRequest = class _TranscribeAudioRequest extends __protoMessage3124 {
      constructor(data) {
        super();
    ...
    TranscribeAudioResponse = class _TranscribeAudioResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
    ...
    TextToSpeechRequest = class _TextToSpeechRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    TextToSpeechResponse = class _TextToSpeechResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.audio = new Uint8Array(0);
        this.mimeType = "";
    ...
    MintDesktopRealtimeVoiceSecretRequest = class _MintDesktopRealtimeVoiceSecretRequest extends __protoMessage3124 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    MintDesktopRealtimeVoiceSecretResponse = class _MintDesktopRealtimeVoiceSecretResponse extends __protoMessage3124 {
      constructor(data) {
        super();
        this.clientSecret = "";
        this.model = "";
