...
var init_mcp_exec_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/mcp_exec_pb.js"() {
    ...
    McpResult = class _McpResult extends __protoMessage329 {
      constructor(data) {
        super();
    ...
    McpApproved = class _McpApproved extends __protoMessage329 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    McpToolNotFound = class _McpToolNotFound extends __protoMessage329 {
      constructor(data) {
        super();
        this.name = "";
        this.availableTools = [];
    ...
    McpServerNotFound = class _McpServerNotFound extends __protoMessage329 {
      constructor(data) {
        super();
        this.name = "";
    ...
    McpTextContent = class _McpTextContent extends __protoMessage329 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    McpImageContent = class _McpImageContent extends __protoMessage329 {
      constructor(data) {
        super();
    ...
    McpToolResultContentItem = class _McpToolResultContentItem extends __protoMessage329 {
      constructor(data) {
        super();
    ...
    McpSuccess = class _McpSuccess extends __protoMessage329 {
      constructor(data) {
        super();
        this.content = [];
        this.isError = false;
    ...
    McpError = class _McpError extends __protoMessage329 {
      constructor(data) {
        super();
        this.error = "";
        proto3.util.initPartial(data, this);
    ...
    McpRejected = class _McpRejected extends __protoMessage329 {
      constructor(data) {
        super();
        this.reason = "";
    ...
    McpPermissionDenied = class _McpPermissionDenied extends __protoMessage329 {
      constructor(data) {
        super();
        this.error = "";
        this.isReadonly = false;
    ...
    McpStateExecArgs = class _McpStateExecArgs extends __protoMessage329 {
      constructor(data) {
        super();
    ...
    McpStateExecResult = class _McpStateExecResult extends __protoMessage329 {
      constructor(data) {
        super();
        this.result = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    McpStateServer = class _McpStateServer extends __protoMessage329 {
      constructor(data) {
        super();
        this.serverName = "";
        this.serverIdentifier = "";
    ...
    McpStateSuccess = class _McpStateSuccess extends __protoMessage329 {
      constructor(data) {
        super();
        this.servers = [];
        proto3.util.initPartial(data, this);
    ...
    McpStateError = class _McpStateError extends __protoMessage329 {
      constructor(data) {
        super();
        this.error = "";
        proto3.util.initPartial(data, this);
    ...
    McpStateRejected = class _McpStateRejected extends __protoMessage329 {
      constructor(data) {
        super();
        this.reason = "";
        proto3.util.initPartial(data, this);
    ...
    ListMcpResourcesExecArgs = class _ListMcpResourcesExecArgs extends __protoMessage329 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ListMcpResourcesExecResult = class _ListMcpResourcesExecResult extends __protoMessage329 {
      constructor(data) {
        super();
        this.result = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    ListMcpResourcesExecResult_McpResource = class _ListMcpResourcesExecResult_McpResource extends __protoMessage329 {
      constructor(data) {
        super();
        this.uri = "";
        this.server = "";
    ...
    ListMcpResourcesSuccess = class _ListMcpResourcesSuccess extends __protoMessage329 {
      constructor(data) {
        super();
        this.resources = [];
        proto3.util.initPartial(data, this);
    ...
    ListMcpResourcesError = class _ListMcpResourcesError extends __protoMessage329 {
      constructor(data) {
        super();
        this.error = "";
        proto3.util.initPartial(data, this);
    ...
    ListMcpResourcesRejected = class _ListMcpResourcesRejected extends __protoMessage329 {
      constructor(data) {
        super();
        this.reason = "";
        proto3.util.initPartial(data, this);
    ...
    ReadMcpResourceExecArgs = class _ReadMcpResourceExecArgs extends __protoMessage329 {
      constructor(data) {
        super();
        this.server = "";
        this.uri = "";
    ...
    ReadMcpResourceExecResult = class _ReadMcpResourceExecResult extends __protoMessage329 {
      constructor(data) {
        super();
        this.result = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    ReadMcpResourceSuccess = class _ReadMcpResourceSuccess extends __protoMessage329 {
      constructor(data) {
        super();
        this.uri = "";
        this.content = { case: void 0 };
    ...
    ReadMcpResourceError = class _ReadMcpResourceError extends __protoMessage329 {
      constructor(data) {
        super();
        this.uri = "";
        this.error = "";
    ...
    ReadMcpResourceRejected = class _ReadMcpResourceRejected extends __protoMessage329 {
      constructor(data) {
        super();
        this.uri = "";
        this.reason = "";
    ...
    ReadMcpResourceNotFound = class _ReadMcpResourceNotFound extends __protoMessage329 {
      constructor(data) {
        super();
        this.uri = "";
        proto3.util.initPartial(data, this);
