...
var init_computer_use_tool_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/computer_use_tool_pb.js"() {
    ...
    ComputerUseArgs = class _ComputerUseArgs extends __protoMessage341 {
      constructor(data) {
        super();
        this.toolCallId = "";
        this.actions = [];
    ...
    MouseMoveAction = class _MouseMoveAction extends __protoMessage341 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ClickAction = class _ClickAction extends __protoMessage341 {
      constructor(data) {
        super();
    ...
    MouseDownAction = class _MouseDownAction extends __protoMessage341 {
      constructor(data) {
        super();
        this.button = MouseButton.UNSPECIFIED;
        proto3.util.initPartial(data, this);
    ...
    MouseUpAction = class _MouseUpAction extends __protoMessage341 {
      constructor(data) {
        super();
        this.button = MouseButton.UNSPECIFIED;
        proto3.util.initPartial(data, this);
    ...
    DragAction = class _DragAction extends __protoMessage341 {
      constructor(data) {
        super();
        this.path = [];
        this.button = MouseButton.UNSPECIFIED;
    ...
    ScrollAction = class _ScrollAction extends __protoMessage341 {
      constructor(data) {
        super();
    ...
    TypeAction = class _TypeAction extends __protoMessage341 {
      constructor(data) {
        super();
        this.text = "";
        proto3.util.initPartial(data, this);
    ...
    KeyAction = class _KeyAction extends __protoMessage341 {
      constructor(data) {
        super();
        this.key = "";
        proto3.util.initPartial(data, this);
    ...
    ScreenshotAction = class _ScreenshotAction extends __protoMessage341 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    CursorPositionAction = class _CursorPositionAction extends __protoMessage341 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ComputerUseResult = class _ComputerUseResult extends __protoMessage341 {
      constructor(data) {
        super();
    ...
    ComputerUseSuccess = class _ComputerUseSuccess extends __protoMessage341 {
      constructor(data) {
        super();
        this.actionCount = 0;
        this.durationMs = 0;
    ...
    ComputerUseError = class _ComputerUseError extends __protoMessage341 {
      constructor(data) {
        super();
        this.error = "";
        this.actionCount = 0;
    ...
    ComputerUseToolCall = class _ComputerUseToolCall extends __protoMessage341 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
