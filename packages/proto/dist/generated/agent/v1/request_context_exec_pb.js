...
var init_request_context_exec_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/request_context_exec_pb.js"() {
    ...
    RequestContextResult = class _RequestContextResult extends __protoMessage389 {
      constructor(data) {
        super();
    ...
    RequestContextSuccess = class _RequestContextSuccess extends __protoMessage389 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    RequestContextError = class _RequestContextError extends __protoMessage389 {
      constructor(data) {
        super();
        this.error = "";
        proto3.util.initPartial(data, this);
    ...
    RequestContextRejected = class _RequestContextRejected extends __protoMessage389 {
      constructor(data) {
        super();
        this.reason = "";
        proto3.util.initPartial(data, this);
    ...
    GitRepoInfo = class _GitRepoInfo extends __protoMessage389 {
      constructor(data) {
        super();
        this.path = "";
        this.status = "";
    ...
    RequestContextEnv = class _RequestContextEnv extends __protoMessage389 {
      constructor(data) {
        super();
        this.osVersion = "";
        this.workspacePaths = [];
    ...
    MountedAgentStore = class _MountedAgentStore extends __protoMessage389 {
      constructor(data) {
        super();
        this.path = "";
    ...
    DebugModeConfig = class _DebugModeConfig extends __protoMessage389 {
      constructor(data) {
        super();
        this.logPath = "";
        this.serverEndpoint = "";
    ...
    SkillDescriptor = class _SkillDescriptor extends __protoMessage389 {
      constructor(data) {
        super();
        this.name = "";
        this.description = "";
    ...
    SkillOptions = class _SkillOptions extends __protoMessage389 {
      constructor(data) {
        super();
    ...
    HooksConfigInfo = class _HooksConfigInfo extends __protoMessage389 {
      constructor(data) {
        super();
    ...
    PermissionsAutoRunInstructions = class _PermissionsAutoRunInstructions extends __protoMessage389 {
      constructor(data) {
        super();
    ...
    PrecomputedHumanChangeRenderedDiff = class _PrecomputedHumanChangeRenderedDiff extends __protoMessage389 {
      constructor(data) {
        super();
    ...
    PrecomputedHumanChange = class _PrecomputedHumanChange extends __protoMessage389 {
      constructor(data) {
        super();
        this.path = "";
        this.renderedDiffs = [];
    ...
    RequestContext = class _RequestContext extends __protoMessage389 {
      constructor(data) {
        super();
        this.rules = [];
        this.repositoryInfo = [];
    ...
    RecentlyAddedPlugin = class _RecentlyAddedPlugin extends __protoMessage389 {
      constructor(data) {
        super();
        this.displayName = "";
        this.description = "";
    ...
    RecentlyAddedPlugin_CapabilityDescriptor = class _RecentlyAddedPlugin_CapabilityDescriptor extends __protoMessage389 {
      constructor(data) {
        super();
        this.name = "";
        this.description = "";
    ...
    MatchedInstalledPlugin = class _MatchedInstalledPlugin extends __protoMessage389 {
      constructor(data) {
        super();
        this.displayName = "";
        this.description = "";
