var __protoPackage19, __protoMessage319, LsArgs, LsResult, LsSuccess, LsDirectoryTreeNode, LsDirectoryTreeNode_File, LsError, LsRejected, LsTimeout, TerminalMetadata, TerminalMetadata_Command;
var init_ls_exec_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/ls_exec_pb.js"() {
    ...
    LsArgs = class _LsArgs extends __protoMessage319 {
      constructor(data) {
        super();
        this.path = "";
        this.ignore = [];
    ...
    LsResult = class _LsResult extends __protoMessage319 {
      constructor(data) {
        super();
    ...
    LsSuccess = class _LsSuccess extends __protoMessage319 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    LsDirectoryTreeNode = class _LsDirectoryTreeNode extends __protoMessage319 {
      constructor(data) {
        super();
        this.absPath = "";
        this.childrenDirs = [];
    ...
    LsDirectoryTreeNode_File = class _LsDirectoryTreeNode_File extends __protoMessage319 {
      constructor(data) {
        super();
        this.name = "";
        proto3.util.initPartial(data, this);
    ...
    LsError = class _LsError extends __protoMessage319 {
      constructor(data) {
        super();
        this.path = "";
        this.error = "";
    ...
    LsRejected = class _LsRejected extends __protoMessage319 {
      constructor(data) {
        super();
        this.path = "";
        this.reason = "";
    ...
    LsTimeout = class _LsTimeout extends __protoMessage319 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    TerminalMetadata = class _TerminalMetadata extends __protoMessage319 {
      constructor(data) {
        super();
        this.lastCommands = [];
        proto3.util.initPartial(data, this);
    ...
    TerminalMetadata_Command = class _TerminalMetadata_Command extends __protoMessage319 {
      constructor(data) {
        super();
        this.command = "";
        proto3.util.initPartial(data, this);
