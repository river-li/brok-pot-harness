...
var init_web_search_tool_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/web_search_tool_pb.js"() {
    ...
    WebSearchResult = class _WebSearchResult extends __protoMessage335 {
      constructor(data) {
        super();
    ...
    WebSearchSuccess = class _WebSearchSuccess extends __protoMessage335 {
      constructor(data) {
        super();
        this.references = [];
        proto3.util.initPartial(data, this);
    ...
    WebSearchError = class _WebSearchError extends __protoMessage335 {
      constructor(data) {
        super();
        this.error = "";
        proto3.util.initPartial(data, this);
    ...
    WebSearchRejected = class _WebSearchRejected extends __protoMessage335 {
      constructor(data) {
        super();
        this.reason = "";
        proto3.util.initPartial(data, this);
    ...
    WebSearchReference = class _WebSearchReference extends __protoMessage335 {
      constructor(data) {
        super();
        this.title = "";
        this.url = "";
    ...
    WebSearchToolCall = class _WebSearchToolCall extends __protoMessage335 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    WebSearchRequestQuery = class _WebSearchRequestQuery extends __protoMessage335 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    WebSearchRequestResponse = class _WebSearchRequestResponse extends __protoMessage335 {
      constructor(data) {
        super();
        this.result = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    WebSearchRequestResponse_Approved = class _WebSearchRequestResponse_Approved extends __protoMessage335 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    WebSearchRequestResponse_Rejected = class _WebSearchRequestResponse_Rejected extends __protoMessage335 {
      constructor(data) {
        super();
        this.reason = "";
        proto3.util.initPartial(data, this);
