...
var init_mcp_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/mcp_pb.js"() {
    ...
    McpTools = class _McpTools extends __protoMessage328 {
      constructor(data) {
        super();
        this.mcpTools = [];
        proto3.util.initPartial(data, this);
    ...
    McpInstructions = class _McpInstructions extends __protoMessage328 {
      constructor(data) {
        super();
        this.serverName = "";
        this.instructions = "";
    ...
    McpDescriptor = class _McpDescriptor extends __protoMessage328 {
      constructor(data) {
        super();
        this.serverName = "";
        this.serverIdentifier = "";
    ...
    McpToolDescriptor = class _McpToolDescriptor extends __protoMessage328 {
      constructor(data) {
        super();
        this.toolName = "";
        proto3.util.initPartial(data, this);
    ...
    McpFileSystemOptions = class _McpFileSystemOptions extends __protoMessage328 {
      constructor(data) {
        super();
        this.enabled = false;
    ...
    McpMetaToolOptions = class _McpMetaToolOptions extends __protoMessage328 {
      constructor(data) {
        super();
        this.enabled = false;
        this.mcpDescriptors = [];
