...
var init_coordinator_tools_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/coordinator_tools_pb.js"() {
    ...
    GetAgentStatusWorker = class _GetAgentStatusWorker extends __protoMessage383 {
      constructor(data) {
        super();
        this.bcId = "";
        this.name = "";
    ...
    GetAgentStatusSuccess = class _GetAgentStatusSuccess extends __protoMessage383 {
      constructor(data) {
        super();
        this.workers = [];
        this.message = "";
    ...
    GetAgentStatusError = class _GetAgentStatusError extends __protoMessage383 {
      constructor(data) {
        super();
        this.error = "";
        proto3.util.initPartial(data, this);
    ...
    GetAgentStatusResult = class _GetAgentStatusResult extends __protoMessage383 {
      constructor(data) {
        super();
    ...
    GetAgentStatusToolCall = class _GetAgentStatusToolCall extends __protoMessage383 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    SendToAgentArgs = class _SendToAgentArgs extends __protoMessage383 {
      constructor(data) {
        super();
        this.toolCallId = "";
        this.agentId = "";
    ...
    SendToAgentError = class _SendToAgentError extends __protoMessage383 {
      constructor(data) {
        super();
        this.error = "";
        proto3.util.initPartial(data, this);
    ...
    SendToAgentResult = class _SendToAgentResult extends __protoMessage383 {
      constructor(data) {
        super();
        this.result = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    SendToAgentToolCall = class _SendToAgentToolCall extends __protoMessage383 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    ReadAgentTranscriptArgs = class _ReadAgentTranscriptArgs extends __protoMessage383 {
      constructor(data) {
        super();
        this.toolCallId = "";
        this.agentId = "";
    ...
    ReadAgentTranscriptSuccess = class _ReadAgentTranscriptSuccess extends __protoMessage383 {
      constructor(data) {
        super();
        this.transcript = "";
    ...
    ReadAgentTranscriptError = class _ReadAgentTranscriptError extends __protoMessage383 {
      constructor(data) {
        super();
        this.error = "";
        proto3.util.initPartial(data, this);
    ...
    ReadAgentTranscriptResult = class _ReadAgentTranscriptResult extends __protoMessage383 {
      constructor(data) {
        super();
        this.result = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    ReadAgentTranscriptToolCall = class _ReadAgentTranscriptToolCall extends __protoMessage383 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    CreateAgentArgs = class _CreateAgentArgs extends __protoMessage383 {
      constructor(data) {
        super();
        this.toolCallId = "";
        this.prompt = "";
    ...
    CreateAgentSuccess = class _CreateAgentSuccess extends __protoMessage383 {
      constructor(data) {
        super();
        this.agentId = "";
        this.message = "";
    ...
    CreateAgentError = class _CreateAgentError extends __protoMessage383 {
      constructor(data) {
        super();
        this.error = "";
        proto3.util.initPartial(data, this);
    ...
    CreateAgentResult = class _CreateAgentResult extends __protoMessage383 {
      constructor(data) {
        super();
        this.result = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    CreateAgentToolCall = class _CreateAgentToolCall extends __protoMessage383 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    StopAgentArgs = class _StopAgentArgs extends __protoMessage383 {
      constructor(data) {
        super();
        this.toolCallId = "";
        this.agentId = "";
    ...
    StopAgentSuccess = class _StopAgentSuccess extends __protoMessage383 {
      constructor(data) {
        super();
        this.workerBcId = "";
        this.message = "";
    ...
    StopAgentError = class _StopAgentError extends __protoMessage383 {
      constructor(data) {
        super();
        this.error = "";
        proto3.util.initPartial(data, this);
    ...
    StopAgentResult = class _StopAgentResult extends __protoMessage383 {
      constructor(data) {
        super();
        this.result = { case: void 0 };
        proto3.util.initPartial(data, this);
    ...
    StopAgentToolCall = class _StopAgentToolCall extends __protoMessage383 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
