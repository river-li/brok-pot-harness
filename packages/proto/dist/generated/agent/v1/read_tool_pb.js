...
var init_read_tool_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/read_tool_pb.js"() {
    ...
    ReadToolArgs = class _ReadToolArgs extends __protoMessage321 {
      constructor(data) {
        super();
        this.path = "";
        proto3.util.initPartial(data, this);
    ...
    ReadToolResult = class _ReadToolResult extends __protoMessage321 {
      constructor(data) {
        super();
    ...
    ReadRange = class _ReadRange extends __protoMessage321 {
      constructor(data) {
        super();
        this.startLine = 0;
        this.endLine = 0;
    ...
    ReadToolSuccess = class _ReadToolSuccess extends __protoMessage321 {
      constructor(data) {
        super();
