var __protoPackage14, __protoMessage310, NetworkPolicyLoggingConfig, NetworkPolicy, NetworkPolicy_DefaultAction, SandboxPolicy, SandboxPolicy_Type, SandboxPolicy_ReadBoundaryMode;
var init_sandbox_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/sandbox_pb.js"() {
    ...
    NetworkPolicy_DefaultAction = /* @__PURE__ */ enumType(proto3, __protoPackage14, "NetworkPolicy.DefaultAction", [[0, "UNSPECIFIED"], [1, "ALLOW"], [2, "DENY"]], 1);
    ...
    SandboxPolicy_Type = /* @__PURE__ */ enumType(proto3, __protoPackage14, "SandboxPolicy.Type", [[0, "UNSPECIFIED"], [1, "INSECURE_NONE"], [2, "WORKSPACE_READWRITE"], [3, "WORKSPACE_READONLY"]], 1);
    SandboxPolicy_ReadBoundaryMode = /* @__PURE__ */ enumType(proto3, __protoPackage14, "SandboxPolicy.ReadBoundaryMode", [[0, "UNSPECIFIED"], [1, "SYSTEM"], [2, "WORKSPACE"]], 1);
  }
});
