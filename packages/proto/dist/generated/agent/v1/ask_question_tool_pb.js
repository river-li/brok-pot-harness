...
var init_ask_question_tool_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/ask_question_tool_pb.js"() {
    ...
    AskQuestionArgs = class _AskQuestionArgs extends __protoMessage338 {
      constructor(data) {
        super();
        this.title = "";
        this.questions = [];
    ...
    AskQuestionArgs_Question = class _AskQuestionArgs_Question extends __protoMessage338 {
      constructor(data) {
        super();
        this.id = "";
        this.prompt = "";
    ...
    AskQuestionArgs_Option = class _AskQuestionArgs_Option extends __protoMessage338 {
      constructor(data) {
        super();
        this.id = "";
        this.label = "";
    ...
    AskQuestionAsync = class _AskQuestionAsync extends __protoMessage338 {
      constructor(data) {
        super();
        proto3.util.initPartial(data, this);
      }
    ...
    AskQuestionResult = class _AskQuestionResult extends __protoMessage338 {
      constructor(data) {
        super();
    ...
    AskQuestionSuccess = class _AskQuestionSuccess extends __protoMessage338 {
      constructor(data) {
        super();
        this.answers = [];
        proto3.util.initPartial(data, this);
    ...
    AskQuestionSuccess_Answer = class _AskQuestionSuccess_Answer extends __protoMessage338 {
      constructor(data) {
        super();
        this.questionId = "";
    ...
    AskQuestionError = class _AskQuestionError extends __protoMessage338 {
      constructor(data) {
        super();
        this.errorMessage = "";
        proto3.util.initPartial(data, this);
    ...
    AskQuestionRejected = class _AskQuestionRejected extends __protoMessage338 {
      constructor(data) {
        super();
        this.reason = "";
        proto3.util.initPartial(data, this);
