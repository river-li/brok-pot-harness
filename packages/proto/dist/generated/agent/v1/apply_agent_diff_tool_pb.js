...
var __protoPackage40, __protoMessage337, ApplyAgentDiffToolCall, ApplyAgentDiffArgs, ApplyAgentDiffResult, ApplyAgentDiffSuccess, AppliedAgentChange, AppliedAgentChange_ChangeType, ApplyAgentDiffError;
var init_apply_agent_diff_tool_pb = __esm({
  "../packages/proto/dist/generated/agent/v1/apply_agent_diff_tool_pb.js"() {
    ...
    ApplyAgentDiffToolCall = class _ApplyAgentDiffToolCall extends __protoMessage337 {
      constructor(data) {
        super();
    ...
    ApplyAgentDiffArgs = class _ApplyAgentDiffArgs extends __protoMessage337 {
      constructor(data) {
        super();
        this.agentId = "";
        proto3.util.initPartial(data, this);
    ...
    ApplyAgentDiffResult = class _ApplyAgentDiffResult extends __protoMessage337 {
      constructor(data) {
        super();
    ...
    ApplyAgentDiffSuccess = class _ApplyAgentDiffSuccess extends __protoMessage337 {
      constructor(data) {
        super();
        this.appliedChanges = [];
        proto3.util.initPartial(data, this);
    ...
    AppliedAgentChange = class _AppliedAgentChange extends __protoMessage337 {
      constructor(data) {
        super();
        this.path = "";
    ...
    AppliedAgentChange_ChangeType = /* @__PURE__ */ enumType(proto3, __protoPackage40, "AppliedAgentChange.ChangeType", [[0, "UNSPECIFIED"], [1, "CREATED"], [2, "MODIFIED"], [3, "DELETED"]], 1);
    ApplyAgentDiffError = class _ApplyAgentDiffError extends __protoMessage337 {
      constructor(data) {
        super();
        this.error = "";
        this.appliedChanges = [];
