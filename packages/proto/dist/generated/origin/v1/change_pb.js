...
var ChangeStatus = /* @__PURE__ */ enumType(proto3, __protoPackage165, "ChangeStatus", [[0, "UNSPECIFIED"], [1, "DRAFT"], [2, "OPEN"], [3, "MERGED"], [4, "CLOSED"]], 1);
var UpdateChangeBranchMethod = /* @__PURE__ */ enumType(proto3, __protoPackage165, "UpdateChangeBranchMethod", [[0, "UNSPECIFIED"], [1, "MERGE_COMMIT"]], 1);
var ReviewVerdict = /* @__PURE__ */ enumType(proto3, __protoPackage165, "ReviewVerdict", [[0, "UNSPECIFIED"], [1, "APPROVE"], [2, "REQUEST_CHANGES"], [3, "COMMENT"]], 1);
var ChangeAssignmentKind = /* @__PURE__ */ enumType(proto3, __protoPackage165, "ChangeAssignmentKind", [[0, "UNSPECIFIED"], [1, "REVIEW_REQUEST"], [2, "ASSIGNEE"]], 1);
var ChangeAssignmentCreatedVia = /* @__PURE__ */ enumType(proto3, __protoPackage165, "ChangeAssignmentCreatedVia", [[0, "UNSPECIFIED"], [1, "HUMAN"], [2, "CODEOWNERS"], [3, "SYSTEM"]], 1);
var ReviewRequestEventAction = /* @__PURE__ */ enumType(proto3, __protoPackage165, "ReviewRequestEventAction", [[0, "UNSPECIFIED"], [1, "REQUESTED"], [2, "REMOVED"]], 1);
var ChangeCodeownersMatchPathReason = /* @__PURE__ */ enumType(proto3, __protoPackage165, "ChangeCodeownersMatchPathReason", [[0, "UNSPECIFIED"], [1, "CURRENT_PATH"], [2, "DELETED_PATH"], [3, "RENAME_NEW_PATH"], [4, "RENAME_OLD_PATH"], [5, "COPY_SOURCE_PATH"]], 1);
var StackMemberParentRelation = /* @__PURE__ */ enumType(proto3, __protoPackage165, "StackMemberParentRelation", [[0, "UNSPECIFIED"], [1, "NONE"], [2, "STRICT"], [3, "STALE"], [4, "PARENT_MERGED"], [5, "PARENT_CLOSED"]], 1);
var StackMemberRecommendedAction = /* @__PURE__ */ enumType(proto3, __protoPackage165, "StackMemberRecommendedAction", [[0, "UNSPECIFIED"], [1, "NONE"], [2, "RESTACK_ONTO_PARENT"], [3, "REBASE_ONTO_TRUNK_IF_CONFLICTS"], [4, "RETARGET_BASE_TO_TRUNK"]], 1);
var SectionOfChangesSortField = /* @__PURE__ */ enumType(proto3, __protoPackage165, "SectionOfChangesSortField", [[0, "UNSPECIFIED"], [1, "UPDATED_AT"], [2, "CREATED_AT"], [3, "TITLE"], [4, "LINES_CHANGED"]], 1);
var SectionOfChangesStatus = /* @__PURE__ */ enumType(proto3, __protoPackage165, "SectionOfChangesStatus", [[0, "UNSPECIFIED"], [1, "DRAFT"], [2, "OPEN"], [3, "MERGED"], [4, "CLOSED"]], 1);
var SectionOfChangesVerdict = /* @__PURE__ */ enumType(proto3, __protoPackage165, "SectionOfChangesVerdict", [[0, "UNSPECIFIED"], [1, "APPROVE"], [2, "COMMENT"], [3, "REQUEST_CHANGES"]], 1);
var SectionOfChangesReviewStatusState = /* @__PURE__ */ enumType(proto3, __protoPackage165, "SectionOfChangesReviewStatusState", [[0, "UNSPECIFIED"], [1, "ONE_OR_MORE_APPROVALS"], [2, "IS_FULLY_APPROVED"], [3, "HAS_ACTIVE_REVIEW"], [4, "HAS_REQUESTED_REVIEWERS"], [5, "HAS_REREQUESTED_REVIEW"], [6, "HAS_UNADDRESSED_CHANGES_REQUESTED"], [7, "HAS_CHANGES_REQUESTED"]], 1);
var Change = class _Change extends __protoMessage3157 {
  constructor(data) {
    super();
    this.id = "";
    this.repoUuid = "";
...
var Version2 = class _Version extends __protoMessage3157 {
  constructor(data) {
    super();
    this.id = "";
    this.changeId = "";
...
var CreateChangeRequest = class _CreateChangeRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.title = "";
    this.description = "";
...
var CreateChangeResponse = class _CreateChangeResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ChangeIdentifier = class _ChangeIdentifier extends __protoMessage3157 {
  constructor(data) {
    super();
...
var RevertPullRequestRequest = class _RevertPullRequestRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.draft = false;
...
var RevertPullRequestResponse = class _RevertPullRequestResponse extends __protoMessage3157 {
  constructor(data) {
    super();
...
var UpdateChangeRequest = class _UpdateChangeRequest extends __protoMessage3157 {
  constructor(data) {
    super();
...
var UpdateChangeResponse = class _UpdateChangeResponse extends __protoMessage3157 {
  constructor(data) {
    super();
...
var UpdateChangeBranchRequest = class _UpdateChangeBranchRequest extends __protoMessage3157 {
  constructor(data) {
    super();
...
var UpdateChangeBranchResponse = class _UpdateChangeBranchResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.unchanged = false;
    proto3.util.initPartial(data, this);
...
var DeleteChangeHeadBranchRequest = class _DeleteChangeHeadBranchRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var DeleteChangeHeadBranchResponse = class _DeleteChangeHeadBranchResponse extends __protoMessage3157 {
  constructor(data) {
    super();
...
var RestorePullRequestBranchRequest = class _RestorePullRequestBranchRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var RestorePullRequestBranchResponse = class _RestorePullRequestBranchResponse extends __protoMessage3157 {
  constructor(data) {
    super();
...
var RetargetChangeRequest = class _RetargetChangeRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.baseRef = "";
    proto3.util.initPartial(data, this);
...
var RetargetChangeResponse = class _RetargetChangeResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.unchanged = false;
    proto3.util.initPartial(data, this);
...
var FoldChangeRequest = class _FoldChangeRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var FoldChangeResponse = class _FoldChangeResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SplitChangeIntoStackRequest = class _SplitChangeIntoStackRequest extends __protoMessage3157 {
  constructor(data) {
    super();
...
var SplitChangeStackGroup = class _SplitChangeStackGroup extends __protoMessage3157 {
  constructor(data) {
    super();
    this.title = "";
    this.paths = [];
...
var SplitChangeIntoStackResponse = class _SplitChangeIntoStackResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changes = [];
    proto3.util.initPartial(data, this);
...
var UpdateChangeMetadataRequest = class _UpdateChangeMetadataRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var UpdateChangeMetadataResponse = class _UpdateChangeMetadataResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var UpdateChangeStatusRequest = class _UpdateChangeStatusRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.status = ChangeStatus.UNSPECIFIED;
    proto3.util.initPartial(data, this);
...
var UpdateChangeStatusResponse = class _UpdateChangeStatusResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ReviewDismissal = class _ReviewDismissal extends __protoMessage3157 {
  constructor(data) {
    super();
...
var Review = class _Review extends __protoMessage3157 {
  constructor(data) {
    super();
    this.id = "";
    this.changeId = "";
...
var ChangeTimelineEvent = class _ChangeTimelineEvent extends __protoMessage3157 {
  constructor(data) {
    super();
    this.id = "";
    this.eventType = "";
...
var Comment2 = class _Comment extends __protoMessage3157 {
  constructor(data) {
    super();
    this.id = "";
    this.changeId = "";
...
var CommentReactionGroup = class _CommentReactionGroup extends __protoMessage3157 {
  constructor(data) {
    super();
    this.emoji = "";
    this.count = 0;
...
var CommentReaction = class _CommentReaction extends __protoMessage3157 {
  constructor(data) {
    super();
    this.emoji = "";
...
var CreateReviewRequest = class _CreateReviewRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.verdict = ReviewVerdict.UNSPECIFIED;
    this.body = "";
...
var CreateReviewResponse = class _CreateReviewResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var UpdateReviewRequest = class _UpdateReviewRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.reviewId = "";
    this.body = "";
...
var UpdateReviewResponse = class _UpdateReviewResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var DismissReviewRequest = class _DismissReviewRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.reviewId = "";
    this.reason = "";
...
var DismissReviewResponse = class _DismissReviewResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ListReviewsRequest = class _ListReviewsRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ListReviewsResponse = class _ListReviewsResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.reviews = [];
    proto3.util.initPartial(data, this);
...
var ListChangeTimelineEventsRequest = class _ListChangeTimelineEventsRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ListChangeTimelineEventsResponse = class _ListChangeTimelineEventsResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.events = [];
    proto3.util.initPartial(data, this);
...
var CreateCommentRequest = class _CreateCommentRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.body = "";
    this.versionNumber = protoInt64.zero;
...
var CreateCommentResponse = class _CreateCommentResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ListCommentsRequest = class _ListCommentsRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ListCommentsResponse = class _ListCommentsResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.comments = [];
    proto3.util.initPartial(data, this);
...
var ChangeAssignment = class _ChangeAssignment extends __protoMessage3157 {
  constructor(data) {
    super();
    this.id = "";
    this.changeId = "";
...
var ListReviewRequestEventsRequest = class _ListReviewRequestEventsRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ListReviewRequestEventsResponse = class _ListReviewRequestEventsResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.events = [];
    proto3.util.initPartial(data, this);
...
var RequestReviewRequest = class _RequestReviewRequest extends __protoMessage3157 {
  constructor(data) {
    super();
...
var RequestReviewResponse = class _RequestReviewResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ReviewRequestTarget = class _ReviewRequestTarget extends __protoMessage3157 {
  constructor(data) {
    super();
    this.target = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var ApplyReviewRequestChangesRequest = class _ApplyReviewRequestChangesRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.additions = [];
    this.removals = [];
...
var ApplyReviewRequestChangesResponse = class _ApplyReviewRequestChangesResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var RequestReviewsRequest = class _RequestReviewsRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.targets = [];
    proto3.util.initPartial(data, this);
...
var RequestReviewsResponse = class _RequestReviewsResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.assignments = [];
    proto3.util.initPartial(data, this);
...
var CloseReviewRequestRequest = class _CloseReviewRequestRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.target = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var CloseReviewRequestResponse = class _CloseReviewRequestResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var AddAssigneeRequest = class _AddAssigneeRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.target = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var AddAssigneeResponse = class _AddAssigneeResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var RemoveAssigneeRequest = class _RemoveAssigneeRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.target = { case: void 0 };
    proto3.util.initPartial(data, this);
...
var RemoveAssigneeResponse = class _RemoveAssigneeResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var OriginReviewerCandidateUser = class _OriginReviewerCandidateUser extends __protoMessage3157 {
  constructor(data) {
    super();
    this.firstName = "";
    this.lastName = "";
...
var OriginReviewerCandidateGroup = class _OriginReviewerCandidateGroup extends __protoMessage3157 {
  constructor(data) {
    super();
    this.groupPublicId = "";
...
var ListOriginRepoReviewerCandidatesRequest = class _ListOriginRepoReviewerCandidatesRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ChangeLabel = class _ChangeLabel extends __protoMessage3157 {
  constructor(data) {
    super();
    this.id = "";
    this.name = "";
...
var ChangeMergeWhenReadySummary = class _ChangeMergeWhenReadySummary extends __protoMessage3157 {
  constructor(data) {
    super();
    this.id = "";
    this.changeId = "";
...
var ChangeViewerCapabilities = class _ChangeViewerCapabilities extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GetChangeResponse = class _GetChangeResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.versions = [];
    this.assignments = [];
...
var GetChangeCodeownersApplicationRequest = class _GetChangeCodeownersApplicationRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var ChangeCodeownersSnapshotMissing = class _ChangeCodeownersSnapshotMissing extends __protoMessage3157 {
  constructor(data) {
    super();
    this.checkedPaths = [];
    proto3.util.initPartial(data, this);
...
var ChangeCodeownersSnapshotTooLarge = class _ChangeCodeownersSnapshotTooLarge extends __protoMessage3157 {
  constructor(data) {
    super();
    this.path = "";
...
var ChangeCodeownersSnapshotFound = class _ChangeCodeownersSnapshotFound extends __protoMessage3157 {
  constructor(data) {
    super();
    this.path = "";
    this.sizeBytes = protoInt64.zero;
...
var ChangeCodeownersSnapshot = class _ChangeCodeownersSnapshot extends __protoMessage3157 {
  constructor(data) {
    super();
    this.baseSha = "";
...
var ChangeCodeownersMatchPath = class _ChangeCodeownersMatchPath extends __protoMessage3157 {
  constructor(data) {
    super();
    this.path = "";
...
var ChangeCodeowner = class _ChangeCodeowner extends __protoMessage3157 {
  constructor(data) {
    super();
    this.label = "";
...
var ChangeCodeowner_User = class _ChangeCodeowner_User extends __protoMessage3157 {
  constructor(data) {
    super();
    this.login = "";
    proto3.util.initPartial(data, this);
...
var ChangeCodeowner_Group = class _ChangeCodeowner_Group extends __protoMessage3157 {
  constructor(data) {
    super();
    this.organizationSlug = "";
    this.groupSlug = "";
...
var ChangeCodeownersResolvedOwnerRule = class _ChangeCodeownersResolvedOwnerRule extends __protoMessage3157 {
  constructor(data) {
    super();
    this.owners = [];
...
var ChangeCodeownersChangedPath = class _ChangeCodeownersChangedPath extends __protoMessage3157 {
  constructor(data) {
    super();
...
var ChangeCodeownersRequirementPath = class _ChangeCodeownersRequirementPath extends __protoMessage3157 {
  constructor(data) {
    super();
    this.canonicalPath = "";
    proto3.util.initPartial(data, this);
...
var ChangeCodeownersRequirementGroup = class _ChangeCodeownersRequirementGroup extends __protoMessage3157 {
  constructor(data) {
    super();
    this.id = "";
    this.owners = [];
...
var GetChangeCodeownersApplicationResponse = class _GetChangeCodeownersApplicationResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changedPaths = [];
...
var GetChangeStackRequest = class _GetChangeStackRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var StackMemberState = class _StackMemberState extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changeId = "";
    this.headSha = "";
...
var GetChangeStackResponse = class _GetChangeStackResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changes = [];
...
var GetProjectedLatestVersionsRequest = class _GetProjectedLatestVersionsRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changeNumbers = [];
    proto3.util.initPartial(data, this);
...
var ProjectedLatestVersionEntry = class _ProjectedLatestVersionEntry extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changeNumber = protoInt64.zero;
    proto3.util.initPartial(data, this);
...
var GetProjectedLatestVersionsResponse = class _GetProjectedLatestVersionsResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.entries = [];
    proto3.util.initPartial(data, this);
...
var ListChangeCommitsRequest = class _ListChangeCommitsRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.versionNumber = protoInt64.zero;
    proto3.util.initPartial(data, this);
...
var ListChangeCommitsResponse = class _ListChangeCommitsResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.commits = [];
    this.mergeBaseSha = "";
...
var CommitActorDisplays = class _CommitActorDisplays extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var CommitActorDisplay = class _CommitActorDisplay extends __protoMessage3157 {
  constructor(data) {
    super();
    this.displayName = "";
    this.avatarUrl = "";
...
var ListChangesRequest = class _ListChangesRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.file = [];
    proto3.util.initPartial(data, this);
...
var ListChangesByHeadRefRequest = class _ListChangesByHeadRefRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.headRef = "";
...
var ListChangesByHeadRefResponse = class _ListChangesByHeadRefResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changes = [];
    proto3.util.initPartial(data, this);
...
var GetCommitReferencesRequest = class _GetCommitReferencesRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.sha = "";
    proto3.util.initPartial(data, this);
...
var CommitReference = class _CommitReference extends __protoMessage3157 {
  constructor(data) {
    super();
    this.branchName = "";
...
var GetCommitReferencesResponse = class _GetCommitReferencesResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.references = [];
    proto3.util.initPartial(data, this);
...
var ChangeWithLatestVersion = class _ChangeWithLatestVersion extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var BatchGetChangesRequest = class _BatchGetChangesRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changeNumbers = [];
    this.headRefs = [];
...
var BatchGetChangesResponse = class _BatchGetChangesResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changes = [];
    proto3.util.initPartial(data, this);
...
var ListChangesResponse = class _ListChangesResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changes = [];
    proto3.util.initPartial(data, this);
...
var GetSectionOfChangesRequest = class _GetSectionOfChangesRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.repos = [];
    this.limit = 0;
  ...
  static $() {
    return ["GetSectionOfChangesRequest|1 repos #0*|2 filter #1|3 cursor 9?|4 limit 5|5 sort_field #2|6 sort_is_asc 8|7 skip_total_count 8|8 change_ids 9*|10 drop_unauthorized_repos 8", ClientRepoIdentifier, SectionOfChangesFilter, SectionOfChangesSortField];
  }
};
var GetSectionOfChangesResponse = class _GetSectionOfChangesResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.changes = [];
    this.hasMore = false;
...
var CountSectionsOfChangesRequest = class _CountSectionsOfChangesRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.repos = [];
    this.filters = [];
  ...
  static $() {
    return ["CountSectionsOfChangesRequest|1 repos #0*|2 filters #1*|3 drop_unauthorized_repos 8", ClientRepoIdentifier, SectionOfChangesFilter];
  }
};
var CountSectionsOfChangesResponse = class _CountSectionsOfChangesResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.counts = [];
    this.droppedRepoCount = 0;
...
var SectionOfChanges = class _SectionOfChanges extends __protoMessage3157 {
  constructor(data) {
    super();
    this.id = "";
    this.number = 0;
...
var SectionOfChangesFilter = class _SectionOfChangesFilter extends __protoMessage3157 {
  constructor(data) {
    super();
...
var SectionOfChangesFilterAnd = class _SectionOfChangesFilterAnd extends __protoMessage3157 {
  constructor(data) {
    super();
    this.exprs = [];
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterOr = class _SectionOfChangesFilterOr extends __protoMessage3157 {
  constructor(data) {
    super();
    this.exprs = [];
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterNot = class _SectionOfChangesFilterNot extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SectionOfChangesFilterConsolidatedStatus = class _SectionOfChangesFilterConsolidatedStatus extends __protoMessage3157 {
  constructor(data) {
    super();
    this.status = SectionOfChangesStatus.UNSPECIFIED;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterTitleContains = class _SectionOfChangesFilterTitleContains extends __protoMessage3157 {
  constructor(data) {
    super();
    this.text = "";
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterDescriptionContains = class _SectionOfChangesFilterDescriptionContains extends __protoMessage3157 {
  constructor(data) {
    super();
    this.text = "";
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterMergeBase = class _SectionOfChangesFilterMergeBase extends __protoMessage3157 {
  constructor(data) {
    super();
    this.mergeBase = "";
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterTrunk = class _SectionOfChangesFilterTrunk extends __protoMessage3157 {
  constructor(data) {
    super();
    this.trunk = "";
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterLastUpdated = class _SectionOfChangesFilterLastUpdated extends __protoMessage3157 {
  constructor(data) {
    super();
    this.hours = 0;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterOpenReviewRequestFor = class _SectionOfChangesFilterOpenReviewRequestFor extends __protoMessage3157 {
  constructor(data) {
    super();
    this.cursorUserId = protoInt64.zero;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterReopenedReviewRequestFor = class _SectionOfChangesFilterReopenedReviewRequestFor extends __protoMessage3157 {
  constructor(data) {
    super();
    this.cursorUserId = protoInt64.zero;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterClosedReviewRequestFrom = class _SectionOfChangesFilterClosedReviewRequestFrom extends __protoMessage3157 {
  constructor(data) {
    super();
    this.cursorUserId = protoInt64.zero;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterIncludesDirectReviewer = class _SectionOfChangesFilterIncludesDirectReviewer extends __protoMessage3157 {
  constructor(data) {
    super();
    this.cursorUserId = protoInt64.zero;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterAuthorIs = class _SectionOfChangesFilterAuthorIs extends __protoMessage3157 {
  constructor(data) {
    super();
    this.cursorUserId = protoInt64.zero;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterReviewStatus = class _SectionOfChangesFilterReviewStatus extends __protoMessage3157 {
  constructor(data) {
    super();
...
var SectionOfChangesFilterApprovedBy = class _SectionOfChangesFilterApprovedBy extends __protoMessage3157 {
  constructor(data) {
    super();
    this.cursorUserId = protoInt64.zero;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterIncludesPastReviewer = class _SectionOfChangesFilterIncludesPastReviewer extends __protoMessage3157 {
  constructor(data) {
    super();
    this.cursorUserId = protoInt64.zero;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterHasLabel = class _SectionOfChangesFilterHasLabel extends __protoMessage3157 {
  constructor(data) {
    super();
    this.name = "";
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterNumFilesChanged = class _SectionOfChangesFilterNumFilesChanged extends __protoMessage3157 {
  constructor(data) {
    super();
    this.numFiles = 0;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterNumLinesChanged = class _SectionOfChangesFilterNumLinesChanged extends __protoMessage3157 {
  constructor(data) {
    super();
    this.numLines = 0;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterIncludesReviewer = class _SectionOfChangesFilterIncludesReviewer extends __protoMessage3157 {
  constructor(data) {
    super();
    this.groupPublicIds = [];
    this.cursorUserId = protoInt64.zero;
...
var SectionOfChangesFilterIncludesAssignee = class _SectionOfChangesFilterIncludesAssignee extends __protoMessage3157 {
  constructor(data) {
    super();
    this.cursorUserId = protoInt64.zero;
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterIncludesDirectTeamReviewer = class _SectionOfChangesFilterIncludesDirectTeamReviewer extends __protoMessage3157 {
  constructor(data) {
    super();
    this.slug = "";
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterMentions = class _SectionOfChangesFilterMentions extends __protoMessage3157 {
  constructor(data) {
    super();
    this.username = "";
    proto3.util.initPartial(data, this);
...
var SectionOfChangesFilterUnsupported = class _SectionOfChangesFilterUnsupported extends __protoMessage3157 {
  constructor(data) {
    super();
    this.kind = "";
    proto3.util.initPartial(data, this);
...
var StartReviewRequest = class _StartReviewRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.verdict = ReviewVerdict.UNSPECIFIED;
    this.body = "";
...
var StartReviewResponse = class _StartReviewResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var SubmitReviewRequest = class _SubmitReviewRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.reviewId = "";
    proto3.util.initPartial(data, this);
...
var SubmitReviewResponse = class _SubmitReviewResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var DiscardPendingReviewRequest = class _DiscardPendingReviewRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    this.reviewId = "";
    proto3.util.initPartial(data, this);
...
var DiscardPendingReviewResponse = class _DiscardPendingReviewResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GetPendingReviewRequest = class _GetPendingReviewRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GetPendingReviewResponse = class _GetPendingReviewResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    this.threadCount = 0;
...
var CheckChangeCreationAccessRequest = class _CheckChangeCreationAccessRequest extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var CheckChangeCreationAccessResponse = class _CheckChangeCreationAccessResponse extends __protoMessage3157 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
