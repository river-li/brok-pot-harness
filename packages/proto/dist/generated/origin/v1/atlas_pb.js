...
var AtlasFreshness = /* @__PURE__ */ enumType(proto3, __protoPackage176, "AtlasFreshness", [[0, "UNSPECIFIED"], [1, "EAGER"], [2, "BALANCED"], [3, "RELAXED"], [4, "MANUAL"]], 1);
var GetAtlasNodeRequest = class _GetAtlasNodeRequest extends __protoMessage3167 {
  constructor(data) {
    super();
    this.path = "";
...
var AtlasNodeLayerContent = class _AtlasNodeLayerContent extends __protoMessage3167 {
  constructor(data) {
    super();
    this.layer = "";
    this.label = "";
...
var GetAtlasNodeResponse = class _GetAtlasNodeResponse extends __protoMessage3167 {
  constructor(data) {
    super();
    this.lastCommit = "";
    this.layers = [];
...
var AtlasLayerStatus = class _AtlasLayerStatus extends __protoMessage3167 {
  constructor(data) {
    super();
    this.layer = "";
    this.label = "";
...
var GetAtlasRepoStatusRequest = class _GetAtlasRepoStatusRequest extends __protoMessage3167 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var GetAtlasRepoStatusResponse = class _GetAtlasRepoStatusResponse extends __protoMessage3167 {
  constructor(data) {
    super();
...
var SetAtlasRepoConfigRequest = class _SetAtlasRepoConfigRequest extends __protoMessage3167 {
  constructor(data) {
    super();
    this.enabled = false;
    this.enabledLayers = [];
...
var SetAtlasRepoConfigResponse = class _SetAtlasRepoConfigResponse extends __protoMessage3167 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var RefreshAtlasRepoRequest = class _RefreshAtlasRepoRequest extends __protoMessage3167 {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
...
var RefreshAtlasRepoResponse = class _RefreshAtlasRepoResponse extends __protoMessage3167 {
  constructor(data) {
    super();
    this.headSha = "";
    proto3.util.initPartial(data, this);
...
var ListAtlasNodePathsRequest = class _ListAtlasNodePathsRequest extends __protoMessage3167 {
  constructor(data) {
    super();
    this.pageSize = 0;
    this.pageToken = "";
...
var ListAtlasNodePathsResponse = class _ListAtlasNodePathsResponse extends __protoMessage3167 {
  constructor(data) {
    super();
    this.paths = [];
    this.nextPageToken = "";
