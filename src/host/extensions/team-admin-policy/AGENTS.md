# team-admin-policy maintenance

The team-admin-policy Host extension and its lifecycle-bound services. Read extension.ts for dependencies and registration.
