...
var ProfileWatch = class {
  ...
  watchSessionProfile(session) {
    ...
    try {
      this.profileWatcher = (0, import_node_fs94.watch)((0, import_node_path152.dirname)(session.dbPath), (_event, filename) => {
  ...
  async getAgentDisplayProfile(agentId) {
    ...
    if (!(0, import_node_fs94.existsSync)(dir)) return null;
