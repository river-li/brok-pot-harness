...
Remote desktop bridges still target the explicitly connected machine through Gateway authentication; keep the original local-tool permission and approval checks for those requests.
