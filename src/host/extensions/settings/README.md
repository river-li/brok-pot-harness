...
The settings Host extension and its lifecycle-bound services. Read extension.ts for dependencies and registration.

Entry points and reference files: [extension.ts](extension.ts), [settings-service.ts](settings-service.ts).
