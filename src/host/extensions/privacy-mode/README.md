...
The privacy-mode Host extension and its lifecycle-bound services. Read extension.ts for dependencies and registration.

Entry points and reference files: [extension.ts](extension.ts), [privacy-mode-service.ts](privacy-mode-service.ts).
