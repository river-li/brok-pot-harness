...
var LocalExecSandBox = class {
  ...
  async ensureReady(ctx, _agentId) {
    ...
    return {
      ...
      vncUrl: "",
      terminalsFolder: (0, import_node_path70.join)(projectDir, "terminals")
    };
  }
  ...
  resolveBoxPath(boxPath) {
    return (0, import_node_path70.isAbsolute)(boxPath) ? boxPath : (0, import_node_path70.resolve)(resolveProjectDir(this.projectDir), boxPath);
  }
  displayWindowIndex() {
