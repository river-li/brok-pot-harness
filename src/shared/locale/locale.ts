...
var SUPPORTED_LOCALE_ROWS, SUPPORTED_LOCALES, DEFAULT_LOCALE, SAND_LANGUAGE_PREFERENCES, DEFAULT_SAND_LANGUAGE_PREFERENCE, LANGUAGE_TAG_PATTERN;
var init_locale = __esm({
  "src/shared/locale/locale.ts"() {
    "use strict";
    init_invariant();
    SUPPORTED_LOCALE_ROWS = [
    ...
    DEFAULT_LOCALE = "en";
    SAND_LANGUAGE_PREFERENCES = ["system", ...SUPPORTED_LOCALES];
    DEFAULT_SAND_LANGUAGE_PREFERENCE = "system";
